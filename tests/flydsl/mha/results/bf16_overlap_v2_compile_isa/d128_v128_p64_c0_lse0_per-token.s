...
.LBB0_18:
	...
	v_add_co_u32_e32 v102, vcc, s89, v102
	s_nop 1
...
.LBB0_22:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v103, v103, v103
	v_max_f32_e32 v140, v102, v103
	;;#ASMSTART
	v_add_f32 v102, v86, v135
	;;#ASMEND
	v_mov_b32_e32 v103, v86
	v_cmp_gt_f32_e32 vcc, v140, v102
	...
	;;#ASMSTART
	v_add_f32 v102, v140, v136
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v86, v86, v102
	v_exp_f32_e32 v139, v86
...
.LBB0_24:
	...
	v_add_f32_e32 v140, v140, v75
	v_add_f32_e32 v140, v140, v76
	;;#ASMSTART
	v_exp_f32 v77, v77
	;;#ASMEND
	;;#ASMSTART
	...
	v_add_f32_e32 v140, v140, v77
	v_add_f32_e32 v140, v140, v78
	;;#ASMSTART
	v_exp_f32 v79, v79
	;;#ASMEND
	;;#ASMSTART
	...
	v_add_f32_e32 v140, v140, v79
	v_add_f32_e32 v140, v140, v80
	;;#ASMSTART
	v_exp_f32 v81, v81
	;;#ASMEND
	s_nop 0
	v_add_f32_e32 v140, v140, v81
	;;#ASMSTART
	v_fma_f32 v138, v138, v139, v140
	;;#ASMEND
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_26:
	...
	v_lshl_add_u64 v[140:141], v[140:141], 2, s[80:81]
	s_lshl_b32 s6, s91, 13
	s_add_i32 s6, s6, s98
	v_mfma_f32_32x32x8_bf16 v[66:81], v[216:217], v[144:145], v[66:81]
	buffer_load_dword v139, v139, s[68:71], 0 offen
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s99, v139
	s_waitcnt lgkmcnt(7)
	...
	v_add_co_u32_e32 v140, vcc, s89, v140
	s_nop 1
	...
	v_pk_mul_f32 v[66:67], v[84:85], v[66:67]
	v_pk_mul_f32 v[68:69], v[88:89], v[68:69]
	v_max_f32_e32 v139, v66, v67
	v_pk_mul_f32 v[70:71], v[90:91], v[70:71]
	v_max3_f32 v139, v139, v68, v69
	v_pk_mul_f32 v[72:73], v[92:93], v[72:73]
	v_max3_f32 v139, v139, v70, v71
	v_pk_mul_f32 v[74:75], v[94:95], v[74:75]
	v_max3_f32 v139, v139, v72, v73
	v_pk_mul_f32 v[76:77], v[96:97], v[76:77]
	v_max3_f32 v139, v139, v74, v75
	v_pk_mul_f32 v[78:79], v[98:99], v[78:79]
	v_max3_f32 v139, v139, v76, v77
	v_pk_mul_f32 v[80:81], v[100:101], v[80:81]
	v_max3_f32 v139, v139, v78, v79
	v_max3_f32 v139, v139, v80, v81
	ds_bpermute_b32 v140, v134, v139
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v140, v140, v140
	v_max_f32_e32 v140, v139, v140
	;;#ASMSTART
	v_add_f32 v139, v86, v135
	;;#ASMEND
	s_nop 0
	v_cmp_gt_f32_e32 vcc, v140, v139
	v_mov_b32_e32 v139, 1.0
	s_and_saveexec_b64 s[4:5], vcc
...
.LBB0_30:
	...
	;;#ASMEND
	s_nop 0
	v_lshlrev_b32_e32 v140, 3, v139
	v_lshlrev_b32_e32 v139, 5, v139
	v_and_b32_e32 v140, 0xf8, v140
	s_waitcnt lgkmcnt(7)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[218:219], v[146:147], v[66:81]
	v_and_b32_e32 v139, 0x400, v139
	v_or3_b32 v140, v140, v139, s6
	v_ashrrev_i32_e32 v141, 31, v140
	v_lshl_add_u64 v[140:141], v[140:141], 1, s[84:85]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[220:221], v[148:149], v[66:81]
	s_waitcnt lgkmcnt(6)
...
.LBB0_47:
	...
	v_subrev_u32_e32 v140, 55, v139
	v_cmp_gt_i32_e32 vcc, s37, v140
	v_subrev_u32_e32 v140, 54, v139
	v_cmp_gt_i32_e64 s[0:1], s37, v140
	v_subrev_u32_e32 v140, 53, v139
	v_cmp_gt_i32_e64 s[4:5], s37, v140
	v_subrev_u32_e32 v140, 52, v139
	v_cmp_gt_i32_e64 s[6:7], s37, v140
	v_subrev_u32_e32 v140, 51, v139
	v_cmp_gt_i32_e64 s[8:9], s37, v140
	v_subrev_u32_e32 v140, 50, v139
	v_cmp_gt_i32_e64 s[10:11], s37, v140
	v_subrev_u32_e32 v140, 49, v139
	v_cmp_gt_i32_e64 s[12:13], s37, v140
	v_subrev_u32_e32 v140, 48, v139
	v_cmp_gt_i32_e64 s[14:15], s37, v140
	v_subrev_u32_e32 v140, 39, v139
	v_cmp_gt_i32_e64 s[16:17], s37, v140
	v_subrev_u32_e32 v140, 38, v139
	v_cmp_gt_i32_e64 s[18:19], s37, v140
	v_subrev_u32_e32 v140, 37, v139
	v_cmp_gt_i32_e64 s[20:21], s37, v140
	v_subrev_u32_e32 v140, 36, v139
	v_cmp_gt_i32_e64 s[22:23], s37, v140
	v_subrev_u32_e32 v140, 35, v139
	v_cmp_gt_i32_e64 s[24:25], s37, v140
	v_subrev_u32_e32 v140, 34, v139
	v_cmp_gt_i32_e64 s[26:27], s37, v140
	v_subrev_u32_e32 v140, 33, v139
	v_subrev_u32_e32 v139, 32, v139
	v_cmp_gt_i32_e64 s[28:29], s37, v140
	v_cmp_gt_i32_e64 s[30:31], s37, v139
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
	s_or_b64 s[24:25], s[26:27], s[24:25]
	s_or_b64 s[22:23], s[24:25], s[22:23]
...
.LBB0_52:
	...
	v_and_b32_e32 v139, 8, v139
	v_add_u32_e32 v139, s42, v139
	v_subrev_u32_e32 v140, 23, v139
	v_cmp_gt_i32_e32 vcc, s37, v140
	v_subrev_u32_e32 v140, 22, v139
	v_cmp_gt_i32_e64 s[0:1], s37, v140
	v_subrev_u32_e32 v140, 21, v139
	v_cmp_gt_i32_e64 s[4:5], s37, v140
	v_subrev_u32_e32 v140, 20, v139
	v_cmp_gt_i32_e64 s[6:7], s37, v140
	v_subrev_u32_e32 v140, 19, v139
	v_cmp_gt_i32_e64 s[8:9], s37, v140
	v_subrev_u32_e32 v140, 18, v139
	v_cmp_gt_i32_e64 s[10:11], s37, v140
	v_subrev_u32_e32 v140, 17, v139
	v_cmp_gt_i32_e64 s[12:13], s37, v140
	v_add_u32_e32 v140, -16, v139
	v_cmp_gt_i32_e64 s[14:15], s37, v140
	v_add_u32_e32 v140, -7, v139
	v_cmp_gt_i32_e64 s[16:17], s37, v140
	v_add_u32_e32 v140, -6, v139
	v_cmp_gt_i32_e64 s[18:19], s37, v140
	v_add_u32_e32 v140, -5, v139
	v_cmp_gt_i32_e64 s[20:21], s37, v140
	v_add_u32_e32 v140, -4, v139
	v_cmp_gt_i32_e64 s[22:23], s37, v140
	v_add_u32_e32 v140, -3, v139
	v_cmp_gt_i32_e64 s[24:25], s37, v140
	v_add_u32_e32 v140, -2, v139
	v_cmp_gt_i32_e64 s[26:27], s37, v140
	v_add_u32_e32 v140, -1, v139
	v_cmp_gt_i32_e64 s[28:29], s37, v140
	v_cmp_gt_i32_e64 s[30:31], s37, v139
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
...
.LBB0_57:
	...
	;;#ASMSTART
	v_perm_b32 v28, v3, v2, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v5, v4, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v7, v6, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v9, v8, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v11, v10, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v13, v12, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v15, v14, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v17, v16, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v19, v18, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v21, v20, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v23, v22, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v74, v75, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v72, v73, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v70, v71, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v68, v69, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v66, v67, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v35, v34, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v37, v36, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v39, v38, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v41, v40, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v43, v42, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v45, v44, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v47, v46, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v49, v48, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v51, v50, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v53, v52, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v55, v54, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v57, v56, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v59, v58, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v61, v60, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v63, v62, s90
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v65, v64, s90
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v34, v0
	;;#ASMEND
