...
.LBB0_18:
	...
	global_load_dwordx4 v[140:143], v[114:115], off
	...
	v_add_co_u32_e32 v106, vcc, s75, v114
	global_load_dwordx4 v[196:199], v[114:115], off offset:1536
	s_nop 0
...
.LBB0_22:
	...
	ds_read_b128 v[140:143], v130
	ds_read_b128 v[192:195], v131
	...
	s_waitcnt lgkmcnt(4)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[140:141], v[160:161], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[142:143], v[162:163], v[66:81]
	s_waitcnt lgkmcnt(3)
...
.LBB0_32:
	...
	v_and_or_b32 v100, v100, s74, v140
	v_add_u32_e32 v109, s37, v101
	v_add_u32_e32 v108, s80, v100
...
.LBB0_36:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v101, v101, v101
	v_max_f32_e32 v142, v100, v101
	;;#ASMSTART
	v_add_f32 v100, v84, v136
	;;#ASMEND
	v_mov_b32_e32 v101, v84
	v_cmp_gt_f32_e32 vcc, v142, v100
	v_mov_b32_e32 v100, v84
	s_and_saveexec_b64 s[42:43], vcc
	s_cbranch_execz .LBB0_39
	;;#ASMSTART
	v_add_f32 v100, v142, v137
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v84, v84, v100
	v_exp_f32_e32 v141, v84
	v_mov_b32_e32 v84, v100
	v_mov_b32_e32 v101, v100
	v_mov_b32_e32 v102, v100
	v_mov_b32_e32 v103, v100
...
.LBB0_60:
	...
	v_mov_b32_e32 v3, s6
	global_atomic_add v3, v135, v3, s[34:35] sc0
.LBB0_63:
	s_or_b64 exec, exec, s[8:9]
