...
.LBB0_18:
	...
	v_add_co_u32_e32 v106, vcc, s90, v114
...
.LBB0_22:
	...
	v_lshl_or_b32 v102, s92, 11, v116
	v_ashrrev_i32_e32 v103, 31, v102
	v_lshl_add_u64 v[102:103], v[102:103], 2, s[80:81]
	s_add_i32 s4, s94, s75
	s_lshl_b32 s4, s4, 12
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v101, v101, v101
	v_max_f32_e32 v141, v84, v101
	;;#ASMSTART
	v_add_f32 v84, v100, v135
	;;#ASMEND
	v_mov_b32_e32 v101, v100
	v_cmp_gt_f32_e32 vcc, v141, v84
	...
	;;#ASMSTART
	v_add_f32 v84, v141, v136
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v100, v100, v84
	v_exp_f32_e32 v140, v100
	v_mov_b32_e32 v100, v84
...
.LBB0_30:
	...
	s_cselect_b32 s6, s92, s94
	s_cselect_b32 s94, s93, s92
	s_cselect_b32 s92, s43, s93
	s_add_u32 s82, s82, 2
...
.LBB0_31:
	...
	v_lshl_or_b32 v100, s93, 11, v116
	...
	v_add_co_u32_e32 v100, vcc, s90, v100
	s_nop 1
...
.LBB0_35:
	...
	v_max_f32_e32 v141, v80, v81
	;;#ASMSTART
	v_add_f32 v80, v84, v135
	;;#ASMEND
	v_mov_b32_e32 v81, v84
	v_cmp_gt_f32_e32 vcc, v141, v80
	...
	;;#ASMSTART
	v_add_f32 v80, v141, v136
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v81, v84, v80
	v_exp_f32_e32 v140, v81
...
.LBB0_41:
	...
	v_mov_b32 v68, v0
	;;#ASMEND
	ds_bpermute_b32 v66, v133, v139
	v_lshrrev_b32_e32 v67, 1, v68
	v_and_b32_e32 v69, 31, v68
	v_and_or_b32 v67, v67, s45, v69
...
.LBB0_61:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v134, v3, s[98:99] sc0
.LBB0_64:
