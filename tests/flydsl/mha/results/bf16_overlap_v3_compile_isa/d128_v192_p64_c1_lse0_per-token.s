...
.LBB0_13:
	...
	v_lshl_add_u32 v7, s43, 8, v150
	s_mov_b32 s39, s7
	v_lshl_add_u32 v6, s43, 2, v119
	s_waitcnt vmcnt(0)
...
.LBB0_18:
	...
	v_and_or_b32 v136, v99, s45, v100
...
.LBB0_22:
	...
	ds_write_b128 v151, v[196:199] offset:8192
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_nop 0
...
.LBB0_26:
	...
	s_ashr_i32 s37, s36, 31
	buffer_load_dword v157, v98, s[4:7], 0 offen
	v_lshl_add_u64 v[98:99], s[36:37], 0, v[114:115]
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[0:1]
	global_load_dwordx4 v[192:195], v[98:99], off offset:512
	ds_write_b128 v151, v[204:207]
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s57, v157
	v_lshrrev_b32_e32 v100, 2, v98
	v_lshlrev_b32_e32 v99, 7, v98
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_b32_e32 v100, 8, v100
	v_and_b32_e32 v158, 48, v98
	v_and_or_b32 v159, v99, s45, v100
...
.LBB0_30:
	...
	ds_write_b128 v151, v[200:203] offset:8192
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_nop 0
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v157, v99, s45, v100
	v_and_b32_e32 v158, 48, v98
...
.LBB0_40:
	...
	v_and_or_b32 v134, v134, s44, v156
	v_add_u32_e32 v143, s58, v135
	v_add_u32_e32 v142, s55, v134
...
.LBB0_44:
	...
	v_lshrrev_b32_e32 v134, 1, v134
	v_and_or_b32 v134, v134, s44, v156
	v_add_u32_e32 v135, s58, v135
	v_add_u32_e32 v134, s55, v134
...
.LBB0_48:
	...
	v_and_or_b32 v200, v99, s45, v100
	v_or_b32_e32 v98, v200, v159
	v_lshlrev_b32_e32 v98, 1, v98
	ds_read_b128 v[202:205], v98 offset:8192
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[202:203], v[160:161], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[204:205], v[162:163], v[98:113]
	v_or_b32_e32 v158, 0x1010, v200
	v_xor_b32_e32 v158, v158, v159
	v_lshlrev_b32_e32 v158, 1, v158
	ds_read_b128 v[202:205], v158
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[202:203], v[164:165], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[204:205], v[166:167], v[98:113]
	v_or_b32_e32 v158, 0x1020, v200
	v_xor_b32_e32 v158, v158, v159
	v_lshlrev_b32_e32 v158, 1, v158
	ds_read_b128 v[202:205], v158
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[202:203], v[168:169], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[204:205], v[170:171], v[98:113]
	v_or_b32_e32 v158, 0x1030, v200
	v_xor_b32_e32 v158, v158, v159
	v_lshlrev_b32_e32 v158, 1, v158
	ds_read_b128 v[202:205], v158
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[202:203], v[172:173], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[204:205], v[174:175], v[98:113]
	v_or_b32_e32 v158, 0x1040, v200
	v_lshrrev_b32_e32 v159, 3, v158
	v_and_b32_e32 v159, 56, v159
	v_xor_b32_e32 v158, v159, v158
	v_lshlrev_b32_e32 v158, 1, v158
	...
	v_mfma_f32_32x32x8_bf16 v[98:113], v[204:205], v[178:179], v[98:113]
	v_or_b32_e32 v158, 0x1050, v200
	v_lshrrev_b32_e32 v159, 3, v158
	v_and_b32_e32 v159, 56, v159
	v_xor_b32_e32 v158, v159, v158
	v_lshlrev_b32_e32 v158, 1, v158
	...
	v_mfma_f32_32x32x8_bf16 v[98:113], v[204:205], v[182:183], v[98:113]
	v_or_b32_e32 v158, 0x1060, v200
	v_lshrrev_b32_e32 v159, 3, v158
	v_and_b32_e32 v159, 56, v159
	v_xor_b32_e32 v158, v159, v158
	v_lshlrev_b32_e32 v158, 1, v158
	...
	v_mfma_f32_32x32x8_bf16 v[98:113], v[204:205], v[186:187], v[98:113]
	v_or_b32_e32 v158, 0x1070, v200
	v_lshrrev_b32_e32 v159, 3, v158
	v_and_b32_e32 v159, 56, v159
	v_xor_b32_e32 v158, v159, v158
	v_lshlrev_b32_e32 v158, 1, v158
	...
	;;#ASMEND
	s_nop 0
	v_lshrrev_b32_e32 v159, 2, v158
	v_and_b32_e32 v159, 8, v159
	v_lshrrev_b32_e32 v158, 1, v158
	v_and_or_b32 v158, v158, s44, v156
	v_add_u32_e32 v159, s58, v159
	v_add_u32_e32 v158, s55, v158
	v_subrev_u32_e32 v200, 55, v159
	v_cmp_lt_i32_e32 vcc, v200, v158
	s_nop 1
	v_cndmask_b32_e32 v99, v155, v99, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 53, v159
	s_nop 0
	v_cndmask_b32_e32 v98, v155, v98, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 52, v159
	v_pk_mul_f32 v[98:99], v[116:117], v[98:99]
	v_cndmask_b32_e32 v100, v155, v100, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 51, v159
	s_nop 0
	v_cndmask_b32_e32 v101, v155, v101, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 50, v159
	v_pk_mul_f32 v[100:101], v[120:121], v[100:101]
	v_cndmask_b32_e32 v102, v155, v102, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 49, v159
	s_nop 0
	v_cndmask_b32_e32 v103, v155, v103, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 48, v159
	v_pk_mul_f32 v[102:103], v[122:123], v[102:103]
	v_cndmask_b32_e32 v104, v155, v104, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 39, v159
	s_nop 0
	v_cndmask_b32_e32 v105, v155, v105, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 38, v159
	v_pk_mul_f32 v[104:105], v[124:125], v[104:105]
	v_cndmask_b32_e32 v106, v155, v106, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 37, v159
	s_nop 0
	v_cndmask_b32_e32 v107, v155, v107, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 36, v159
	v_pk_mul_f32 v[106:107], v[126:127], v[106:107]
	v_cndmask_b32_e32 v108, v155, v108, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 35, v159
	s_nop 0
	v_cndmask_b32_e32 v109, v155, v109, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 34, v159
	v_pk_mul_f32 v[108:109], v[128:129], v[108:109]
	v_cndmask_b32_e32 v110, v155, v110, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 33, v159
	...
	s_nop 0
	v_cndmask_b32_e32 v112, v155, v112, vcc
	v_cmp_le_i32_e32 vcc, v159, v158
...
.LBB0_53:
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v158, v99, s45, v100
	v_and_b32_e32 v159, 48, v98
	...
	v_add_u32_e32 v159, s58, v159
	v_add_u32_e32 v158, s55, v158
	v_subrev_u32_e32 v200, 23, v159
	v_cmp_lt_i32_e32 vcc, v200, v158
	s_nop 1
	v_cndmask_b32_e32 v99, v155, v99, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 21, v159
	s_nop 0
	v_cndmask_b32_e32 v98, v155, v98, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 20, v159
	v_pk_mul_f32 v[98:99], v[116:117], v[98:99]
	v_cndmask_b32_e32 v100, v155, v100, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 19, v159
	s_nop 0
	v_cndmask_b32_e32 v101, v155, v101, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 18, v159
	v_pk_mul_f32 v[100:101], v[120:121], v[100:101]
	v_cndmask_b32_e32 v102, v155, v102, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_subrev_u32_e32 v200, 17, v159
	s_nop 0
	v_cndmask_b32_e32 v103, v155, v103, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_add_u32_e32 v200, -16, v159
	v_pk_mul_f32 v[102:103], v[122:123], v[102:103]
	v_cndmask_b32_e32 v104, v155, v104, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_add_u32_e32 v200, -7, v159
	s_nop 0
	v_cndmask_b32_e32 v105, v155, v105, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_add_u32_e32 v200, -6, v159
	v_pk_mul_f32 v[104:105], v[124:125], v[104:105]
	v_cndmask_b32_e32 v106, v155, v106, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_add_u32_e32 v200, -5, v159
	s_nop 0
	v_cndmask_b32_e32 v107, v155, v107, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_add_u32_e32 v200, -4, v159
	v_pk_mul_f32 v[106:107], v[126:127], v[106:107]
	v_cndmask_b32_e32 v108, v155, v108, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_add_u32_e32 v200, -3, v159
	s_nop 0
	v_cndmask_b32_e32 v109, v155, v109, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_add_u32_e32 v200, -2, v159
	v_pk_mul_f32 v[108:109], v[128:129], v[108:109]
	v_cndmask_b32_e32 v110, v155, v110, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_add_u32_e32 v200, -1, v159
	s_nop 0
	v_cndmask_b32_e32 v111, v155, v111, vcc
	v_cmp_le_i32_e32 vcc, v200, v158
	v_pk_mul_f32 v[110:111], v[130:131], v[110:111]
