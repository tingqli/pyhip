...
.LBB0_13:
	...
	buffer_load_dwordx4 v[176:179], v7, s[72:75], 0 offen
	buffer_load_dwordx4 v[180:183], v7, s[72:75], 0 offen offset:32
	buffer_load_dwordx4 v[184:187], v7, s[72:75], 0 offen offset:64
	buffer_load_dwordx4 v[188:191], v7, s[72:75], 0 offen offset:96
	buffer_load_dwordx4 v[192:195], v7, s[72:75], 0 offen offset:128
	buffer_load_dwordx4 v[196:199], v7, s[72:75], 0 offen offset:160
	s_addc_u32 s0, s61, s1
	s_lshl_b32 s70, s81, 6
	s_and_b32 s69, s0, 0xffff
	buffer_load_dword v2, v6, s[68:71], 0 offen
	buffer_load_dwordx4 v[200:203], v7, s[72:75], 0 offen offset:192
	buffer_load_dwordx4 v[204:207], v7, s[72:75], 0 offen offset:224
	s_waitcnt vmcnt(10)
...
.LBB0_18:
	...
	v_lshl_add_u64 v[96:97], v[96:97], 2, s[86:87]
	s_mov_b32 s8, s75
	s_mov_b32 s12, s83
	s_waitcnt vmcnt(0)
	...
	v_add_co_u32_e32 v96, vcc, s95, v96
	s_nop 1
...
.LBB0_22:
	...
	v_lshlrev_b32_e32 v66, 1, v66
	ds_read_b128 v[208:211], v66
	ds_write_b128 v152, v[164:167] offset:8192
	s_waitcnt lgkmcnt(8)
...
.LBB0_26:
	...
	v_lshl_add_u64 v[112:113], v[112:113], 2, s[86:87]
	...
	v_add_co_u32_e32 v122, vcc, s95, v122
	s_nop 1
...
.LBB0_34:
	...
	v_add_co_u32_e32 v112, vcc, s95, v112
	s_nop 1
...
.LBB0_38:
	...
	v_lshl_add_u64 v[114:115], v[114:115], 2, s[86:87]
	s_addk_i32 s13, 0x1000
	v_mfma_f32_32x32x8_bf16 v[66:81], v[134:135], v[178:179], v[66:81]
	...
	v_add_co_u32_e32 v114, vcc, s95, v114
	s_nop 1
...
.LBB0_53:
	...
	;;#ASMSTART
	v_perm_b32 v2, v3, v2, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v5, v4, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v7, v6, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v9, v8, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v11, v10, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v13, v12, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v15, v14, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v17, v16, s76
	;;#ASMEND
	s_barrier
	s_setprio 1
	s_waitcnt vmcnt(7)
...
.LBB0_55:
	...
	v_lshl_add_u64 v[82:83], v[82:83], 2, s[86:87]
	s_waitcnt vmcnt(0)
	...
	v_add_co_u32_e32 v82, vcc, s95, v82
	s_nop 1
...
.LBB0_59:
	...
	v_lshl_add_u64 v[84:85], v[84:85], 2, s[86:87]
	...
	v_add_co_u32_e32 v84, vcc, s95, v84
	s_nop 1
...
.LBB0_63:
	...
	v_add_co_u32_e32 v86, vcc, s95, v86
	s_nop 1
...
.LBB0_71:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[230:231], v[178:179], v[66:81]
	buffer_load_dword v159, v84, s[68:71], 0 offen
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s46, v159
	s_waitcnt lgkmcnt(7)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[212:213], v[180:181], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[214:215], v[182:183], v[66:81]
	s_waitcnt lgkmcnt(6)
...
.LBB0_80:
	...
	v_add_u32_e32 v9, 0x8000, v174
	v_add_u32_e32 v10, 0x8000, v173
	v_add_u32_e32 v8, 0x8000, v172
	v_add_u32_e32 v11, 0x8000, v171
	v_add_u32_e32 v7, 0x8000, v170
	v_add_u32_e32 v12, 0x8000, v169
	v_add_u32_e32 v6, 0x8000, v168
	v_add_u32_e32 v13, 0x8000, v167
	v_add_u32_e32 v5, 0x8000, v166
	v_add_u32_e32 v14, 0x8000, v165
	v_add_u32_e32 v4, 0x8000, v164
	v_add_u32_e32 v15, 0x8000, v163
	v_add_u32_e32 v3, 0x8000, v162
	v_add_u32_e32 v16, 0x8000, v161
	v_add_u32_e32 v2, 0x8000, v160
	v_add_u32_e32 v17, 0x8000, v159
	;;#ASMSTART
	v_perm_b32 v2, v2, v17, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v3, v16, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v4, v15, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v5, v14, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v6, v13, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v7, v12, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v8, v11, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v9, v10, s76
	;;#ASMEND
	s_barrier
	s_setprio 1
	s_waitcnt vmcnt(7)
...
.LBB0_84:
	...
	v_lshlrev_b32_e32 v2, 1, v2
	ds_read_b128 v[220:223], v2
	ds_write_b128 v152, v[208:211] offset:8192
	s_waitcnt lgkmcnt(8)
	...
	v_add_co_u32_e32 v18, vcc, s95, v18
	s_nop 1
...
.LBB0_89:
	...
	v_cndmask_b32_e32 v68, 0, v157, vcc
	v_readlane_b32 s6, v248, 0
	v_readlane_b32 s7, v248, 1
...
.LBB0_91:
	...
	;;#ASMSTART
	v_perm_b32 v28, v28, v34, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v29, v36, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v32, v38, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v33, v40, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v30, v42, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v31, v44, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v26, v46, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v27, v48, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v24, v50, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v25, v52, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v22, v54, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v21, v23, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v19, v20, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v17, v18, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v15, v16, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v12, v14, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v3, v2, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v5, v4, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v7, v6, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v9, v8, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v11, v10, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v13, v86, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v84, v85, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v82, v83, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v80, v81, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v78, v79, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v76, v77, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v74, v75, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v72, v73, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v70, v71, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v68, v69, s76
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v66, v67, s76
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v34, v0
	;;#ASMEND
...
.Lfunc_end0:
	...
	.set .Lattn_kernel_0.num_vgpr, 249
