...
.LBB0_13:
	...
	s_add_u32 s4, s54, s0
	buffer_load_dwordx4 v[172:175], v7, s[36:39], 0 offen
	buffer_load_dwordx4 v[176:179], v7, s[36:39], 0 offen offset:32
	buffer_load_dwordx4 v[180:183], v7, s[36:39], 0 offen offset:64
	buffer_load_dwordx4 v[184:187], v7, s[36:39], 0 offen offset:96
	buffer_load_dwordx4 v[188:191], v7, s[36:39], 0 offen offset:128
	buffer_load_dwordx4 v[192:195], v7, s[36:39], 0 offen offset:160
	s_addc_u32 s0, s55, s1
	s_lshl_b32 s6, s43, 6
	s_and_b32 s5, s0, 0xffff
	buffer_load_dword v2, v6, s[4:7], 0 offen
	buffer_load_dwordx4 v[196:199], v7, s[36:39], 0 offen offset:192
	buffer_load_dwordx4 v[200:203], v7, s[36:39], 0 offen offset:224
	s_waitcnt vmcnt(10)
...
.LBB0_15:
	...
	global_load_dwordx4 v[204:207], v[2:3], off offset:512
	s_waitcnt vmcnt(1) lgkmcnt(0)
	s_barrier
	s_setprio 0
	s_barrier
	s_setprio 1
	global_load_dwordx4 v[208:211], v[2:3], off offset:1024
...
.LBB0_17:
	...
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v150, v111, v110, s75
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v151, v113, v112, s75
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
	...
	s_add_u32 s0, s0, 2
	s_addc_u32 s1, s1, 0
	v_mov_b64_e32 v[150:151], s[64:65]
...
.LBB0_18:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[138:139], v[172:173], 0
	s_mov_b32 s12, s85
	s_waitcnt vmcnt(1)
...
.LBB0_22:
	...
	ds_write_b128 v166, v[208:211] offset:8192
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_nop 0
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[136:137], v[172:173], 0
...
.LBB0_26:
	...
	s_waitcnt vmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[50:65], v[216:217], v[100:101], v[50:65]
	s_waitcnt vmcnt(0)
	...
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v107, vcc
	v_mfma_f32_32x32x8_bf16 v[50:65], v[218:219], v[102:103], v[50:65]
	...
	v_mfma_f32_32x32x8_bf16 v[82:97], v[212:213], v[104:105], v[82:97]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[110:111], v[98:99], v[2:17]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[106:107], v[104:105], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[100:101], v[104:105], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[18:33], v[206:207], v[98:99], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[210:211], v[98:99], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[82:97], v[214:215], v[98:99], v[82:97]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[108:109], v[98:99], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[102:103], v[98:99], v[66:81]
	s_ashr_i32 s5, s4, 31
...
.LBB0_30:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[156:157], v[172:173], 0
...
.LBB0_34:
	...
	v_lshlrev_b32_e32 v98, 1, v98
	ds_read_b128 v[204:207], v98 offset:8192
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[204:205], v[172:173], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[206:207], v[174:175], v[98:113]
	v_or_b32_e32 v153, 0x1010, v151
	v_xor_b32_e32 v153, v153, v150
	v_lshlrev_b32_e32 v153, 1, v153
	ds_read_b128 v[204:207], v153
	s_waitcnt lgkmcnt(0)
	...
	ds_read_b128 v[204:207], v150
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[204:205], v[196:197], v[98:113]
	...
	ds_read_b128 v[204:207], v150
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[204:205], v[200:201], v[98:113]
...
.LBB0_38:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[158:159], v[172:173], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[160:161], v[174:175], v[98:113]
...
.LBB0_42:
	...
	v_mfma_f32_32x32x8_bf16 v[82:97], v[204:205], v[104:105], v[82:97]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[110:111], v[98:99], v[2:17]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[106:107], v[104:105], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[100:101], v[104:105], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[18:33], v[160:161], v[98:99], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[164:165], v[98:99], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[82:97], v[206:207], v[98:99], v[82:97]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[108:109], v[98:99], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[102:103], v[98:99], v[66:81]
	s_ashr_i32 s5, s4, 31
	v_lshl_add_u64 v[98:99], s[4:5], 0, v[114:115]
...
.LBB0_46:
	...
	v_mfma_f32_32x32x8_bf16 v[50:65], v[108:109], v[98:99], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[102:103], v[98:99], v[66:81]
	global_load_dwordx4 v[208:211], v[150:151], off offset:1024
	ds_write_b128 v166, v[212:215] offset:8192
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_nop 0
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[154:155], v[172:173], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[156:157], v[174:175], v[98:113]
	v_or_b32_e32 v153, 16, v150
	v_xor_b32_e32 v153, v153, v151
	v_lshlrev_b32_e32 v153, 1, v153
	ds_read_b128 v[154:157], v153
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[154:155], v[176:177], v[98:113]
...
.LBB0_71:
	...
	s_waitcnt vmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[2:17], v[216:217], v[100:101], v[2:17]
	v_add_co_u32_e32 v100, vcc, s76, v106
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v107, vcc
	v_mfma_f32_32x32x8_bf16 v[82:97], v[110:111], v[102:103], v[82:97]
	...
	v_mfma_f32_32x32x8_bf16 v[2:17], v[218:219], v[102:103], v[2:17]
	s_waitcnt vmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[82:97], v[108:109], v[104:105], v[82:97]
	global_load_dwordx4 v[106:109], v[100:101], off
	s_nop 0
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[150:151], v[200:201], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[152:153], v[202:203], v[98:113]
	s_waitcnt vmcnt(1) lgkmcnt(0)
	s_barrier
	s_setprio 0
	;;#ASMSTART
...
.LBB0_76:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[162:163], v[172:173], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[164:165], v[174:175], v[98:113]
	v_or_b32_e32 v153, 16, v151
	v_xor_b32_e32 v153, v153, v152
	v_lshlrev_b32_e32 v153, 1, v153
	...
	v_add_u32_e32 v151, s87, v151
	v_add_u32_e32 v152, 0xffffffa9, v151
	v_cmp_gt_i32_e32 vcc, s86, v152
	v_add_u32_e32 v152, 0xffffffaa, v151
	v_cmp_gt_i32_e64 s[0:1], s86, v152
	v_add_u32_e32 v152, 0xffffffab, v151
	v_cmp_gt_i32_e64 s[4:5], s86, v152
	v_add_u32_e32 v152, 0xffffffac, v151
	v_cmp_gt_i32_e64 s[6:7], s86, v152
	v_add_u32_e32 v152, 0xffffffad, v151
	v_cmp_gt_i32_e64 s[8:9], s86, v152
	v_add_u32_e32 v152, 0xffffffae, v151
	v_cmp_gt_i32_e64 s[10:11], s86, v152
	v_add_u32_e32 v152, 0xffffffaf, v151
	v_cmp_gt_i32_e64 s[12:13], s86, v152
	v_add_u32_e32 v152, 0xffffffb0, v151
	v_cmp_gt_i32_e64 s[14:15], s86, v152
	v_add_u32_e32 v152, 0xffffffb9, v151
	v_cmp_gt_i32_e64 s[16:17], s86, v152
	v_add_u32_e32 v152, 0xffffffba, v151
	v_cmp_gt_i32_e64 s[18:19], s86, v152
	v_add_u32_e32 v152, 0xffffffbb, v151
	v_cmp_gt_i32_e64 s[20:21], s86, v152
	v_add_u32_e32 v152, 0xffffffbc, v151
	v_cmp_gt_i32_e64 s[22:23], s86, v152
	v_add_u32_e32 v152, 0xffffffbd, v151
	v_cmp_gt_i32_e64 s[24:25], s86, v152
	v_add_u32_e32 v152, 0xffffffbe, v151
	v_cmp_gt_i32_e64 s[26:27], s86, v152
	v_add_u32_e32 v152, 0xffffffbf, v151
	v_subrev_u32_e32 v151, 64, v151
	v_cmp_gt_i32_e64 s[28:29], s86, v152
	v_cmp_gt_i32_e64 s[30:31], s86, v151
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
	s_or_b64 s[24:25], s[26:27], s[24:25]
	s_or_b64 s[22:23], s[24:25], s[22:23]
...
.LBB0_90:
	ds_bpermute_b32 v2, v167, v171
	s_waitcnt lgkmcnt(0)
	;;#ASMSTART
	v_add_f32 v2, v171, v2
	;;#ASMEND
	s_nop 0
