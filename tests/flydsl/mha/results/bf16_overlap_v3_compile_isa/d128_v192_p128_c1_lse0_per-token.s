...
.LBB0_13:
	...
	buffer_load_dwordx4 v[174:177], v7, s[4:7], 0 offen
	buffer_load_dwordx4 v[178:181], v7, s[4:7], 0 offen offset:32
	buffer_load_dwordx4 v[182:185], v7, s[4:7], 0 offen offset:64
	buffer_load_dwordx4 v[186:189], v7, s[4:7], 0 offen offset:96
	buffer_load_dwordx4 v[190:193], v7, s[4:7], 0 offen offset:128
	buffer_load_dwordx4 v[194:197], v7, s[4:7], 0 offen offset:160
	s_addc_u32 s0, s25, s1
	s_lshl_b32 s38, s13, 6
	s_and_b32 s37, s0, 0xffff
	buffer_load_dword v2, v6, s[36:39], 0 offen
	buffer_load_dwordx4 v[198:201], v7, s[4:7], 0 offen offset:192
	buffer_load_dwordx4 v[202:205], v7, s[4:7], 0 offen offset:224
	s_waitcnt vmcnt(10)
...
.LBB0_15:
	...
	v_mov_b32_e32 v68, v173
	v_mov_b32_e32 v69, v173
	v_mov_b32_e32 v70, v173
...
.LBB0_17:
	...
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v101, v100, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v100, v103, v102, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v105, v104, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v107, v106, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v109, v108, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v150, v111, v110, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v151, v113, v112, s48
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
	...
	v_add_co_u32_e32 v98, vcc, s49, v104
	s_nop 1
	...
	v_add_co_u32_e32 v98, vcc, s50, v104
	s_nop 1
	v_addc_co_u32_e32 v99, vcc, 0, v105, vcc
	...
	v_mov_b64_e32 v[150:151], s[30:31]
	v_cmp_lt_i64_e32 vcc, s[34:35], v[150:151]
	s_add_i32 s62, s62, 8
	s_mov_b32 s58, s64
	s_mov_b32 s38, s63
...
.LBB0_22:
	...
	ds_write_b128 v167, v[210:213] offset:8192
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_nop 0
...
.LBB0_26:
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v153, v99, s47, v100
...
.LBB0_46:
	...
	ds_write_b128 v167, v[214:217] offset:8192
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_nop 0
...
.LBB0_56:
	...
	v_and_or_b32 v134, v134, s46, v172
...
.LBB0_64:
	...
	v_and_or_b32 v153, v153, s46, v172
	v_add_u32_e32 v154, s60, v154
	v_add_u32_e32 v153, s57, v153
...
.LBB0_72:
	...
	v_and_or_b32 v150, v150, s46, v172
...
.LBB0_77:
	...
	v_and_or_b32 v151, v151, s46, v172
	v_add_u32_e32 v152, s60, v152
	v_add_u32_e32 v151, s57, v151
...
.LBB0_91:
	ds_bpermute_b32 v2, v168, v173
	s_waitcnt lgkmcnt(0)
	;;#ASMSTART
	v_add_f32 v2, v173, v2
	;;#ASMEND
	s_nop 0
	v_div_scale_f32 v3, s[0:1], v2, v2, s44
	v_rcp_f32_e32 v4, v3
	v_div_scale_f32 v5, vcc, s44, v2, s44
	...
	;;#ASMSTART
	v_perm_b32 v48, v5, v4, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v49, v7, v6, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v46, v9, v8, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v47, v11, v10, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v44, v13, v12, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v45, v15, v14, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v42, v17, v16, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v43, v35, v34, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v40, v37, v36, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v41, v39, v38, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v38, v69, v71, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v39, v65, v67, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v36, v61, v63, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v37, v57, v59, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v34, v53, v55, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v35, v51, v50, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v32, v52, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v33, v54, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v30, v56, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v31, v58, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v28, v28, v60, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v29, v62, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v26, v64, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v27, v66, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v24, v68, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v25, v70, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v22, v72, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v23, v74, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v20, v76, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v21, v78, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v18, v80, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v19, v82, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v112, v113, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v110, v111, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v108, v109, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v106, v107, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v104, v105, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v102, v103, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v100, v101, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v97, v99, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v85, v84, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v87, v86, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v89, v88, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v91, v90, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v93, v92, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v95, v94, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v2, v96, s48
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v3, v98, s48
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v50, v0
	;;#ASMEND
