...
.LBB0_13:
	...
	v_lshl_add_u32 v3, s45, 8, v1
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s31, v4
	s_add_i32 s54, s31, s40
	v_readfirstlane_b32 s34, v5
	s_add_i32 s12, s54, 0x100
	s_min_i32 s12, s12, s34
	s_sub_i32 s19, s12, s54
	s_waitcnt lgkmcnt(0)
	s_add_u32 s12, s22, s0
	s_addc_u32 s13, s23, s1
	s_add_u32 s0, s10, s0
	s_addc_u32 s1, s11, s1
	s_lshl_b32 s36, s54, 11
	...
	buffer_load_dwordx4 v[150:153], v3, s[12:15], 0 offen
	buffer_load_dwordx4 v[154:157], v3, s[12:15], 0 offen offset:32
	buffer_load_dwordx4 v[158:161], v3, s[12:15], 0 offen offset:64
	buffer_load_dwordx4 v[162:165], v3, s[12:15], 0 offen offset:96
	buffer_load_dwordx4 v[166:169], v3, s[12:15], 0 offen offset:128
	buffer_load_dwordx4 v[170:173], v3, s[12:15], 0 offen offset:160
	buffer_load_dwordx4 v[174:177], v3, s[12:15], 0 offen offset:192
	buffer_load_dwordx4 v[178:181], v3, s[12:15], 0 offen offset:224
	;;#ASMSTART
	v_mov_b32 v3, v0
	;;#ASMEND
	s_waitcnt vmcnt(9)
...
.LBB0_15:
	...
	s_lshr_b32 s0, s0, 28
	s_sub_i32 s41, s13, s12
	s_add_i32 s0, s45, s0
	s_sub_i32 s31, s31, s34
	s_lshl_b32 s34, s41, 7
	s_ashr_i32 s13, s0, 4
	s_and_b32 s0, s0, -16
	s_cmp_lg_u32 s45, s0
	...
	s_cselect_b64 s[34:35], -1, 0
	s_and_b64 s[30:31], s[34:35], s[30:31]
	s_subb_u32 s61, s36, 0
	s_lshl_b32 s30, s61, 1
...
.LBB0_17:
	...
	;;#ASMSTART
	v_perm_b32 v100, v99, v98, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v117, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v105, v104, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v107, v106, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v109, v108, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v111, v110, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v113, v112, s47
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
	...
	v_add_co_u32_e32 v100, vcc, s49, v106
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v107, vcc
...
.LBB0_18:
	...
	v_and_or_b32 v125, v99, s46, v100
...
.LBB0_20:
	...
	v_mov_b32 v106, v0
	;;#ASMEND
	s_mul_i32 s37, s38, 0x6000
	v_lshlrev_b32_e32 v107, 3, v106
	v_bfe_i32 v106, v106, 5, 1
	s_add_i32 s37, s37, s55
	v_and_b32_e32 v107, 0xf8, v107
	v_and_b32_e32 v106, 0x600, v106
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v117, v99, s46, v100
	v_and_b32_e32 v124, 48, v98
...
.LBB0_22:
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v147, v99, s46, v100
	...
	v_max3_f32 v117, v117, v110, v111
	v_max3_f32 v117, v117, v112, v113
	ds_bpermute_b32 v147, v143, v117
	s_waitcnt lgkmcnt(0)
...
.LBB0_26:
	...
	buffer_load_dword v147, v98, s[12:15], 0 offen
	...
	v_and_or_b32 v141, v99, s46, v100
...
.LBB0_28:
	...
	ds_bpermute_b32 v148, v143, v147
	s_waitcnt lgkmcnt(0)
...
.LBB0_35:
	...
	v_mov_b32_e32 v118, 0xff800000
.LBB0_36:
	s_add_i32 s34, s19, s60
	s_add_i32 s36, s34, 0x7f
	s_ashr_i32 s34, s36, 31
	s_lshr_b32 s34, s34, 25
	s_add_i32 s34, s36, s34
	s_ashr_i32 s39, s34, 7
	...
	s_min_i32 s34, s34, s41
	s_cmp_ge_i32 s30, s34
	s_cbranch_scc1 .LBB0_58
	s_lshl_b32 s36, s61, 8
	s_ashr_i32 s35, s34, 31
	v_mov_b32_e32 v120, v116
	v_mov_b32_e32 v121, v116
	v_or_b32_e32 v140, s40, v142
	s_or_b32 s60, s36, 0xf7
	s_lshl3_add_u32 s61, s61, 20
	s_branch .LBB0_40
.LBB0_38:
	s_or_b64 exec, exec, s[38:39]
...
.LBB0_39:
	...
	s_cselect_b32 s38, s56, s58
	s_cselect_b32 s58, s59, s56
	s_cselect_b32 s56, s62, s59
	s_add_u32 s30, s30, 2
...
.LBB0_40:
	...
	;;#ASMEND
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s62, v117
	v_lshrrev_b32_e32 v100, 2, v98
	v_lshlrev_b32_e32 v99, 7, v98
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_b32_e32 v100, 8, v100
	v_and_b32_e32 v122, 48, v98
	v_and_or_b32 v123, v99, s46, v100
	...
	v_and_or_b32 v117, v117, s50, v140
	v_add_u32_e32 v124, s60, v122
	v_add_u32_e32 v117, s57, v117
...
.LBB0_42:
	...
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v100, v101, v100, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v99, v98, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s47
	;;#ASMEND
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v122, v99, s46, v100
	...
	v_and_or_b32 v122, v122, s50, v140
	v_add_u32_e32 v123, s60, v123
...
.LBB0_44:
	...
	v_lshrrev_b32_e32 v117, 1, v117
	v_and_or_b32 v117, v117, s50, v140
	v_add_u32_e32 v147, s60, v147
	v_add_u32_e32 v117, s57, v117
	v_add_u32_e32 v148, 0xffffff49, v147
	v_cmp_lt_i32_e32 vcc, v148, v117
	s_nop 1
	v_cndmask_b32_e32 v99, v146, v99, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff4b, v147
	s_nop 0
	v_cndmask_b32_e32 v98, v146, v98, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff4c, v147
	v_pk_mul_f32 v[98:99], v[120:121], v[98:99]
	v_cndmask_b32_e32 v100, v146, v100, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff4d, v147
	s_nop 0
	v_cndmask_b32_e32 v101, v146, v101, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff4e, v147
	s_nop 0
	v_cndmask_b32_e32 v102, v146, v102, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff4f, v147
	s_nop 0
	v_cndmask_b32_e32 v103, v146, v103, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff50, v147
	s_nop 0
	v_cndmask_b32_e32 v104, v146, v104, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff59, v147
	s_nop 0
	v_cndmask_b32_e32 v105, v146, v105, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff5a, v147
	s_nop 0
	v_cndmask_b32_e32 v106, v146, v106, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff5b, v147
	s_nop 0
	v_cndmask_b32_e32 v107, v146, v107, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff5c, v147
	s_nop 0
	v_cndmask_b32_e32 v108, v146, v108, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff5d, v147
	s_nop 0
	v_cndmask_b32_e32 v109, v146, v109, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff5e, v147
	s_nop 0
	v_cndmask_b32_e32 v110, v146, v110, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_add_u32_e32 v148, 0xffffff5f, v147
	v_add_u32_e32 v147, 0xffffff60, v147
	v_cndmask_b32_e32 v111, v146, v111, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	s_nop 1
	v_cndmask_b32_e32 v112, v146, v112, vcc
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v148, v148, v148
	v_max_f32_e32 v149, v147, v148
	;;#ASMSTART
	v_add_f32 v147, v118, v144
	;;#ASMEND
	v_mov_b32_e32 v148, 1.0
	v_cmp_gt_f32_e32 vcc, v149, v147
	v_mov_b32_e32 v147, 1.0
	s_and_saveexec_b64 s[36:37], vcc
	s_cbranch_execz .LBB0_46
	;;#ASMSTART
	v_add_f32 v122, v149, v145
	;;#ASMEND
	s_nop 0
...
.LBB0_46:
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v148, v99, s46, v100
	v_and_b32_e32 v149, 48, v98
	v_or_b32_e32 v98, v148, v149
	v_lshlrev_b32_e32 v98, 1, v98
	ds_read_b128 v[190:193], v98
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[190:191], v[150:151], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[192:193], v[152:153], v[98:113]
	v_or_b32_e32 v190, 16, v148
	v_xor_b32_e32 v190, v190, v149
	v_lshlrev_b32_e32 v190, 1, v190
	ds_read_b128 v[190:193], v190
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[190:191], v[154:155], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[192:193], v[156:157], v[98:113]
	v_or_b32_e32 v190, 32, v148
	v_xor_b32_e32 v190, v190, v149
	v_lshlrev_b32_e32 v190, 1, v190
	ds_read_b128 v[190:193], v190
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[190:191], v[158:159], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[192:193], v[160:161], v[98:113]
	v_or_b32_e32 v190, 48, v148
	v_xor_b32_e32 v149, v190, v149
	v_lshlrev_b32_e32 v149, 1, v149
	ds_read_b128 v[190:193], v149
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[190:191], v[162:163], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[192:193], v[164:165], v[98:113]
	v_or_b32_e32 v149, 64, v148
	v_lshrrev_b32_e32 v190, 3, v149
	v_and_b32_e32 v190, 56, v190
	v_xor_b32_e32 v149, v190, v149
	v_lshlrev_b32_e32 v149, 1, v149
	ds_read_b128 v[190:193], v149
	s_waitcnt lgkmcnt(0)
	...
	;;#ASMEND
	s_nop 0
	v_lshrrev_b32_e32 v149, 2, v148
	v_and_b32_e32 v149, 8, v149
	v_lshrrev_b32_e32 v148, 1, v148
	v_and_or_b32 v148, v148, s50, v140
	v_add_u32_e32 v149, s60, v149
	v_add_u32_e32 v148, s57, v148
	v_add_u32_e32 v190, 0xffffff69, v149
	v_cmp_lt_i32_e32 vcc, v190, v148
	s_nop 1
	v_cndmask_b32_e32 v99, v146, v99, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff6b, v149
	s_nop 0
	v_cndmask_b32_e32 v98, v146, v98, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff6c, v149
	v_pk_mul_f32 v[98:99], v[120:121], v[98:99]
	v_cndmask_b32_e32 v100, v146, v100, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff6d, v149
	s_nop 0
	v_cndmask_b32_e32 v101, v146, v101, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff6e, v149
	v_pk_mul_f32 v[100:101], v[116:117], v[100:101]
	v_cndmask_b32_e32 v102, v146, v102, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff6f, v149
	s_nop 0
	v_cndmask_b32_e32 v103, v146, v103, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff70, v149
	v_pk_mul_f32 v[102:103], v[116:117], v[102:103]
	v_cndmask_b32_e32 v104, v146, v104, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff79, v149
	s_nop 0
	v_cndmask_b32_e32 v105, v146, v105, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff7a, v149
	v_pk_mul_f32 v[104:105], v[116:117], v[104:105]
	v_cndmask_b32_e32 v106, v146, v106, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff7b, v149
	s_nop 0
	v_cndmask_b32_e32 v107, v146, v107, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff7c, v149
	v_pk_mul_f32 v[106:107], v[116:117], v[106:107]
	v_cndmask_b32_e32 v108, v146, v108, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff7d, v149
	s_nop 0
	v_cndmask_b32_e32 v109, v146, v109, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff7e, v149
	v_pk_mul_f32 v[108:109], v[116:117], v[108:109]
	v_cndmask_b32_e32 v110, v146, v110, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_add_u32_e32 v190, 0xffffff7f, v149
	v_add_u32_e32 v149, 0xffffff80, v149
	v_cndmask_b32_e32 v111, v146, v111, vcc
	v_cmp_le_i32_e32 vcc, v190, v148
	v_pk_mul_f32 v[110:111], v[116:117], v[110:111]
	s_nop 0
	v_cndmask_b32_e32 v112, v146, v112, vcc
	v_cmp_le_i32_e32 vcc, v149, v148
	s_nop 1
	v_cndmask_b32_e32 v113, v146, v113, vcc
	v_pk_mul_f32 v[112:113], v[116:117], v[112:113]
	v_max_f32_e32 v117, v98, v99
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v148, v148, v148
	v_max_f32_e32 v117, v117, v148
	;;#ASMSTART
	v_add_f32 v148, v118, v144
	;;#ASMEND
	s_nop 0
	v_cmp_gt_f32_e32 vcc, v117, v148
	s_and_saveexec_b64 s[36:37], vcc
...
.LBB0_48:
	...
	v_and_or_b32 v139, v99, s46, v100
...
.LBB0_51:
	...
	v_and_or_b32 v141, v99, s46, v100
	v_and_b32_e32 v147, 48, v98
	v_or_b32_e32 v98, v141, v147
	v_lshlrev_b32_e32 v98, 1, v98
	ds_read_b128 v[182:185], v98
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[182:183], v[150:151], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[184:185], v[152:153], v[98:113]
	v_or_b32_e32 v148, 16, v141
	v_xor_b32_e32 v148, v148, v147
	v_lshlrev_b32_e32 v148, 1, v148
	ds_read_b128 v[182:185], v148
	s_waitcnt lgkmcnt(0)
	...
	;;#ASMEND
	s_nop 0
	v_lshrrev_b32_e32 v147, 2, v141
	v_and_b32_e32 v147, 8, v147
	v_lshrrev_b32_e32 v141, 1, v141
	v_and_or_b32 v141, v141, s50, v140
	v_add_u32_e32 v147, s60, v147
	v_add_u32_e32 v141, s57, v141
	v_add_u32_e32 v148, 0xffffffa9, v147
	v_cmp_lt_i32_e32 vcc, v148, v141
	s_nop 1
	v_cndmask_b32_e32 v99, v146, v99, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffab, v147
	s_nop 0
	v_cndmask_b32_e32 v98, v146, v98, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffac, v147
	v_pk_mul_f32 v[98:99], v[120:121], v[98:99]
	v_cndmask_b32_e32 v100, v146, v100, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffad, v147
	s_nop 0
	v_cndmask_b32_e32 v101, v146, v101, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffae, v147
	v_pk_mul_f32 v[100:101], v[116:117], v[100:101]
	v_cndmask_b32_e32 v102, v146, v102, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffaf, v147
	s_nop 0
	v_cndmask_b32_e32 v103, v146, v103, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffb0, v147
	v_pk_mul_f32 v[102:103], v[116:117], v[102:103]
	v_cndmask_b32_e32 v104, v146, v104, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffb9, v147
	s_nop 0
	v_cndmask_b32_e32 v105, v146, v105, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffba, v147
	v_pk_mul_f32 v[104:105], v[116:117], v[104:105]
	v_cndmask_b32_e32 v106, v146, v106, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffbb, v147
	s_nop 0
	v_cndmask_b32_e32 v107, v146, v107, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffbc, v147
	v_pk_mul_f32 v[106:107], v[116:117], v[106:107]
	v_cndmask_b32_e32 v108, v146, v108, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffbd, v147
	s_nop 0
	v_cndmask_b32_e32 v109, v146, v109, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffbe, v147
	v_pk_mul_f32 v[108:109], v[116:117], v[108:109]
	v_cndmask_b32_e32 v110, v146, v110, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_add_u32_e32 v148, 0xffffffbf, v147
	v_subrev_u32_e32 v147, 64, v147
	v_cndmask_b32_e32 v111, v146, v111, vcc
	v_cmp_le_i32_e32 vcc, v148, v141
	v_pk_mul_f32 v[110:111], v[116:117], v[110:111]
	s_nop 0
	v_cndmask_b32_e32 v112, v146, v112, vcc
	v_cmp_le_i32_e32 vcc, v147, v141
	s_nop 1
	v_cndmask_b32_e32 v113, v146, v113, vcc
	v_pk_mul_f32 v[112:113], v[116:117], v[112:113]
	v_max_f32_e32 v117, v98, v99
...
.LBB0_53:
	...
	v_add_u32_e32 v147, s60, v147
	v_add_u32_e32 v117, s57, v117
	v_subrev_u32_e32 v148, 55, v147
	v_cmp_lt_i32_e32 vcc, v148, v117
	s_nop 1
	v_cndmask_b32_e32 v99, v146, v99, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 53, v147
	s_nop 0
	v_cndmask_b32_e32 v98, v146, v98, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 52, v147
	v_pk_mul_f32 v[98:99], v[120:121], v[98:99]
	v_cndmask_b32_e32 v100, v146, v100, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 51, v147
	s_nop 0
	v_cndmask_b32_e32 v101, v146, v101, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 50, v147
	s_nop 0
	v_cndmask_b32_e32 v102, v146, v102, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 49, v147
	s_nop 0
	v_cndmask_b32_e32 v103, v146, v103, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 48, v147
	s_nop 0
	v_cndmask_b32_e32 v104, v146, v104, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 39, v147
	s_nop 0
	v_cndmask_b32_e32 v105, v146, v105, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 38, v147
	s_nop 0
	v_cndmask_b32_e32 v106, v146, v106, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 37, v147
	s_nop 0
	v_cndmask_b32_e32 v107, v146, v107, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 36, v147
	s_nop 0
	v_cndmask_b32_e32 v108, v146, v108, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 35, v147
	s_nop 0
	v_cndmask_b32_e32 v109, v146, v109, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 34, v147
	s_nop 0
	v_cndmask_b32_e32 v110, v146, v110, vcc
	v_cmp_le_i32_e32 vcc, v148, v117
	v_subrev_u32_e32 v148, 33, v147
...
.LBB0_55:
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v138, v99, s46, v100
	...
	v_mfma_f32_32x32x8_bf16 v[98:113], v[190:191], v[150:151], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[192:193], v[152:153], v[98:113]
	v_or_b32_e32 v148, 16, v138
	v_xor_b32_e32 v148, v148, v139
	v_lshlrev_b32_e32 v148, 1, v148
	ds_read_b128 v[190:193], v148
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[190:191], v[154:155], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[192:193], v[156:157], v[98:113]
	v_or_b32_e32 v148, 32, v138
	v_xor_b32_e32 v148, v148, v139
	v_lshlrev_b32_e32 v148, 1, v148
	ds_read_b128 v[190:193], v148
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[190:191], v[158:159], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[192:193], v[160:161], v[98:113]
	v_or_b32_e32 v148, 48, v138
	v_xor_b32_e32 v139, v148, v139
	...
	v_and_or_b32 v138, v138, s50, v140
	v_add_u32_e32 v139, s60, v139
	v_add_u32_e32 v138, s57, v138
	v_subrev_u32_e32 v148, 23, v139
	v_cmp_lt_i32_e32 vcc, v148, v138
	s_nop 1
	v_cndmask_b32_e32 v99, v146, v99, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_subrev_u32_e32 v148, 21, v139
	s_nop 0
	v_cndmask_b32_e32 v98, v146, v98, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_subrev_u32_e32 v148, 20, v139
	v_pk_mul_f32 v[98:99], v[120:121], v[98:99]
	v_cndmask_b32_e32 v100, v146, v100, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_subrev_u32_e32 v148, 19, v139
	s_nop 0
	v_cndmask_b32_e32 v101, v146, v101, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_subrev_u32_e32 v148, 18, v139
	v_pk_mul_f32 v[100:101], v[116:117], v[100:101]
	v_cndmask_b32_e32 v102, v146, v102, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_subrev_u32_e32 v148, 17, v139
	s_nop 0
	v_cndmask_b32_e32 v103, v146, v103, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_add_u32_e32 v148, -16, v139
	v_pk_mul_f32 v[102:103], v[116:117], v[102:103]
	v_cndmask_b32_e32 v104, v146, v104, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_add_u32_e32 v148, -7, v139
	s_nop 0
	v_cndmask_b32_e32 v105, v146, v105, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_add_u32_e32 v148, -6, v139
	v_pk_mul_f32 v[104:105], v[116:117], v[104:105]
	v_cndmask_b32_e32 v106, v146, v106, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_add_u32_e32 v148, -5, v139
	s_nop 0
	v_cndmask_b32_e32 v107, v146, v107, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_add_u32_e32 v148, -4, v139
	v_pk_mul_f32 v[106:107], v[116:117], v[106:107]
	v_cndmask_b32_e32 v108, v146, v108, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_add_u32_e32 v148, -3, v139
	s_nop 0
	v_cndmask_b32_e32 v109, v146, v109, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_add_u32_e32 v148, -2, v139
	v_pk_mul_f32 v[108:109], v[116:117], v[108:109]
	v_cndmask_b32_e32 v110, v146, v110, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_add_u32_e32 v148, -1, v139
	s_nop 0
	v_cndmask_b32_e32 v111, v146, v111, vcc
	v_cmp_le_i32_e32 vcc, v148, v138
	v_pk_mul_f32 v[110:111], v[116:117], v[110:111]
...
.LBB0_58:
	...
	;;#ASMEND
	s_nop 0
	v_div_scale_f32 v99, s[0:1], v98, v98, s44
	v_rcp_f32_e32 v100, v99
	v_div_scale_f32 v101, vcc, s44, v98, s44
	...
	v_div_fixup_f32 v98, v99, v98, s44
	...
	;;#ASMSTART
	v_perm_b32 v48, v3, v2, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v49, v5, v4, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v46, v7, v6, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v47, v9, v8, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v44, v11, v10, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v45, v13, v12, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v42, v15, v14, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v43, v17, v16, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v40, v19, v18, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v41, v21, v20, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v38, v23, v22, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v39, v25, v24, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v36, v27, v26, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v37, v29, v28, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v34, v31, v30, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v35, v33, v32, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v112, v113, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v110, v111, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v108, v109, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v106, v107, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v28, v104, v105, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v102, v103, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v100, v101, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v98, v99, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v51, v50, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v53, v52, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v55, v54, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v57, v56, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v59, v58, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v61, v60, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v63, v62, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v65, v64, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v67, v66, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v69, v68, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v71, v70, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v73, v72, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v75, v74, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v77, v76, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v79, v78, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v81, v80, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v83, v82, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v85, v84, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v87, v86, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v89, v88, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v91, v90, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v93, v92, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v95, v94, s47
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v97, v96, s47
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v50, v0
	;;#ASMEND
...
.LBB0_62:
	...
	s_barrier
.LBB0_63:
	v_mul_u32_u24_sdwa v95, v94, s51 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
.LBB0_90:
	...
	s_barrier
.LBB0_91:
	v_mul_u32_u24_sdwa v2, v88, s51 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
