...
.LBB0_13:
	...
	global_load_dwordx2 v[4:5], v106, s[4:5]
	global_load_dword v2, v106, s[68:69]
	...
	s_ashr_i32 s5, s4, 31
	global_load_dwordx2 v[4:5], v106, s[6:7]
	global_load_dword v6, v106, s[0:1]
	s_lshl_b64 s[0:1], s[4:5], 1
	s_add_u32 s76, s46, s0
	s_addc_u32 s0, s47, s1
	s_mul_i32 s78, s81, 0x1800
	s_and_b32 s77, s0, 0xffff
	buffer_load_dwordx4 v[128:131], v3, s[76:79], 0 offen
	buffer_load_dwordx4 v[132:135], v3, s[76:79], 0 offen offset:32
	buffer_load_dwordx4 v[136:139], v3, s[76:79], 0 offen offset:64
	buffer_load_dwordx4 v[140:143], v3, s[76:79], 0 offen offset:96
	buffer_load_dwordx4 v[144:147], v3, s[76:79], 0 offen offset:128
	buffer_load_dwordx4 v[148:151], v3, s[76:79], 0 offen offset:160
	buffer_load_dwordx4 v[152:155], v3, s[76:79], 0 offen offset:192
	buffer_load_dwordx4 v[156:159], v3, s[76:79], 0 offen offset:224
	buffer_load_dwordx4 v[160:163], v3, s[76:79], 0 offen offset:256
	buffer_load_dwordx4 v[164:167], v3, s[76:79], 0 offen offset:288
	buffer_load_dwordx4 v[168:171], v3, s[76:79], 0 offen offset:320
	buffer_load_dwordx4 v[172:175], v3, s[76:79], 0 offen offset:352
	;;#ASMSTART
	v_mov_b32 v3, v0
	;;#ASMEND
	s_waitcnt vmcnt(13)
...
.LBB0_15:
	...
	s_subb_u32 s71, s7, 0
	s_mul_i32 s4, s71, 0x1800
	s_ashr_i32 s5, s4, 31
	s_lshl_b64 s[4:5], s[4:5], 1
	s_add_u32 s94, s48, s4
	s_addc_u32 s95, s49, s5
	s_ashr_i32 s1, s0, 31
	...
	v_add_u32_sdwa v4, s4, v85 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
...
.LBB0_19:
	...
	ds_write_b128 v104, v[116:119] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[0:1]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_26:
	...
	ds_write_b128 v104, v[120:123] offset:12288
	ds_write_b128 v104, v[124:127] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v66, v0
...
.LBB0_30:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[208:209], v[128:129], 0
	;;#ASMSTART
	v_mov_b32 v83, v0
	;;#ASMEND
	s_add_i32 s4, s11, s71
	v_lshlrev_b32_e32 v84, 3, v83
	v_lshlrev_b32_e32 v83, 5, v83
	s_lshl_b32 s4, s4, 12
	v_and_b32_e32 v84, 0xf8, v84
	v_and_b32_e32 v83, 0x400, v83
	v_mfma_f32_32x32x8_bf16 v[66:81], v[210:211], v[130:131], v[66:81]
	v_or3_b32 v102, v84, v83, s4
	v_ashrrev_i32_e32 v103, 31, v102
	v_lshl_add_u64 v[102:103], v[102:103], 1, s[82:83]
	global_load_dwordx4 v[216:219], v[102:103], off
	s_waitcnt lgkmcnt(10)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[90:91], v[132:133], v[66:81]
	v_add_co_u32_e32 v90, vcc, s72, v102
	s_nop 1
	v_addc_co_u32_e32 v91, vcc, 0, v103, vcc
	v_mfma_f32_32x32x8_bf16 v[66:81], v[92:93], v[134:135], v[66:81]
	s_waitcnt lgkmcnt(9)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[94:95], v[136:137], v[66:81]
	global_load_dwordx4 v[220:223], v[102:103], off offset:512
	global_load_dwordx4 v[208:211], v[102:103], off offset:1024
	v_mfma_f32_32x32x8_bf16 v[66:81], v[96:97], v[138:139], v[66:81]
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[98:99], v[140:141], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[100:101], v[142:143], v[66:81]
	global_load_dwordx4 v[212:215], v[102:103], off offset:1536
...
.LBB0_36:
	s_or_b64 exec, exec, s[4:5]
	s_waitcnt lgkmcnt(11)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[180:181], v[128:129], 0
	;;#ASMSTART
	v_mov_b32 v83, v0
	;;#ASMEND
	s_add_i32 s4, s87, s71
	v_lshlrev_b32_e32 v84, 3, v83
	v_lshlrev_b32_e32 v83, 5, v83
	s_lshl_b32 s4, s4, 12
	v_and_b32_e32 v84, 0xf8, v84
	v_and_b32_e32 v83, 0x400, v83
	v_mfma_f32_32x32x8_bf16 v[66:81], v[182:183], v[130:131], v[66:81]
	v_or3_b32 v102, v84, v83, s4
	v_ashrrev_i32_e32 v103, 31, v102
	v_lshl_add_u64 v[102:103], v[102:103], 1, s[82:83]
	...
	s_waitcnt lgkmcnt(7)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[98:99], v[144:145], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[100:101], v[146:147], v[66:81]
	s_waitcnt lgkmcnt(6)
	...
	global_load_dwordx4 v[176:179], v[90:91], off offset:1536
	s_waitcnt lgkmcnt(4)
...
.LBB0_41:
	...
	v_mfma_f32_32x32x8_bf16 v[18:33], v[216:217], v[70:71], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[208:209], v[70:71], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[176:177], v[70:71], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[214:215], v[72:73], v[2:17]
	v_mfma_f32_32x32x8_bf16 v[18:33], v[218:219], v[72:73], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[210:211], v[72:73], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[178:179], v[72:73], v[50:65]
	;;#ASMSTART
	v_mov_b32 v66, v0
	;;#ASMEND
...
.LBB0_42:
	...
	s_cselect_b32 s11, s86, s87
	s_cselect_b32 s87, s88, s86
	s_cselect_b32 s86, s43, s88
	s_add_u32 s96, s96, 2
...
.LBB0_47:
	...
	v_and_b32_e32 v83, 0x400, v83
	v_mfma_f32_32x32x8_bf16 v[66:81], v[210:211], v[130:131], v[66:81]
	v_or3_b32 v88, v88, v83, s0
	v_ashrrev_i32_e32 v89, 31, v88
	v_lshl_add_u64 v[88:89], v[88:89], 1, s[82:83]
	global_load_dwordx4 v[216:219], v[88:89], off
	s_waitcnt lgkmcnt(10)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[90:91], v[132:133], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[92:93], v[134:135], v[66:81]
	s_waitcnt lgkmcnt(9)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[94:95], v[136:137], v[66:81]
	global_load_dwordx4 v[220:223], v[88:89], off offset:512
	global_load_dwordx4 v[208:211], v[88:89], off offset:1024
	v_mfma_f32_32x32x8_bf16 v[66:81], v[96:97], v[138:139], v[66:81]
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[98:99], v[140:141], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[100:101], v[142:143], v[66:81]
	global_load_dwordx4 v[212:215], v[88:89], off offset:1536
	...
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[180:181], v[148:149], v[66:81]
	global_load_dwordx4 v[176:179], v[88:89], off offset:512
	...
	v_cndmask_b32_e64 v69, v109, v69, s[6:7]
	v_cndmask_b32_e64 v68, v109, v68, s[4:5]
	v_cndmask_b32_e64 v89, v109, v67, s[0:1]
	v_cndmask_b32_e32 v88, v109, v66, vcc
	v_mov_b32_e32 v83, v82
	v_cndmask_b32_e64 v81, v109, v81, s[30:31]
	v_cndmask_b32_e64 v80, v109, v80, s[28:29]
	v_cndmask_b32_e64 v79, v109, v79, s[26:27]
	v_cndmask_b32_e64 v78, v109, v78, s[24:25]
	v_cndmask_b32_e64 v77, v109, v77, s[22:23]
	v_cndmask_b32_e64 v76, v109, v76, s[20:21]
	v_cndmask_b32_e64 v75, v109, v75, s[18:19]
	v_cndmask_b32_e64 v74, v109, v74, s[16:17]
	v_cndmask_b32_e64 v73, v109, v73, s[14:15]
	v_cndmask_b32_e64 v72, v109, v72, s[12:13]
	v_cndmask_b32_e64 v71, v109, v71, s[10:11]
	v_cndmask_b32_e64 v70, v109, v70, s[8:9]
...
.LBB0_54:
	...
	global_load_dwordx4 v[220:223], v[88:89], off offset:1024
	v_mfma_f32_32x32x8_bf16 v[66:81], v[96:97], v[138:139], v[66:81]
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[98:99], v[140:141], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[100:101], v[142:143], v[66:81]
	global_load_dwordx4 v[224:227], v[88:89], off offset:1536
	v_add_co_u32_e32 v88, vcc, s72, v88
	s_nop 1
	v_addc_co_u32_e32 v89, vcc, 0, v89, vcc
	global_load_dwordx4 v[212:215], v[88:89], off
	s_waitcnt lgkmcnt(7)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[176:177], v[144:145], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[178:179], v[146:147], v[66:81]
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[180:181], v[148:149], v[66:81]
	global_load_dwordx4 v[216:219], v[88:89], off offset:512
	global_load_dwordx4 v[208:211], v[88:89], off offset:1024
	v_mfma_f32_32x32x8_bf16 v[66:81], v[182:183], v[150:151], v[66:81]
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[184:185], v[152:153], v[66:81]
	...
	s_or_b64 s[0:1], s[4:5], s[0:1]
	s_or_b64 vcc, s[0:1], vcc
	v_cndmask_b32_e64 v67, v109, v67, s[0:1]
...
.LBB0_75:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v106, v3, s[90:91] sc0
.LBB0_78:
	...
	global_store_dword v106, v2, s[6:7]
	s_waitcnt vmcnt(0)
.LBB0_79:
	s_or_b64 exec, exec, s[4:5]
	s_lshl_b64 s[0:1], s[0:1], 2
...
.LBB0_82:
	...
	global_load_dwordx2 v[2:3], v106, s[6:7] offset:4
	s_waitcnt vmcnt(0)
