...
.LBB0_22:
	...
	global_load_dwordx4 v[150:153], v[114:115], off offset:512
	;;#ASMSTART
	v_mov_b32 v112, v0
	;;#ASMEND
	s_nop 0
	...
	global_load_dwordx4 v[186:189], v[114:115], off offset:512
	global_load_dwordx4 v[174:177], v[114:115], off offset:1024
	s_waitcnt lgkmcnt(4)
	...
	global_load_dwordx4 v[178:181], v[114:115], off offset:1536
	...
	global_load_dwordx4 v[170:173], v[114:115], off offset:512
	...
	ds_bpermute_b32 v114, v107, v112
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v114, v114, v114
	v_max_f32_e32 v115, v112, v114
	;;#ASMSTART
	v_add_f32 v112, v86, v108
	;;#ASMEND
	v_mov_b32_e32 v114, 1.0
	v_cmp_gt_f32_e32 vcc, v115, v112
	v_mov_b32_e32 v112, 1.0
	s_and_saveexec_b64 s[40:41], vcc
...
.LBB0_36:
	...
	v_lshl_add_u64 v[150:151], s[42:43], 0, v[82:83]
	v_lshl_add_u64 v[150:151], v[150:151], 2, s[16:17]
	...
	v_ashrrev_i32_e32 v115, 31, v114
	v_lshl_add_u64 v[114:115], v[114:115], 1, s[24:25]
	global_load_dwordx4 v[190:193], v[114:115], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[116:117], v[128:129], v[66:81]
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[162:163], v[130:131], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[164:165], v[132:133], v[66:81]
	global_load_dwordx4 v[194:197], v[114:115], off offset:512
	...
	s_waitcnt lgkmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[170:171], v[138:139], v[66:81]
	global_load_dwordx4 v[186:189], v[114:115], off offset:1536
	v_add_co_u32_e32 v114, vcc, s82, v114
	s_nop 1
	v_addc_co_u32_e32 v115, vcc, 0, v115, vcc
	global_load_dwordx4 v[178:181], v[114:115], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[172:173], v[140:141], v[66:81]
	s_waitcnt lgkmcnt(2)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[174:175], v[142:143], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[176:177], v[144:145], v[66:81]
	...
	global_load_dwordx4 v[162:165], v[114:115], off offset:1536
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[158:159], v[146:147], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[160:161], v[148:149], v[66:81]
	s_waitcnt vmcnt(9) lgkmcnt(0)
	...
	ds_bpermute_b32 v115, v107, v114
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v115, v115, v115
	v_max_f32_e32 v116, v114, v115
	;;#ASMSTART
	v_add_f32 v114, v86, v108
	;;#ASMEND
	v_mov_b32_e32 v115, 1.0
	v_cmp_gt_f32_e32 vcc, v116, v114
	v_mov_b32_e32 v114, 1.0
	s_and_saveexec_b64 s[42:43], vcc
	s_cbranch_execz .LBB0_39
	;;#ASMSTART
	v_add_f32 v90, v116, v109
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v86, v86, v90
...
.LBB0_39:
	...
	;;#ASMEND
	s_nop 0
	v_lshrrev_b32_e32 v116, 2, v115
	v_and_b32_e32 v116, 8, v116
	v_lshrrev_b32_e32 v115, 1, v115
	v_and_or_b32 v115, v115, s84, v112
	...
	s_nop 1
	v_cndmask_b32_e32 v67, v110, v67, vcc
	v_cmp_le_i32_e32 vcc, v117, v115
	...
	s_nop 0
	v_cndmask_b32_e32 v80, v110, v80, vcc
	v_cmp_le_i32_e32 vcc, v116, v115
	s_nop 1
	v_cndmask_b32_e32 v81, v110, v81, vcc
	v_pk_mul_f32 v[80:81], v[84:85], v[80:81]
	v_max_f32_e32 v85, v66, v67
	...
	v_max3_f32 v85, v85, v78, v79
	v_max3_f32 v85, v85, v80, v81
	ds_bpermute_b32 v115, v107, v85
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v115, v115, v115
	v_max_f32_e32 v85, v85, v115
	;;#ASMSTART
	v_add_f32 v115, v86, v108
	;;#ASMEND
	s_nop 0
