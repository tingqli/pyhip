...
.LBB0_8:
	...
	s_mov_b32 s33, s74
.LBB0_9:
	s_load_dword s75, s[50:51], 0x0
	s_load_dword s45, s[52:53], 0x0
	s_cmp_ge_i32 s84, s3
	...
	s_waitcnt lgkmcnt(0)
	v_writelane_b32 v196, s4, 0
	v_lshlrev_b32_e32 v2, 2, v2
	v_xor_b32_e32 v107, 0x80, v2
	v_writelane_b32 v196, s5, 1
...
.LBB0_13:
	...
	global_load_dword v2, v108, s[48:49]
	s_mov_b32 s83, s79
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s4, v4
	s_add_i32 s70, s4, s2
	v_readfirstlane_b32 s5, v5
	s_add_i32 s2, s70, 0x100
	s_min_i32 s2, s2, s5
	s_sub_i32 s71, s2, s70
	s_add_u32 s4, s52, s0
...
.LBB0_15:
	...
	v_lshl_add_u64 v[6:7], v[6:7], 2, s[72:73]
...
.LBB0_18:
	...
	s_mov_b32 s10, s68
	v_lshl_or_b32 v114, s10, 11, v85
	v_ashrrev_i32_e32 v115, 31, v114
	v_lshl_add_u64 v[114:115], v[114:115], 2, s[72:73]
	s_add_i32 s6, s6, s83
	...
	v_add_co_u32_e32 v92, vcc, s95, v92
	s_nop 1
...
.LBB0_20:
	...
	v_lshl_or_b32 v92, s2, 11, v85
	v_ashrrev_i32_e32 v93, 31, v92
	v_lshl_add_u64 v[92:93], v[92:93], 2, s[72:73]
	s_add_i32 s4, s69, s83
	s_lshl_b32 s4, s4, 12
	v_mfma_f32_32x32x8_bf16 v[66:81], v[94:95], v[118:119], v[66:81]
	buffer_load_dword v83, v83, s[76:79], 0 offen
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s68, v83
	s_waitcnt lgkmcnt(7)
...
.LBB0_26:
	...
	s_cselect_b32 s6, s2, s69
	s_cselect_b32 s69, s68, s2
	s_cselect_b32 s2, s43, s68
	s_add_u32 s88, s88, 2
	s_addc_u32 s89, s89, 0
	v_mov_b64_e32 v[66:67], s[80:81]
	v_cmp_lt_i64_e32 vcc, s[88:89], v[66:67]
...
.LBB0_27:
	...
	v_lshl_or_b32 v88, s68, 11, v85
	v_ashrrev_i32_e32 v89, 31, v88
	v_lshl_add_u64 v[88:89], v[88:89], 2, s[72:73]
	s_add_i32 s0, s6, s83
	s_lshl_b32 s0, s0, 12
	v_mfma_f32_32x32x8_bf16 v[66:81], v[174:175], v[118:119], v[66:81]
	buffer_load_dword v83, v83, s[76:79], 0 offen
	...
	v_add_co_u32_e32 v88, vcc, s95, v88
	s_nop 1
...
.LBB0_33:
	...
	v_readlane_b32 s6, v196, 0
	v_readlane_b32 s7, v196, 1
...
.LBB0_35:
	s_or_b64 exec, exec, s[0:1]
	v_div_scale_f32 v67, s[0:1], v66, v66, s45
	v_rcp_f32_e32 v68, v67
	v_div_scale_f32 v69, vcc, s45, v66, s45
	...
	v_div_fixup_f32 v66, v67, v66, s45
...
.LBB0_41:
	...
	s_add_i32 s2, s85, 0x10000
	v_or_b32_e32 v38, v38, v39
	v_add_lshl_u32 v39, s2, v38, 1
...
.LBB0_53:
	...
	s_add_i32 s2, s2, 0x60000
	v_add_lshl_u32 v2, s2, v38, 1
	s_waitcnt lgkmcnt(0)
	...
	v_mov_b32_e32 v3, s2
	global_atomic_add v3, v108, v3, s[98:99] sc0
.LBB0_56:
...
.LBB0_60:
	...
	global_load_dwordx2 v[2:3], v108, s[6:7] offset:4
	s_waitcnt vmcnt(0)
...
.Lfunc_end0:
	...
	.set .Lattn_kernel_0.num_vgpr, 197
