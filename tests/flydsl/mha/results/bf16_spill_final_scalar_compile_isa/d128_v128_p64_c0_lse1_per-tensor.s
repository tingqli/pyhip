...
.LBB0_18:
	...
	global_load_dwordx4 v[168:171], v[92:93], off offset:1536
	...
	global_load_dwordx4 v[156:159], v[92:93], off offset:512
...
.LBB0_22:
	...
	s_ashr_i32 s5, s4, 31
	v_lshl_add_u64 v[148:149], s[4:5], 0, v[82:83]
	v_lshl_add_u64 v[148:149], v[148:149], 2, s[88:89]
	s_lshl_b32 s6, s74, 13
	s_add_i32 s6, s6, s72
	v_mfma_f32_32x32x8_bf16 v[66:81], v[158:159], v[118:119], v[66:81]
	buffer_load_dword v113, v113, s[76:79], 0 offen
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s83, v113
	s_waitcnt lgkmcnt(7)
	...
	;;#ASMEND
	s_nop 0
	v_lshlrev_b32_e32 v156, 3, v115
	v_lshlrev_b32_e32 v115, 5, v115
	v_and_b32_e32 v156, 0xf8, v156
	v_and_b32_e32 v115, 0x400, v115
	v_or3_b32 v156, v156, v115, s6
	v_ashrrev_i32_e32 v157, 31, v156
	v_lshl_add_u64 v[156:157], v[156:157], 1, s[86:87]
	global_load_dwordx4 v[180:183], v[156:157], off
	...
	global_load_dwordx4 v[184:187], v[156:157], off offset:512
	global_load_dwordx4 v[172:175], v[156:157], off offset:1024
	s_waitcnt lgkmcnt(4)
	...
	global_load_dwordx4 v[176:179], v[156:157], off offset:1536
	v_add_co_u32_e32 v156, vcc, s2, v156
	s_nop 1
	v_addc_co_u32_e32 v157, vcc, 0, v157, vcc
	global_load_dwordx4 v[164:167], v[156:157], off
	...
	global_load_dwordx4 v[168:171], v[156:157], off offset:512
	global_load_dwordx4 v[160:163], v[156:157], off offset:1024
	s_nop 0
	...
	v_max3_f32 v85, v85, v78, v79
	v_max3_f32 v85, v85, v80, v81
	ds_bpermute_b32 v113, v108, v85
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v113, v113, v113
	v_max_f32_e32 v115, v85, v113
	;;#ASMSTART
	v_add_f32 v85, v86, v109
	;;#ASMEND
	v_mov_b32_e32 v113, 1.0
	v_cmp_gt_f32_e32 vcc, v115, v85
	v_mov_b32_e32 v85, 1.0
	s_and_saveexec_b64 s[4:5], vcc
...
.LBB0_24:
	...
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[156:157], v[116:117], 0
	v_lshl_or_b32 v152, s12, 12, v82
	v_ashrrev_i32_e32 v153, 31, v152
	v_lshl_add_u64 v[152:153], v[152:153], 2, s[88:89]
	s_addk_i32 s6, 0x1000
	v_mfma_f32_32x32x8_bf16 v[66:81], v[158:159], v[118:119], v[66:81]
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[160:161], v[120:121], v[66:81]
	v_and_b32_e32 v85, 0x400, v85
	v_or3_b32 v156, v115, v85, s6
	v_ashrrev_i32_e32 v157, 31, v156
	v_lshl_add_u64 v[156:157], v[156:157], 1, s[86:87]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[162:163], v[122:123], v[66:81]
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[164:165], v[124:125], v[66:81]
	global_load_dwordx4 v[184:187], v[156:157], off
	global_load_dwordx4 v[176:179], v[156:157], off offset:512
	v_mfma_f32_32x32x8_bf16 v[66:81], v[166:167], v[126:127], v[66:81]
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[168:169], v[128:129], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[170:171], v[130:131], v[66:81]
	global_load_dwordx4 v[180:183], v[156:157], off offset:1024
	global_load_dwordx4 v[172:175], v[156:157], off offset:1536
	v_add_co_u32_e32 v156, vcc, s2, v156
	s_nop 1
	v_addc_co_u32_e32 v157, vcc, 0, v157, vcc
	s_waitcnt lgkmcnt(4)
	...
	global_load_dwordx4 v[168:171], v[156:157], off
	global_load_dwordx4 v[160:163], v[156:157], off offset:512
	...
	global_load_dwordx4 v[164:167], v[156:157], off offset:1024
	s_nop 0
	global_load_dwordx4 v[156:159], v[156:157], off offset:1536
	s_waitcnt lgkmcnt(1)
...
.LBB0_35:
	...
	v_lshl_add_u64 v[114:115], v[114:115], 2, s[88:89]
	s_lshl_b32 s41, s74, 13
	...
	v_add_co_u32_e32 v114, vcc, s2, v114
	s_nop 1
	...
	ds_bpermute_b32 v113, v108, v107
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v113, v113, v113
	v_max_f32_e32 v114, v107, v113
	;;#ASMSTART
	v_add_f32 v107, v86, v109
	;;#ASMEND
	v_mov_b32_e32 v113, 1.0
	v_cmp_gt_f32_e32 vcc, v114, v107
	v_mov_b32_e32 v107, 1.0
	s_and_saveexec_b64 s[0:1], vcc
	s_cbranch_execz .LBB0_38
	;;#ASMSTART
	v_add_f32 v90, v114, v110
	;;#ASMEND
	s_nop 0
...
.LBB0_41:
	...
	v_readlane_b32 s6, v204, 0
	v_readlane_b32 s7, v204, 1
...
.LBB0_43:
	s_or_b64 exec, exec, s[0:1]
	v_div_scale_f32 v67, s[0:1], v66, v66, s56
	v_rcp_f32_e32 v68, v67
	v_div_scale_f32 v69, vcc, s56, v66, s56
	...
	v_div_fixup_f32 v66, v67, v66, s56
...
.Lfunc_end0:
	...
	.set .Lattn_kernel_0.num_vgpr, 205
