...
.LBB0_15:
	...
	v_add_u32_sdwa v4, s47, v136 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
...
.LBB0_19:
	...
	ds_write_b128 v137, v[148:151]
	ds_write_b128 v137, v[152:155] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[16:17]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_23:
	...
	s_sub_i32 s16, s44, s45
	s_lshl_b32 s17, s49, 5
	...
	s_lshr_b32 s16, s44, 31
	s_add_i32 s16, s44, s16
	s_ashr_i32 s46, s16, 1
	s_and_b32 s16, s16, -2
	s_cmp_lg_u32 s44, s16
	s_cselect_b64 s[16:17], -1, 0
	s_cmp_lt_i32 s44, 0
...
.LBB0_25:
	...
	;;#ASMSTART
	v_perm_b32 v100, v99, v98, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v115, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v105, v104, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v107, v106, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v109, v108, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v111, v110, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v113, v112, s54
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
...
.LBB0_26:
	...
	s_mov_b32 s71, s65
	v_cmp_ne_u32_e32 vcc, s53, v99
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s62, v98
	s_and_saveexec_b64 s[46:47], vcc
	s_cbranch_execz .LBB0_28
	ds_write_b128 v137, v[156:159] offset:12288
	ds_write_b128 v137, v[160:163] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[46:47]
	;;#ASMSTART
	v_mov_b32 v98, v0
	...
	v_cmp_ne_u32_e32 vcc, s53, v98
	s_and_saveexec_b64 s[46:47], vcc
	s_cbranch_execz .LBB0_30
	s_mul_i32 s65, s71, 0xc00
	v_add_u32_sdwa v98, s65, v136 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
...
.LBB0_30:
	...
	v_mfma_f32_32x32x8_bf16 v[98:113], v[124:125], v[210:211], v[98:113]
	s_waitcnt vmcnt(2) lgkmcnt(0)
	s_barrier
	s_setprio 0
...
.LBB0_34:
	...
	v_add_u32_sdwa v98, s68, v136 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[0:1]
...
.LBB0_43:
	...
	v_cmp_lt_i64_e32 vcc, s[16:17], v[98:99]
...
.LBB0_46:
	...
	v_add_u32_sdwa v98, s48, v136 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[0:1]
	global_load_dwordx4 v[156:159], v[98:99], off
	global_load_dwordx4 v[160:163], v[98:99], off offset:256
.LBB0_48:
	...
	v_and_or_b32 v115, v115, s57, v145
	v_add_u32_e32 v122, s66, v120
	v_add_u32_e32 v115, s63, v115
...
.LBB0_50:
	...
	v_add_u32_e32 v106, 0x8000, v106
	;;#ASMSTART
	v_perm_b32 v100, v101, v100, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v99, v98, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s54
	;;#ASMEND
...
.LBB0_60:
	...
	;;#ASMSTART
	v_perm_b32 v48, v3, v2, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v49, v5, v4, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v46, v7, v6, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v47, v9, v8, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v44, v11, v10, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v45, v13, v12, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v42, v15, v14, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v43, v17, v16, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v40, v19, v18, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v41, v21, v20, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v38, v23, v22, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v39, v25, v24, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v36, v27, v26, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v37, v29, v28, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v34, v31, v30, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v35, v33, v32, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v112, v113, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v110, v111, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v108, v109, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v106, v107, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v28, v104, v105, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v102, v103, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v100, v101, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v98, v99, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v51, v50, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v53, v52, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v55, v54, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v57, v56, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v59, v58, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v61, v60, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v63, v62, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v65, v64, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v67, v66, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v69, v68, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v71, v70, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v73, v72, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v75, v74, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v77, v76, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v79, v78, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v81, v80, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v83, v82, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v85, v84, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v87, v86, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v89, v88, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v91, v90, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v93, v92, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v95, v94, s54
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v97, v96, s54
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v50, v0
	;;#ASMEND
...
.LBB0_93:
	...
	global_atomic_add v3, v139, v3, s[38:39] sc0
.LBB0_97:
	s_or_b64 exec, exec, s[16:17]
