...
.LBB0_13:
	...
	global_load_dwordx2 v[4:5], v141, s[12:13]
	global_load_dword v2, v141, s[4:5]
	v_lshl_add_u32 v3, s24, 8, v1
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s25, v4
	s_add_i32 s36, s25, s44
...
.LBB0_18:
	...
	s_mov_b32 s66, s61
	buffer_load_dword v115, v98, s[12:15], 0 offen
	v_lshl_or_b32 v98, s66, 11, v117
...
.LBB0_28:
	...
	;;#ASMEND
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s65, v115
	v_lshrrev_b32_e32 v100, 2, v98
	v_lshlrev_b32_e32 v99, 7, v98
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_b32_e32 v100, 8, v100
	v_and_b32_e32 v120, 48, v98
	v_and_or_b32 v121, v99, s49, v100
	...
	v_and_or_b32 v115, v115, s53, v137
	v_add_u32_e32 v122, s62, v120
	v_add_u32_e32 v115, s59, v115
	v_subrev_u32_e32 v120, 55, v122
	v_cmp_lt_i32_e32 vcc, v120, v115
	s_nop 1
	v_cndmask_b32_e32 v121, v144, v99, vcc
...
.LBB0_69:
	...
	global_atomic_add v3, v141, v3, s[34:35] sc0
.LBB0_73:
	...
	global_store_dword v141, v2, s[36:37]
	s_waitcnt vmcnt(0)
.LBB0_74:
...
.LBB0_77:
	...
	s_add_u32 s18, s16, s18
	s_addc_u32 s19, s17, s19
	global_load_dwordx2 v[2:3], v141, s[18:19] offset:4
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s14, v3
