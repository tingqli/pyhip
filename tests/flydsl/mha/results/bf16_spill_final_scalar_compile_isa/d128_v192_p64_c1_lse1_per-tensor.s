...
.LBB0_15:
	...
	v_ashrrev_i32_e32 v3, 31, v2
	v_lshl_add_u64 v[2:3], v[2:3], 2, s[0:1]
	global_load_dwordx4 v[186:189], v[2:3], off
...
.LBB0_18:
	...
	v_and_or_b32 v125, v99, s49, v100
...
.LBB0_20:
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v117, v99, s49, v100
	v_and_b32_e32 v124, 48, v98
...
.LBB0_22:
	...
	s_ashr_i32 s43, s42, 31
	buffer_load_dword v146, v98, s[12:15], 0 offen
	v_lshl_add_u64 v[98:99], s[42:43], 0, v[114:115]
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[0:1]
	global_load_dwordx4 v[182:185], v[98:99], off offset:512
	ds_write_b128 v119, v[194:197]
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s61, v146
	v_lshrrev_b32_e32 v100, 2, v98
	v_lshlrev_b32_e32 v99, 7, v98
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_b32_e32 v100, 8, v100
	v_and_b32_e32 v148, 48, v98
	v_and_or_b32 v149, v99, s49, v100
	v_or_b32_e32 v98, v149, v148
	v_lshlrev_b32_e32 v98, 1, v98
	...
	v_or_b32_e32 v146, 0x1010, v149
	v_xor_b32_e32 v146, v146, v148
...
.LBB0_24:
	...
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[0:1]
	global_load_dwordx4 v[186:189], v[98:99], off
...
.LBB0_32:
	...
	v_and_or_b32 v123, v99, s49, v100
	...
	v_and_or_b32 v117, v117, s53, v139
	v_add_u32_e32 v124, s62, v122
	v_add_u32_e32 v117, s59, v117
...
.LBB0_34:
	...
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v100, v101, v100, s50
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v99, v98, s50
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s50
	;;#ASMEND
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v122, v99, s49, v100
	...
	v_and_or_b32 v122, v122, s53, v139
	v_add_u32_e32 v123, s62, v123
...
.LBB0_36:
	...
	;;#ASMEND
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s65, v117
	v_lshrrev_b32_e32 v100, 2, v98
	v_lshlrev_b32_e32 v99, 7, v98
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_b32_e32 v100, 8, v100
	v_and_b32_e32 v146, 48, v98
	v_and_or_b32 v147, v99, s49, v100
	v_or_b32_e32 v98, v147, v146
	v_lshlrev_b32_e32 v98, 1, v98
	ds_read_b128 v[190:193], v98 offset:8192
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[190:191], v[150:151], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[192:193], v[152:153], v[98:113]
	v_or_b32_e32 v117, 0x1010, v147
	...
	;;#ASMEND
	s_nop 0
	v_lshrrev_b32_e32 v146, 2, v117
	v_and_b32_e32 v146, 8, v146
	v_lshrrev_b32_e32 v117, 1, v117
	v_and_or_b32 v117, v117, s53, v139
	v_add_u32_e32 v146, s62, v146
	v_add_u32_e32 v117, s59, v117
	v_subrev_u32_e32 v147, 55, v146
	v_cmp_lt_i32_e32 vcc, v147, v117
	s_nop 1
	v_cndmask_b32_e32 v99, v144, v99, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 53, v146
	s_nop 0
	v_cndmask_b32_e32 v98, v144, v98, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 52, v146
	v_pk_mul_f32 v[98:99], v[120:121], v[98:99]
	v_cndmask_b32_e32 v100, v144, v100, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 51, v146
	s_nop 0
	v_cndmask_b32_e32 v101, v144, v101, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 50, v146
	s_nop 0
	v_cndmask_b32_e32 v102, v144, v102, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 49, v146
	s_nop 0
	v_cndmask_b32_e32 v103, v144, v103, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 48, v146
	s_nop 0
	v_cndmask_b32_e32 v104, v144, v104, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 39, v146
	s_nop 0
	v_cndmask_b32_e32 v105, v144, v105, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 38, v146
	s_nop 0
	v_cndmask_b32_e32 v106, v144, v106, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 37, v146
	s_nop 0
	v_cndmask_b32_e32 v107, v144, v107, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 36, v146
	s_nop 0
	v_cndmask_b32_e32 v108, v144, v108, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 35, v146
	s_nop 0
	v_cndmask_b32_e32 v109, v144, v109, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 34, v146
	s_nop 0
	v_cndmask_b32_e32 v110, v144, v110, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	v_subrev_u32_e32 v147, 33, v146
	v_subrev_u32_e32 v146, 32, v146
	v_cndmask_b32_e32 v111, v144, v111, vcc
	v_cmp_le_i32_e32 vcc, v147, v117
	s_nop 1
	v_cndmask_b32_e32 v112, v144, v112, vcc
	...
	ds_bpermute_b32 v147, v141, v146
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v147, v147, v147
	v_max_f32_e32 v148, v146, v147
	;;#ASMSTART
	v_add_f32 v146, v118, v142
	;;#ASMEND
	v_mov_b32_e32 v147, 1.0
	v_cmp_gt_f32_e32 vcc, v148, v146
	v_mov_b32_e32 v146, 1.0
	s_and_saveexec_b64 s[44:45], vcc
	s_cbranch_execz .LBB0_39
	;;#ASMSTART
	v_add_f32 v122, v148, v143
	;;#ASMEND
	s_nop 0
...
.LBB0_39:
	...
	;;#ASMEND
	s_nop 0
	v_lshrrev_b32_e32 v148, 2, v147
	v_and_b32_e32 v148, 8, v148
	v_lshrrev_b32_e32 v147, 1, v147
	v_and_or_b32 v147, v147, s53, v139
	v_add_u32_e32 v148, s62, v148
	v_add_u32_e32 v147, s59, v147
	v_subrev_u32_e32 v149, 23, v148
	v_cmp_lt_i32_e32 vcc, v149, v147
	s_nop 1
	v_cndmask_b32_e32 v99, v144, v99, vcc
	v_cmp_le_i32_e32 vcc, v149, v147
	...
	s_nop 0
	v_cndmask_b32_e32 v112, v144, v112, vcc
	v_cmp_le_i32_e32 vcc, v148, v147
	s_nop 1
	v_cndmask_b32_e32 v113, v144, v113, vcc
	v_pk_mul_f32 v[112:113], v[116:117], v[112:113]
	v_max_f32_e32 v117, v98, v99
