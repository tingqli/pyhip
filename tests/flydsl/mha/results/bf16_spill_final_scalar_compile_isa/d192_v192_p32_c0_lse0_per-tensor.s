...
.LBB0_8:
	...
	s_mov_b32 s33, s2
.LBB0_9:
	s_load_dword s73, s[38:39], 0x0
	s_load_dword s74, s[40:41], 0x0
	s_cmp_ge_i32 s52, s3
...
.LBB0_13:
	...
	global_load_dwordx2 v[4:5], v138, s[4:5]
	global_load_dword v2, v138, s[36:37]
	s_mul_i32 s53, s75, 0xc0
	s_mov_b32 s51, s47
	...
	global_load_dwordx2 v[4:5], v138, s[6:7]
	global_load_dword v6, v138, s[0:1]
	s_addc_u32 s0, s39, s65
	s_and_b32 s49, s0, 0xffff
	buffer_load_dwordx4 v[160:163], v3, s[48:51], 0 offen
	buffer_load_dwordx4 v[164:167], v3, s[48:51], 0 offen offset:32
	buffer_load_dwordx4 v[168:171], v3, s[48:51], 0 offen offset:64
	buffer_load_dwordx4 v[172:175], v3, s[48:51], 0 offen offset:96
	buffer_load_dwordx4 v[176:179], v3, s[48:51], 0 offen offset:128
	buffer_load_dwordx4 v[180:183], v3, s[48:51], 0 offen offset:160
	buffer_load_dwordx4 v[184:187], v3, s[48:51], 0 offen offset:192
	buffer_load_dwordx4 v[188:191], v3, s[48:51], 0 offen offset:224
	buffer_load_dwordx4 v[192:195], v3, s[48:51], 0 offen offset:256
	buffer_load_dwordx4 v[196:199], v3, s[48:51], 0 offen offset:288
	buffer_load_dwordx4 v[200:203], v3, s[48:51], 0 offen offset:320
	buffer_load_dwordx4 v[204:207], v3, s[48:51], 0 offen offset:352
	;;#ASMSTART
	v_mov_b32 v3, v0
	;;#ASMEND
	s_waitcnt vmcnt(13)
...
.LBB0_15:
	...
	s_add_u32 s66, s40, s4
	s_addc_u32 s67, s41, s5
	s_ashr_i32 s1, s0, 31
...
.LBB0_19:
	...
	ds_write_b128 v136, v[144:147]
	ds_write_b128 v136, v[148:151] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[0:1]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_26:
	...
	ds_write_b128 v136, v[152:155] offset:12288
	ds_write_b128 v136, v[156:159] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v98, v0
...
.LBB0_47:
	...
	v_cndmask_b32_e64 v101, v141, v101, s[6:7]
	v_cndmask_b32_e64 v100, v141, v100, s[4:5]
	v_cndmask_b32_e64 v121, v141, v99, s[0:1]
	v_cndmask_b32_e32 v120, v141, v98, vcc
	v_mov_b32_e32 v115, v114
	v_cndmask_b32_e64 v113, v141, v113, s[30:31]
	v_cndmask_b32_e64 v112, v141, v112, s[28:29]
	v_cndmask_b32_e64 v111, v141, v111, s[26:27]
	v_cndmask_b32_e64 v110, v141, v110, s[24:25]
	v_cndmask_b32_e64 v109, v141, v109, s[22:23]
	v_cndmask_b32_e64 v108, v141, v108, s[20:21]
	v_cndmask_b32_e64 v107, v141, v107, s[18:19]
	v_cndmask_b32_e64 v106, v141, v106, s[16:17]
	v_cndmask_b32_e64 v105, v141, v105, s[14:15]
	v_cndmask_b32_e64 v104, v141, v104, s[12:13]
	v_cndmask_b32_e64 v103, v141, v103, s[10:11]
	v_cndmask_b32_e64 v102, v141, v102, s[8:9]
...
.LBB0_49:
	...
	v_add_u32_e32 v106, 0x8000, v106
	;;#ASMSTART
	v_perm_b32 v100, v101, v100, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v99, v98, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s77
	;;#ASMEND
...
.LBB0_54:
	...
	s_or_b64 s[0:1], s[4:5], s[0:1]
	s_or_b64 vcc, s[0:1], vcc
	v_cndmask_b32_e64 v99, v141, v99, s[0:1]
...
.LBB0_90:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v138, v3, s[62:63] sc0
.LBB0_94:
	...
	global_store_dword v138, v2, s[6:7]
	s_waitcnt vmcnt(0)
.LBB0_95:
	s_or_b64 exec, exec, s[4:5]
	s_lshl_b64 s[0:1], s[0:1], 2
...
.LBB0_98:
	...
	global_load_dwordx2 v[2:3], v138, s[6:7] offset:4
	s_waitcnt vmcnt(0)
