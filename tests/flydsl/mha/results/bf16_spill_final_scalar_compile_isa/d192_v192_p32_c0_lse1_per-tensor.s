...
.LBB0_9:
	...
	s_mov_b32 s87, 0xaaab
	s_movk_i32 s88, 0xff
	s_mov_b32 s89, s2
	v_mov_b32_e32 v141, 0xff800000
	v_mov_b32_e32 v142, 0x42000000
	s_branch .LBB0_13
.LBB0_11:
	s_mov_b32 s78, s6
.LBB0_12:
...
.LBB0_19:
	...
	ds_write_b128 v136, v[150:153] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[0:1]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_25:
	...
	;;#ASMSTART
	v_perm_b32 v100, v99, v98, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v115, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v105, v104, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v107, v106, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v109, v108, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v111, v110, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v113, v112, s82
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
...
.LBB0_26:
	...
	ds_write_b128 v136, v[154:157] offset:12288
	ds_write_b128 v136, v[158:161] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v98, v0
...
.LBB0_42:
	...
	s_cselect_b32 s76, s90, s91
	s_cselect_b32 s91, s92, s90
	s_cselect_b32 s90, s97, s92
	s_add_u32 s74, s74, 2
...
.LBB0_47:
	...
	v_cmp_gt_i32_e64 s[30:31], s93, v115
...
.LBB0_49:
	...
	v_add_u32_e32 v106, 0x8000, v106
	;;#ASMSTART
	v_perm_b32 v100, v101, v100, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v99, v98, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s82
	;;#ASMEND
...
.LBB0_57:
	...
	v_mov_b32 v100, v0
	;;#ASMEND
	ds_bpermute_b32 v98, v137, v143
	v_lshrrev_b32_e32 v99, 1, v100
	v_and_b32_e32 v101, 31, v100
	v_and_or_b32 v99, v99, s85, v101
	...
	v_cndmask_b32_e32 v100, 0, v142, vcc
	s_add_u32 s6, s64, s4
...
.LBB0_59:
	...
	;;#ASMSTART
	v_perm_b32 v48, v3, v2, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v49, v5, v4, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v46, v7, v6, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v47, v9, v8, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v44, v11, v10, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v45, v13, v12, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v42, v15, v14, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v43, v17, v16, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v40, v19, v18, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v41, v21, v20, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v38, v23, v22, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v39, v25, v24, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v36, v27, v26, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v37, v29, v28, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v34, v31, v30, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v35, v33, v32, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v112, v113, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v110, v111, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v108, v109, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v106, v107, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v28, v104, v105, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v102, v103, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v100, v101, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v98, v99, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v51, v50, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v53, v52, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v55, v54, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v57, v56, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v59, v58, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v61, v60, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v63, v62, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v65, v64, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v67, v66, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v69, v68, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v71, v70, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v73, v72, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v75, v74, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v77, v76, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v79, v78, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v81, v80, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v83, v82, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v85, v84, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v87, v86, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v89, v88, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v91, v90, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v93, v92, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v95, v94, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v97, v96, s82
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v50, v0
	;;#ASMEND
...
.LBB0_63:
	...
	s_barrier
.LBB0_64:
	v_mul_u32_u24_sdwa v95, v94, s87 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
.LBB0_91:
	...
	s_barrier
.LBB0_92:
	v_mul_u32_u24_sdwa v2, v88, s87 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v138, v3, s[66:67] sc0
.LBB0_96:
...
.Lfunc_end0:
	...
	.set .Lattn_kernel_0.numbered_sgpr, 99
