...
.LBB0_9:
	...
	s_waitcnt lgkmcnt(0)
	v_writelane_b32 v113, s4, 0
	v_lshlrev_b32_e32 v2, 2, v2
	v_xor_b32_e32 v105, 0x80, v2
	v_writelane_b32 v113, s5, 1
...
.LBB0_19:
	...
	ds_write_b128 v104, v[118:121] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[0:1]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_23:
	...
	v_lshlrev_b32_e32 v4, 1, v4
	ds_read_b128 v[206:209], v4
	v_or_b32_e32 v4, 32, v2
	v_xor_b32_e32 v4, v4, v3
	v_lshlrev_b32_e32 v4, 1, v4
	ds_read_b128 v[202:205], v4
...
.LBB0_26:
	...
	ds_write_b128 v104, v[122:125] offset:12288
	ds_write_b128 v104, v[126:129] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v66, v0
...
.LBB0_30:
	...
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[90:91], v[142:143], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[92:93], v[144:145], v[66:81]
	s_waitcnt lgkmcnt(7)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[94:95], v[146:147], v[66:81]
...
.LBB0_36:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[90:91], v[174:175], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[92:93], v[176:177], v[66:81]
	s_waitcnt vmcnt(2) lgkmcnt(0)
	s_barrier
	s_setprio 0
	v_mov_b32_e32 v83, v82
...
.LBB0_54:
	...
	v_max_f32_e32 v112, v80, v81
	;;#ASMSTART
	v_add_f32 v80, v84, v107
	;;#ASMEND
	v_mov_b32_e32 v81, v84
	v_cmp_gt_f32_e32 vcc, v112, v80
...
.LBB0_57:
	...
	v_readlane_b32 s6, v113, 0
	v_readlane_b32 s7, v113, 1
...
.LBB0_77:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v106, v3, s[94:95] sc0
.LBB0_80:
...
.LBB0_84:
	...
	s_add_u32 s8, s34, s8
	s_addc_u32 s9, s35, s9
	global_load_dwordx2 v[2:3], v106, s[8:9] offset:4
	s_waitcnt vmcnt(0)
