...
.LBB0_13:
	...
	global_load_dwordx2 v[4:5], v139, s[12:13]
	global_load_dword v2, v139, s[4:5]
	...
	global_load_dwordx2 v[4:5], v139, s[16:17]
	...
	buffer_load_dwordx4 v[162:165], v3, s[16:19], 0 offen
	buffer_load_dwordx4 v[166:169], v3, s[16:19], 0 offen offset:32
	buffer_load_dwordx4 v[170:173], v3, s[16:19], 0 offen offset:64
	buffer_load_dwordx4 v[174:177], v3, s[16:19], 0 offen offset:96
	buffer_load_dwordx4 v[178:181], v3, s[16:19], 0 offen offset:128
	buffer_load_dwordx4 v[182:185], v3, s[16:19], 0 offen offset:160
	buffer_load_dwordx4 v[186:189], v3, s[16:19], 0 offen offset:192
	buffer_load_dwordx4 v[190:193], v3, s[16:19], 0 offen offset:224
	buffer_load_dwordx4 v[194:197], v3, s[16:19], 0 offen offset:256
	buffer_load_dwordx4 v[198:201], v3, s[16:19], 0 offen offset:288
	buffer_load_dwordx4 v[202:205], v3, s[16:19], 0 offen offset:320
	buffer_load_dwordx4 v[206:209], v3, s[16:19], 0 offen offset:352
	;;#ASMSTART
	v_mov_b32 v3, v0
	;;#ASMEND
	s_waitcnt vmcnt(13)
...
.LBB0_15:
	...
	s_mul_i32 s41, s63, 0xc00
	v_add_u32_sdwa v4, s41, v136 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
...
.LBB0_19:
	...
	ds_write_b128 v137, v[150:153] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[36:37]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_23:
	...
	s_sub_i32 s57, s36, 32
	s_add_i32 s62, s57, s42
	s_add_i32 s38, s62, 1
	...
	s_cselect_b64 s[38:39], -1, 0
	s_and_b64 s[36:37], s[38:39], s[36:37]
	s_subb_u32 s61, s40, 0
	s_lshl_b32 s36, s61, 1
...
.LBB0_25:
	...
	;;#ASMSTART
	v_perm_b32 v100, v99, v98, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v115, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v105, v104, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v107, v106, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v109, v108, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v111, v110, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v113, v112, s49
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
...
.LBB0_26:
	...
	s_mov_b32 s66, s59
	v_cmp_ne_u32_e32 vcc, s48, v99
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s56, v98
	s_and_saveexec_b64 s[40:41], vcc
	s_cbranch_execz .LBB0_28
	ds_write_b128 v137, v[154:157] offset:12288
	ds_write_b128 v137, v[158:161] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[40:41]
	;;#ASMSTART
	v_mov_b32 v98, v0
	...
	v_cmp_ne_u32_e32 vcc, s48, v98
	s_and_saveexec_b64 s[40:41], vcc
	s_cbranch_execz .LBB0_30
	s_mul_i32 s59, s66, 0xc00
	v_add_u32_sdwa v98, s59, v136 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
...
.LBB0_34:
	...
	s_mul_i32 s63, s56, 0xc00
	v_add_u32_sdwa v98, s63, v136 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[16:17]
...
.LBB0_46:
	...
	s_mul_i32 s42, s59, 0xc00
	v_add_u32_sdwa v98, s42, v136 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[16:17]
	global_load_dwordx4 v[154:157], v[98:99], off
	global_load_dwordx4 v[158:161], v[98:99], off offset:256
.LBB0_48:
	...
	v_and_or_b32 v115, v115, s52, v144
	v_add_u32_e32 v122, s60, v120
	v_add_u32_e32 v115, s57, v115
	v_subrev_u32_e32 v120, 55, v122
	v_cmp_lt_i32_e32 vcc, v120, v115
	s_nop 1
	v_cndmask_b32_e32 v121, v142, v99, vcc
...
.LBB0_50:
	...
	v_add_u32_e32 v106, 0x8000, v106
	;;#ASMSTART
	v_perm_b32 v100, v101, v100, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v99, v98, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s49
	;;#ASMEND
...
.LBB0_55:
	...
	v_mov_b32_e32 v123, v116
	v_mov_b32_e32 v124, v116
	v_cndmask_b32_e32 v99, v142, v99, vcc
	...
	v_mov_b32_e32 v126, v116
	v_cndmask_b32_e32 v101, v142, v101, vcc
	v_cmp_le_i32_e32 vcc, v121, v115
	v_subrev_u32_e32 v121, 18, v120
	v_mov_b32_e32 v127, v116
	v_cndmask_b32_e32 v102, v142, v102, vcc
	v_cmp_le_i32_e32 vcc, v121, v115
	v_subrev_u32_e32 v121, 17, v120
	v_mov_b32_e32 v128, v116
	v_cndmask_b32_e32 v103, v142, v103, vcc
	v_cmp_le_i32_e32 vcc, v121, v115
	...
	v_mov_b32_e32 v130, v116
	v_cndmask_b32_e32 v105, v142, v105, vcc
	v_cmp_le_i32_e32 vcc, v121, v115
	v_add_u32_e32 v121, -6, v120
	v_mov_b32_e32 v131, v116
	v_cndmask_b32_e32 v106, v142, v106, vcc
	v_cmp_le_i32_e32 vcc, v121, v115
	v_add_u32_e32 v121, -5, v120
	v_mov_b32_e32 v132, v116
	v_cndmask_b32_e32 v107, v142, v107, vcc
	v_cmp_le_i32_e32 vcc, v121, v115
	v_add_u32_e32 v121, -4, v120
	v_mov_b32_e32 v133, v116
	v_cndmask_b32_e32 v108, v142, v108, vcc
	v_cmp_le_i32_e32 vcc, v121, v115
	v_add_u32_e32 v121, -3, v120
	v_mov_b32_e32 v134, v116
	v_cndmask_b32_e32 v109, v142, v109, vcc
	v_cmp_le_i32_e32 vcc, v121, v115
	v_add_u32_e32 v121, -2, v120
	v_mov_b32_e32 v135, v116
	v_cndmask_b32_e32 v110, v142, v110, vcc
	v_cmp_le_i32_e32 vcc, v121, v115
	v_add_u32_e32 v121, -1, v120
	s_nop 0
	v_cndmask_b32_e32 v111, v142, v111, vcc
	v_cmp_le_i32_e32 vcc, v121, v115
	v_mov_b32_e32 v121, v116
	s_nop 0
	v_cndmask_b32_e32 v112, v142, v112, vcc
	v_cmp_le_i32_e32 vcc, v120, v115
	v_mov_b32_e32 v115, v114
	v_pk_mul_f32 v[110:111], v[114:115], v[110:111]
	v_cndmask_b32_e32 v113, v142, v113, vcc
	v_pk_mul_f32 v[112:113], v[114:115], v[112:113]
	v_pk_mul_f32 v[108:109], v[114:115], v[108:109]
	v_pk_mul_f32 v[106:107], v[114:115], v[106:107]
	v_pk_mul_f32 v[104:105], v[114:115], v[104:105]
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v120, v120, v120
	v_max_f32_e32 v145, v115, v120
	;;#ASMSTART
	v_add_f32 v115, v116, v140
	;;#ASMEND
	v_mov_b32_e32 v120, v116
	v_cmp_gt_f32_e32 vcc, v145, v115
	v_mov_b32_e32 v115, 1.0
	s_and_saveexec_b64 s[42:43], vcc
...
.LBB0_58:
	...
	;;#ASMSTART
	v_perm_b32 v48, v3, v2, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v49, v5, v4, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v46, v7, v6, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v47, v9, v8, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v44, v11, v10, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v45, v13, v12, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v42, v15, v14, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v43, v17, v16, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v40, v19, v18, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v41, v21, v20, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v38, v23, v22, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v39, v25, v24, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v36, v27, v26, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v37, v29, v28, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v34, v31, v30, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v35, v33, v32, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v112, v113, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v110, v111, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v108, v109, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v106, v107, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v28, v104, v105, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v102, v103, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v100, v101, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v98, v99, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v51, v50, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v53, v52, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v55, v54, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v57, v56, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v59, v58, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v61, v60, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v63, v62, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v65, v64, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v67, v66, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v69, v68, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v71, v70, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v73, v72, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v75, v74, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v77, v76, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v79, v78, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v81, v80, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v83, v82, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v85, v84, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v87, v86, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v89, v88, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v91, v90, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v93, v92, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v95, v94, s49
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v97, v96, s49
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v50, v0
	;;#ASMEND
...
.LBB0_62:
	...
	s_barrier
.LBB0_63:
	v_mul_u32_u24_sdwa v95, v94, s53 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
.LBB0_90:
	...
	s_barrier
.LBB0_91:
	v_mul_u32_u24_sdwa v2, v88, s53 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	...
	global_atomic_add v3, v139, v3, s[34:35] sc0
.LBB0_95:
	s_or_b64 exec, exec, s[16:17]
	...
	global_store_dword v139, v2, s[16:17]
	s_waitcnt vmcnt(0)
.LBB0_96:
	s_or_b64 exec, exec, s[12:13]
...
.LBB0_99:
	...
	global_load_dwordx2 v[2:3], v139, s[16:17] offset:4
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s14, v3
