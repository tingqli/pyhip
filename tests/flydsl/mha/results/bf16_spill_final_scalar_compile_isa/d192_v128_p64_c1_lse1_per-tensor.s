...
.LBB0_13:
	...
	global_load_dwordx2 v[4:5], v108, s[38:39]
...
.LBB0_23:
	...
	s_lshl_b32 s82, s42, 13
	s_sub_i32 s38, s40, s41
	s_lshl_b32 s39, s87, 6
	s_waitcnt vmcnt(2) lgkmcnt(0)
	s_barrier
	s_setprio 0
	s_barrier
...
.LBB0_30:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[180:181], v[132:133], 0
...
.LBB0_36:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[88:89], v[176:177], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[90:91], v[178:179], v[66:81]
	s_waitcnt vmcnt(2) lgkmcnt(0)
	s_barrier
	s_setprio 0
	v_mov_b32_e32 v83, v82
...
.LBB0_42:
	...
	s_waitcnt lgkmcnt(2)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[188:189], v[168:169], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[190:191], v[170:171], v[66:81]
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[184:185], v[172:173], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[186:187], v[174:175], v[66:81]
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[180:181], v[176:177], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[182:183], v[178:179], v[66:81]
	s_waitcnt vmcnt(2) lgkmcnt(0)
	s_barrier
	s_setprio 0
	v_mov_b32_e32 v83, v82
...
.LBB0_44:
	...
	v_mov_b32 v74, v0
	;;#ASMEND
	s_lshl_b32 s44, s84, 13
	v_lshlrev_b32_e32 v75, 3, v74
	v_lshlrev_b32_e32 v74, 5, v74
	s_add_i32 s44, s44, s82
	v_and_b32_e32 v75, 0xf8, v75
	v_and_b32_e32 v74, 0x400, v74
	v_or3_b32 v74, v75, v74, s44
	v_ashrrev_i32_e32 v75, 31, v74
...
.LBB0_52:
	...
	s_lshl_b32 s37, s88, 7
	s_ashr_i32 s39, s38, 31
	v_mov_b32_e32 v86, v82
	v_mov_b32_e32 v87, v82
	v_or_b32_e32 v113, s86, v1
	s_addk_i32 s37, 0x77
...
.LBB0_73:
	...
	;;#ASMEND
	s_nop 0
	v_lshrrev_b32_e32 v115, 2, v83
	v_and_b32_e32 v115, 8, v115
	v_lshrrev_b32_e32 v83, 1, v83
	v_and_or_b32 v83, v83, s78, v113
	v_add_u32_e32 v115, s37, v115
	v_add_u32_e32 v83, s83, v83
	v_subrev_u32_e32 v180, 55, v115
	v_cmp_lt_i32_e32 vcc, v180, v83
	s_nop 1
	v_cndmask_b32_e32 v67, v111, v67, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 53, v115
	s_nop 0
	v_cndmask_b32_e32 v66, v111, v66, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 52, v115
	v_pk_mul_f32 v[66:67], v[86:87], v[66:67]
	v_cndmask_b32_e32 v68, v111, v68, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 51, v115
	s_nop 0
	v_cndmask_b32_e32 v69, v111, v69, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 50, v115
	s_nop 0
	v_cndmask_b32_e32 v70, v111, v70, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 49, v115
	s_nop 0
	v_cndmask_b32_e32 v71, v111, v71, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 48, v115
	s_nop 0
	v_cndmask_b32_e32 v72, v111, v72, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 39, v115
	s_nop 0
	v_cndmask_b32_e32 v73, v111, v73, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 38, v115
	s_nop 0
	v_cndmask_b32_e32 v74, v111, v74, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 37, v115
	s_nop 0
	v_cndmask_b32_e32 v75, v111, v75, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 36, v115
	s_nop 0
	v_cndmask_b32_e32 v76, v111, v76, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 35, v115
	s_nop 0
	v_cndmask_b32_e32 v77, v111, v77, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 34, v115
	s_nop 0
	v_cndmask_b32_e32 v78, v111, v78, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 33, v115
...
.LBB0_77:
	...
	s_mul_i32 s48, s85, 0x1800
	v_add_u32_sdwa v66, s48, v104 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_ashrrev_i32_e32 v67, 31, v66
	v_lshl_add_u64 v[66:67], v[66:67], 2, s[0:1]
	global_load_dwordx4 v[116:119], v[66:67], off
	global_load_dwordx4 v[120:123], v[66:67], off offset:256
.LBB0_79:
	...
	v_add_u32_e32 v115, s37, v115
	v_add_u32_e32 v83, s83, v83
	v_subrev_u32_e32 v180, 23, v115
	v_cmp_lt_i32_e32 vcc, v180, v83
	s_nop 1
	v_cndmask_b32_e32 v67, v111, v67, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 21, v115
	s_nop 0
	v_cndmask_b32_e32 v66, v111, v66, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 20, v115
	v_pk_mul_f32 v[66:67], v[86:87], v[66:67]
	v_cndmask_b32_e32 v68, v111, v68, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 19, v115
	s_nop 0
	v_cndmask_b32_e32 v69, v111, v69, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 18, v115
	s_nop 0
	v_cndmask_b32_e32 v70, v111, v70, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_subrev_u32_e32 v180, 17, v115
	s_nop 0
	v_cndmask_b32_e32 v71, v111, v71, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_add_u32_e32 v180, -16, v115
	s_nop 0
	v_cndmask_b32_e32 v72, v111, v72, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_add_u32_e32 v180, -7, v115
	s_nop 0
	v_cndmask_b32_e32 v73, v111, v73, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_add_u32_e32 v180, -6, v115
	s_nop 0
	v_cndmask_b32_e32 v74, v111, v74, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_add_u32_e32 v180, -5, v115
	s_nop 0
	v_cndmask_b32_e32 v75, v111, v75, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_add_u32_e32 v180, -4, v115
	s_nop 0
	v_cndmask_b32_e32 v76, v111, v76, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_add_u32_e32 v180, -3, v115
	s_nop 0
	v_cndmask_b32_e32 v77, v111, v77, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_add_u32_e32 v180, -2, v115
	s_nop 0
	v_cndmask_b32_e32 v78, v111, v78, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	v_add_u32_e32 v180, -1, v115
	s_nop 0
	v_cndmask_b32_e32 v79, v111, v79, vcc
	v_cmp_le_i32_e32 vcc, v180, v83
	s_nop 1
...
.LBB0_82:
	...
	v_cndmask_b32_e32 v68, 0, v112, vcc
...
.LBB0_102:
	...
	global_atomic_add v3, v108, v3, s[34:35] sc0
.LBB0_105:
	s_or_b64 exec, exec, s[38:39]
	...
	global_store_dword v108, v2, s[38:39]
	s_waitcnt vmcnt(0)
.LBB0_106:
