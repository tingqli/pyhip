...
.LBB0_32:
	...
	v_and_or_b32 v134, v134, s44, v157
...
.LBB0_34:
	...
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v136, v137, s46
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v98, v135, s46
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v99, v134, s46
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
...
.LBB0_36:
	...
	v_and_b32_e32 v100, 8, v100
	v_and_b32_e32 v159, 48, v98
	v_and_or_b32 v160, v99, s45, v100
	...
	v_and_or_b32 v158, v158, s44, v157
	v_add_u32_e32 v159, s58, v159
	v_add_u32_e32 v158, s55, v158
	v_subrev_u32_e32 v160, 55, v159
	v_cmp_lt_i32_e32 vcc, v160, v158
	s_nop 1
	v_cndmask_b32_e32 v99, v155, v99, vcc
	v_cmp_le_i32_e32 vcc, v160, v158
...
.LBB0_39:
	...
	v_and_or_b32 v159, v159, s44, v157
	v_add_u32_e32 v160, s58, v160
	v_add_u32_e32 v159, s55, v159
