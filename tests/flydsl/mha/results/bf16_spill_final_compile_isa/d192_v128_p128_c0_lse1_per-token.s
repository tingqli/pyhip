...
.LBB0_9:
	...
	s_waitcnt lgkmcnt(0)
	v_writelane_b32 v242, s4, 0
	v_lshlrev_b32_e32 v2, 2, v2
	v_lshlrev_b32_e32 v1, 6, v1
	v_writelane_b32 v242, s5, 1
...
.LBB0_15:
	...
	s_add_u32 s92, s50, s8
	s_addc_u32 s93, s51, s9
	s_ashr_i32 s1, s0, 31
...
.LBB0_23:
	...
	ds_read_b128 v[194:197], v3 offset:12288
...
.LBB0_36:
	...
	s_waitcnt lgkmcnt(10)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[218:219], v[134:135], v[66:81]
	...
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[210:211], v[142:143], v[66:81]
	...
	s_waitcnt lgkmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[112:113], v[162:163], v[66:81]
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[102:103], v[176:177], v[66:81]
	s_waitcnt vmcnt(2) lgkmcnt(0)
	s_barrier
	s_setprio 0
	s_nop 7
...
.LBB0_38:
	...
	global_load_dwordx4 v[198:201], v[74:75], off offset:1024
	global_load_dwordx4 v[202:205], v[74:75], off offset:1536
	s_waitcnt vmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[2:17], v[76:77], v[66:67], v[2:17]
	s_waitcnt vmcnt(2)
	...
	global_load_dwordx4 v[194:197], v[66:67], off offset:1024
...
.LBB0_42:
	...
	s_waitcnt lgkmcnt(10)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[234:235], v[134:135], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[236:237], v[136:137], v[66:81]
	s_waitcnt lgkmcnt(9)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[230:231], v[138:139], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[232:233], v[140:141], v[66:81]
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[226:227], v[142:143], v[66:81]
...
.LBB0_44:
	...
	v_xor_b32_e32 v68, v67, v66
	v_lshlrev_b32_e32 v68, 1, v68
	ds_read_b128 v[238:241], v68
	v_or_b32_e32 v68, 16, v66
	v_xor_b32_e32 v68, v68, v67
	v_lshlrev_b32_e32 v68, 1, v68
	ds_read_b128 v[234:237], v68
	v_or_b32_e32 v68, 32, v66
	v_xor_b32_e32 v68, v68, v67
	v_lshlrev_b32_e32 v68, 1, v68
	ds_read_b128 v[230:233], v68
	v_or_b32_e32 v68, 48, v66
	v_xor_b32_e32 v67, v68, v67
	v_lshlrev_b32_e32 v67, 1, v67
	ds_read_b128 v[226:229], v67
...
.LBB0_83:
	...
	v_cndmask_b32_e64 v105, v125, v67, s[0:1]
	v_cndmask_b32_e32 v104, v125, v66, vcc
	...
	v_cndmask_b32_e64 v103, v125, v69, s[6:7]
	v_cndmask_b32_e64 v102, v125, v68, s[4:5]
...
.LBB0_85:
	...
	;;#ASMSTART
	v_perm_b32 v66, v66, v75, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v67, v67, v74, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v68, v68, v73, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v69, v69, v72, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v70, v71, v70, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v71, v102, v103, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v72, v100, v101, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v73, v81, v80, s83
	;;#ASMEND
...
.LBB0_95:
	...
	v_add_u32_e32 v128, s40, v128
	v_add_u32_e32 v129, 0xffffff49, v128
	v_cmp_gt_i32_e32 vcc, s37, v129
	v_add_u32_e32 v129, 0xffffff4a, v128
	v_cmp_gt_i32_e64 s[0:1], s37, v129
	v_add_u32_e32 v129, 0xffffff4b, v128
	v_cmp_gt_i32_e64 s[4:5], s37, v129
	v_add_u32_e32 v129, 0xffffff4c, v128
	v_cmp_gt_i32_e64 s[6:7], s37, v129
	v_add_u32_e32 v129, 0xffffff4d, v128
	v_cmp_gt_i32_e64 s[8:9], s37, v129
	v_add_u32_e32 v129, 0xffffff4e, v128
	v_cmp_gt_i32_e64 s[10:11], s37, v129
	v_add_u32_e32 v129, 0xffffff4f, v128
	v_cmp_gt_i32_e64 s[12:13], s37, v129
	v_add_u32_e32 v129, 0xffffff50, v128
	v_cmp_gt_i32_e64 s[14:15], s37, v129
	v_add_u32_e32 v129, 0xffffff59, v128
	v_cmp_gt_i32_e64 s[16:17], s37, v129
	v_add_u32_e32 v129, 0xffffff5a, v128
	v_cmp_gt_i32_e64 s[18:19], s37, v129
	v_add_u32_e32 v129, 0xffffff5b, v128
	v_cmp_gt_i32_e64 s[20:21], s37, v129
	v_add_u32_e32 v129, 0xffffff5c, v128
	v_cmp_gt_i32_e64 s[22:23], s37, v129
	v_add_u32_e32 v129, 0xffffff5d, v128
	v_cmp_gt_i32_e64 s[24:25], s37, v129
	v_add_u32_e32 v129, 0xffffff5e, v128
	v_cmp_gt_i32_e64 s[26:27], s37, v129
	v_add_u32_e32 v129, 0xffffff5f, v128
	v_add_u32_e32 v128, 0xffffff60, v128
...
.LBB0_108:
	...
	v_and_b32_e32 v128, 8, v128
	v_add_u32_e32 v128, s40, v128
	v_add_u32_e32 v129, 0xffffff89, v128
	v_cmp_gt_i32_e32 vcc, s37, v129
	v_add_u32_e32 v129, 0xffffff8a, v128
	v_cmp_gt_i32_e64 s[0:1], s37, v129
	v_add_u32_e32 v129, 0xffffff8b, v128
	v_cmp_gt_i32_e64 s[4:5], s37, v129
	v_add_u32_e32 v129, 0xffffff8c, v128
	v_cmp_gt_i32_e64 s[6:7], s37, v129
	v_add_u32_e32 v129, 0xffffff8d, v128
	v_cmp_gt_i32_e64 s[8:9], s37, v129
	v_add_u32_e32 v129, 0xffffff8e, v128
	v_cmp_gt_i32_e64 s[10:11], s37, v129
	v_add_u32_e32 v129, 0xffffff8f, v128
	v_cmp_gt_i32_e64 s[12:13], s37, v129
	v_add_u32_e32 v129, 0xffffff90, v128
	v_cmp_gt_i32_e64 s[14:15], s37, v129
	v_add_u32_e32 v129, 0xffffff99, v128
	v_cmp_gt_i32_e64 s[16:17], s37, v129
	v_add_u32_e32 v129, 0xffffff9a, v128
	v_cmp_gt_i32_e64 s[18:19], s37, v129
	v_add_u32_e32 v129, 0xffffff9b, v128
	v_cmp_gt_i32_e64 s[20:21], s37, v129
	v_add_u32_e32 v129, 0xffffff9c, v128
	v_cmp_gt_i32_e64 s[22:23], s37, v129
	v_add_u32_e32 v129, 0xffffff9d, v128
	v_cmp_gt_i32_e64 s[24:25], s37, v129
	v_add_u32_e32 v129, 0xffffff9e, v128
	v_cmp_gt_i32_e64 s[26:27], s37, v129
	v_add_u32_e32 v129, 0xffffff9f, v128
	v_add_u32_e32 v128, 0xffffffa0, v128
	v_cmp_gt_i32_e64 s[28:29], s37, v129
	v_cmp_gt_i32_e64 s[30:31], s37, v128
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
...
.LBB0_110:
	...
	v_mov_b32 v74, v0
	;;#ASMEND
	s_lshl_b32 s46, s88, 14
	v_lshlrev_b32_e32 v75, 3, v74
	v_lshlrev_b32_e32 v74, 5, v74
	s_add_i32 s46, s46, s87
	v_and_b32_e32 v75, 0xf8, v75
	v_and_b32_e32 v74, 0x400, v74
	v_or3_b32 v74, v75, v74, s46
	v_ashrrev_i32_e32 v75, 31, v74
...
.LBB0_114:
	...
	v_and_b32_e32 v128, 8, v128
	v_add_u32_e32 v128, s40, v128
	v_add_u32_e32 v129, 0xffffffa9, v128
	v_cmp_gt_i32_e32 vcc, s37, v129
	v_add_u32_e32 v129, 0xffffffaa, v128
	v_cmp_gt_i32_e64 s[0:1], s37, v129
	v_add_u32_e32 v129, 0xffffffab, v128
	v_cmp_gt_i32_e64 s[4:5], s37, v129
	v_add_u32_e32 v129, 0xffffffac, v128
	v_cmp_gt_i32_e64 s[6:7], s37, v129
	v_add_u32_e32 v129, 0xffffffad, v128
	v_cmp_gt_i32_e64 s[8:9], s37, v129
	v_add_u32_e32 v129, 0xffffffae, v128
	v_cmp_gt_i32_e64 s[10:11], s37, v129
	v_add_u32_e32 v129, 0xffffffaf, v128
	v_cmp_gt_i32_e64 s[12:13], s37, v129
	v_add_u32_e32 v129, 0xffffffb0, v128
	v_cmp_gt_i32_e64 s[14:15], s37, v129
	v_add_u32_e32 v129, 0xffffffb9, v128
	v_cmp_gt_i32_e64 s[16:17], s37, v129
	v_add_u32_e32 v129, 0xffffffba, v128
	v_cmp_gt_i32_e64 s[18:19], s37, v129
	v_add_u32_e32 v129, 0xffffffbb, v128
	v_cmp_gt_i32_e64 s[20:21], s37, v129
	v_add_u32_e32 v129, 0xffffffbc, v128
	v_cmp_gt_i32_e64 s[22:23], s37, v129
	v_add_u32_e32 v129, 0xffffffbd, v128
	v_cmp_gt_i32_e64 s[24:25], s37, v129
	v_add_u32_e32 v129, 0xffffffbe, v128
	v_cmp_gt_i32_e64 s[26:27], s37, v129
	v_add_u32_e32 v129, 0xffffffbf, v128
	v_subrev_u32_e32 v128, 64, v128
	v_cmp_gt_i32_e64 s[28:29], s37, v129
	v_cmp_gt_i32_e64 s[30:31], s37, v128
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
...
.LBB0_129:
	...
	v_readlane_b32 s6, v242, 0
	v_readlane_b32 s7, v242, 1
...
.LBB0_149:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v122, v3, s[94:95] sc0
.LBB0_152:
...
.Lfunc_end0:
	...
	.set .Lattn_kernel_0.num_vgpr, 243
