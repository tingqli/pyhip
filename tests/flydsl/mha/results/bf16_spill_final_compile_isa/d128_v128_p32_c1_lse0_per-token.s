...
.LBB0_13:
	...
	s_mov_b32 s11, s7
	v_lshl_add_u32 v6, s73, 2, v85
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s38, v2
	s_add_i32 s6, s38, s84
	...
	s_ashr_i32 s9, s8, 31
	s_lshl_b32 s40, s6, 4
	global_load_dwordx2 v[4:5], v120, s[4:5]
	global_load_dword v3, v120, s[0:1]
	s_lshl_b64 s[0:1], s[8:9], 1
	s_add_u32 s8, s18, s0
	s_addc_u32 s4, s19, s1
	s_lshl_b32 s17, s73, 7
	...
	s_add_u32 s4, s28, s4
	buffer_load_dwordx4 v[128:131], v7, s[8:11], 0 offen
	buffer_load_dwordx4 v[132:135], v7, s[8:11], 0 offen offset:32
	buffer_load_dwordx4 v[136:139], v7, s[8:11], 0 offen offset:64
	buffer_load_dwordx4 v[140:143], v7, s[8:11], 0 offen offset:96
	buffer_load_dwordx4 v[144:147], v7, s[8:11], 0 offen offset:128
	buffer_load_dwordx4 v[148:151], v7, s[8:11], 0 offen offset:160
	s_addc_u32 s5, s29, s5
	s_lshl_b32 s6, s85, 6
	s_and_b32 s5, s5, 0xffff
	buffer_load_dword v2, v6, s[4:7], 0 offen
	buffer_load_dwordx4 v[152:155], v7, s[8:11], 0 offen offset:192
	buffer_load_dwordx4 v[156:159], v7, s[8:11], 0 offen offset:224
	s_waitcnt vmcnt(10)
...
.LBB0_15:
	...
	s_sub_i32 s86, s5, s4
	s_ashr_i32 s5, s73, 31
	s_lshr_b32 s5, s5, 28
	s_add_i32 s5, s73, s5
	s_sub_i32 s40, s38, s39
	s_lshl_b32 s41, s86, 5
	s_ashr_i32 s6, s5, 4
	s_and_b32 s5, s5, -16
	s_cmp_lg_u32 s73, s5
	s_cselect_b64 s[8:9], -1, 0
	...
	s_add_i32 s38, s40, s41
	s_add_i32 s38, s38, s37
	s_sub_i32 s80, s38, 32
	s_add_i32 s88, s80, s84
	s_add_i32 s37, s88, 1
...
.LBB0_18:
	ds_write_b128 v118, v[160:163] offset:8192
	s_waitcnt lgkmcnt(8)
...
.LBB0_27:
	...
	s_cselect_b32 s83, s79, s82
	s_cselect_b32 s82, s81, s79
	s_cselect_b32 s79, s45, s81
	s_add_u32 s68, s68, 2
	s_addc_u32 s69, s69, 0
	v_mov_b64_e32 v[66:67], s[38:39]
	v_cmp_lt_i64_e32 vcc, s[68:69], v[66:67]
...
.LBB0_28:
	...
	s_add_i32 s40, s83, s11
	s_lshl_b32 s40, s40, 12
	v_mfma_f32_32x32x8_bf16 v[66:81], v[186:187], v[130:131], v[66:81]
	buffer_load_dword v114, v100, s[4:7], 0 offen
	v_lshl_or_b32 v100, s81, 11, v117
	...
	v_and_or_b32 v100, v100, s74, v125
	v_add_u32_e32 v127, s37, v101
	v_add_u32_e32 v126, s80, v100
	v_subrev_u32_e32 v100, 55, v127
	v_cmp_lt_i32_e32 vcc, v100, v126
	s_nop 1
	v_cndmask_b32_e32 v101, v123, v67, vcc
	v_cmp_le_i32_e32 vcc, v100, v126
	v_subrev_u32_e32 v67, 32, v127
	s_nop 0
	v_cndmask_b32_e32 v100, v123, v66, vcc
	v_subrev_u32_e32 v66, 53, v127
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 52, v127
	s_nop 0
	v_cndmask_b32_e32 v106, v123, v68, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 51, v127
	s_nop 0
	v_cndmask_b32_e32 v107, v123, v69, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 50, v127
	s_nop 0
	v_cndmask_b32_e32 v108, v123, v70, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 49, v127
	s_nop 0
	v_cndmask_b32_e32 v109, v123, v71, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 48, v127
	s_nop 0
	v_cndmask_b32_e32 v114, v123, v72, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 39, v127
	s_nop 0
	v_cndmask_b32_e32 v115, v123, v73, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 38, v127
	s_nop 0
	v_cndmask_b32_e32 v72, v123, v74, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 37, v127
	s_nop 0
	v_cndmask_b32_e32 v73, v123, v75, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 36, v127
	v_pk_mul_f32 v[74:75], v[90:91], v[114:115]
	v_cndmask_b32_e32 v70, v123, v76, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 35, v127
	v_pk_mul_f32 v[72:73], v[92:93], v[72:73]
	v_cndmask_b32_e32 v71, v123, v77, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 34, v127
	v_pk_mul_f32 v[76:77], v[88:89], v[108:109]
	v_cndmask_b32_e32 v68, v123, v78, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_subrev_u32_e32 v66, 33, v127
	v_pk_mul_f32 v[70:71], v[94:95], v[70:71]
	v_cndmask_b32_e32 v69, v123, v79, vcc
	v_cmp_le_i32_e32 vcc, v66, v126
	v_pk_mul_f32 v[78:79], v[86:87], v[106:107]
	v_pk_mul_f32 v[68:69], v[96:97], v[68:69]
	v_cndmask_b32_e32 v66, v123, v80, vcc
	v_cmp_le_i32_e32 vcc, v67, v126
	s_nop 1
...
.LBB0_30:
	...
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v71, v71, v108, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v72, v106, v107, s77
	;;#ASMEND
	;;#ASMSTART
...
.LBB0_34:
	...
	;;#ASMEND
	s_nop 0
	v_div_scale_f32 v67, s[4:5], v66, v66, s72
	v_rcp_f32_e32 v68, v67
	v_div_scale_f32 v69, vcc, s72, v66, s72
	...
	v_div_fixup_f32 v66, v67, v66, s72
...
.LBB0_55:
	...
	global_store_dword v120, v2, s[8:9]
	s_waitcnt vmcnt(0)
.LBB0_56:
	s_or_b64 exec, exec, s[4:5]
...
.LBB0_59:
	...
	global_load_dwordx2 v[2:3], v120, s[8:9] offset:4
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s6, v3
