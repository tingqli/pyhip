...
.LBB0_22:
	...
	v_or_b32_e32 v157, 0x1010, v159
	v_xor_b32_e32 v157, v157, v158
	v_lshlrev_b32_e32 v157, 1, v157
	ds_read_b128 v[196:199], v157
	s_waitcnt lgkmcnt(0)
	...
	v_max_f32_e32 v159, v157, v158
	;;#ASMSTART
	v_add_f32 v157, v118, v152
	;;#ASMEND
	v_mov_b32_e32 v158, 1.0
	v_cmp_gt_f32_e32 vcc, v159, v157
	v_mov_b32_e32 v157, 1.0
	s_and_saveexec_b64 s[4:5], vcc
	s_cbranch_execz .LBB0_24
	;;#ASMSTART
	v_add_f32 v134, v159, v153
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v118, v118, v134
...
.LBB0_24:
	...
	v_or_b32_e32 v200, 16, v158
	v_xor_b32_e32 v200, v200, v159
	v_lshlrev_b32_e32 v200, 1, v200
	ds_read_b128 v[200:203], v200
	s_waitcnt lgkmcnt(0)
	...
	v_or_b32_e32 v200, 48, v158
	v_xor_b32_e32 v159, v200, v159
	...
	v_lshrrev_b32_e32 v200, 3, v159
	v_and_b32_e32 v200, 56, v200
	v_xor_b32_e32 v159, v200, v159
	v_lshlrev_b32_e32 v159, 1, v159
	ds_read_b128 v[200:203], v159
	s_waitcnt lgkmcnt(0)
...
.LBB0_35:
	...
	v_add_u32_e32 v157, s92, v157
	v_subrev_u32_e32 v158, 55, v157
	v_cmp_gt_i32_e32 vcc, s91, v158
	v_subrev_u32_e32 v158, 54, v157
	v_cmp_gt_i32_e64 s[0:1], s91, v158
	v_subrev_u32_e32 v158, 53, v157
	v_cmp_gt_i32_e64 s[4:5], s91, v158
	v_subrev_u32_e32 v158, 52, v157
	v_cmp_gt_i32_e64 s[6:7], s91, v158
	v_subrev_u32_e32 v158, 51, v157
	v_cmp_gt_i32_e64 s[8:9], s91, v158
	v_subrev_u32_e32 v158, 50, v157
	v_cmp_gt_i32_e64 s[10:11], s91, v158
	v_subrev_u32_e32 v158, 49, v157
	v_cmp_gt_i32_e64 s[12:13], s91, v158
	v_subrev_u32_e32 v158, 48, v157
	v_cmp_gt_i32_e64 s[14:15], s91, v158
	v_subrev_u32_e32 v158, 39, v157
	v_cmp_gt_i32_e64 s[16:17], s91, v158
	v_subrev_u32_e32 v158, 38, v157
	v_cmp_gt_i32_e64 s[18:19], s91, v158
	v_subrev_u32_e32 v158, 37, v157
	v_cmp_gt_i32_e64 s[20:21], s91, v158
	v_subrev_u32_e32 v158, 36, v157
	v_cmp_gt_i32_e64 s[22:23], s91, v158
	v_subrev_u32_e32 v158, 35, v157
	v_cmp_gt_i32_e64 s[24:25], s91, v158
	v_subrev_u32_e32 v158, 34, v157
	v_cmp_gt_i32_e64 s[26:27], s91, v158
	v_subrev_u32_e32 v158, 33, v157
	v_subrev_u32_e32 v157, 32, v157
	v_cmp_gt_i32_e64 s[28:29], s91, v158
	v_cmp_gt_i32_e64 s[30:31], s91, v157
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
	s_or_b64 s[24:25], s[26:27], s[24:25]
	s_or_b64 s[22:23], s[24:25], s[22:23]
...
.LBB0_41:
	...
	v_cndmask_b32_e32 v100, 0, v155, vcc
	s_add_u32 s6, s60, s4
	...
	s_add_u32 s4, s6, s4
	s_addc_u32 s5, s7, s5
	v_cndmask_b32_e32 v100, v154, v100, vcc
