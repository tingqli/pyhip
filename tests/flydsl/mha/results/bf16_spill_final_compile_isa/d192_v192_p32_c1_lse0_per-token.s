...
.LBB0_13:
	...
	buffer_load_dwordx4 v[208:211], v7, s[8:11], 0 offen offset:256
	buffer_load_dwordx4 v[212:215], v7, s[8:11], 0 offen offset:288
	...
	buffer_load_dwordx4 v[216:219], v7, s[8:11], 0 offen offset:320
	buffer_load_dwordx4 v[220:223], v7, s[8:11], 0 offen offset:352
	s_waitcnt vmcnt(14)
...
.LBB0_19:
	...
	ds_write_b128 v150, v[160:163]
	ds_write_b128 v150, v[164:167] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[36:37]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_26:
	...
	ds_write_b128 v150, v[168:171] offset:12288
	ds_write_b128 v150, v[172:175] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[40:41]
	;;#ASMSTART
	v_mov_b32 v98, v0
...
.LBB0_48:
	...
	v_and_or_b32 v132, v132, s48, v157
	v_add_u32_e32 v141, s60, v133
	v_add_u32_e32 v140, s57, v132
...
.LBB0_50:
	...
	;;#ASMSTART
	v_perm_b32 v100, v100, v109, s50
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v108, s50
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v102, v107, s50
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v103, v106, s50
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v105, v104, s50
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v134, v135, s50
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v98, v133, s50
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v99, v132, s50
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
...
.LBB0_91:
	...
	v_mov_b32_e32 v3, s6
	global_atomic_add v3, v152, v3, s[34:35] sc0
.LBB0_95:
	s_or_b64 exec, exec, s[8:9]
