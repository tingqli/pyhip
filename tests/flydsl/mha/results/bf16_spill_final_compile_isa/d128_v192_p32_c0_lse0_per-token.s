...
.LBB0_13:
	...
	v_lshl_add_u32 v7, s71, 8, v117
	s_mov_b32 s7, s39
	v_lshl_add_u32 v6, s71, 2, v1
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s79, v2
	s_add_i32 s79, s79, s6
	v_readfirstlane_b32 s4, v3
	s_add_i32 s5, s79, 0x100
	s_min_i32 s4, s5, s4
	s_sub_i32 s43, s4, s79
	s_waitcnt lgkmcnt(0)
	s_add_u32 s4, s50, s0
	s_addc_u32 s5, s51, s1
	s_add_u32 s0, s40, s0
	s_addc_u32 s1, s41, s1
	s_lshl_b32 s10, s79, 11
	s_ashr_i32 s11, s10, 31
	s_lshl_b32 s8, s79, 4
	global_load_dwordx2 v[4:5], v151, s[4:5]
...
.LBB0_15:
	...
	s_subb_u32 s80, s10, 0
	s_lshl_b32 s4, s80, 12
	s_ashr_i32 s5, s4, 31
...
.LBB0_17:
	...
	;;#ASMSTART
	v_perm_b32 v100, v99, v98, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v132, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v105, v104, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v107, v106, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v109, v108, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v111, v110, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v113, v112, s73
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
	...
	v_add_co_u32_e32 v100, vcc, s74, v106
	s_nop 1
	...
	v_add_co_u32_e32 v100, vcc, s75, v106
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v107, vcc
...
.LBB0_18:
	...
	s_mov_b32 s9, s83
	buffer_load_dword v116, v98, s[36:39], 0 offen
	v_lshl_or_b32 v98, s9, 11, v148
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[62:63]
	ds_write_b128 v149, v[190:193] offset:8192
	...
	v_and_or_b32 v134, v99, s72, v100
...
.LBB0_20:
	...
	buffer_load_dword v116, v98, s[36:39], 0 offen
	v_lshl_or_b32 v98, s81, 11, v148
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[62:63]
	ds_write_b128 v149, v[194:197]
	global_load_dwordx4 v[194:197], v[98:99], off
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s83, v116
	v_lshrrev_b32_e32 v100, 2, v98
	v_lshlrev_b32_e32 v99, 7, v98
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_b32_e32 v100, 8, v100
...
.LBB0_26:
	...
	s_cselect_b32 s66, s81, s82
	s_cselect_b32 s82, s83, s81
	s_cselect_b32 s81, s88, s83
	s_add_u32 s64, s64, 2
...
.LBB0_27:
	...
	buffer_load_dword v132, v98, s[36:39], 0 offen
	v_lshl_or_b32 v98, s83, 11, v148
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[62:63]
	ds_write_b128 v149, v[190:193] offset:8192
	global_load_dwordx4 v[190:193], v[98:99], off
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[132:133], v[186:187], v[98:113]
	...
	v_add_u32_e32 v132, s85, v132
	v_subrev_u32_e32 v133, 55, v132
	v_cmp_gt_i32_e32 vcc, s84, v133
	v_subrev_u32_e32 v133, 54, v132
	v_cmp_gt_i32_e64 s[0:1], s84, v133
	v_subrev_u32_e32 v133, 53, v132
	v_cmp_gt_i32_e64 s[4:5], s84, v133
	v_subrev_u32_e32 v133, 52, v132
	v_cmp_gt_i32_e64 s[6:7], s84, v133
	v_subrev_u32_e32 v133, 51, v132
	v_cmp_gt_i32_e64 s[8:9], s84, v133
	v_subrev_u32_e32 v133, 50, v132
	v_cmp_gt_i32_e64 s[10:11], s84, v133
	v_subrev_u32_e32 v133, 49, v132
	v_cmp_gt_i32_e64 s[12:13], s84, v133
	v_subrev_u32_e32 v133, 48, v132
	v_cmp_gt_i32_e64 s[14:15], s84, v133
	v_subrev_u32_e32 v133, 39, v132
	v_cmp_gt_i32_e64 s[16:17], s84, v133
	v_subrev_u32_e32 v133, 38, v132
	v_cmp_gt_i32_e64 s[18:19], s84, v133
	v_subrev_u32_e32 v133, 37, v132
	v_cmp_gt_i32_e64 s[20:21], s84, v133
	v_subrev_u32_e32 v133, 36, v132
	v_cmp_gt_i32_e64 s[22:23], s84, v133
	v_subrev_u32_e32 v133, 35, v132
	v_cmp_gt_i32_e64 s[24:25], s84, v133
	v_subrev_u32_e32 v133, 34, v132
	v_cmp_gt_i32_e64 s[26:27], s84, v133
	v_subrev_u32_e32 v133, 33, v132
	v_subrev_u32_e32 v132, 32, v132
	v_cmp_gt_i32_e64 s[28:29], s84, v133
	v_cmp_gt_i32_e64 s[30:31], s84, v132
...
.LBB0_29:
	...
	;;#ASMSTART
	v_perm_b32 v100, v100, v109, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v108, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v102, v107, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v103, v106, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v105, v104, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v134, v135, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v98, v133, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v99, v132, s73
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[108:109], v[98:99], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[82:97], v[102:103], v[98:99], v[82:97]
	s_cmp_gt_i32 s60, s86
	s_cselect_b64 s[66:67], -1, 0
	s_cmp_le_i32 s60, s86
	s_cbranch_scc1 .LBB0_32
	v_mov_b32_e32 v98, s87
	buffer_load_dword v132, v98, s[36:39], 0 offen
	v_lshl_or_b32 v98, s88, 11, v148
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[62:63]
	ds_write_b128 v149, v[194:197]
	global_load_dwordx4 v[194:197], v[98:99], off
...
.LBB0_33:
	...
	;;#ASMEND
	s_nop 0
	v_div_scale_f32 v99, s[0:1], v98, v98, s70
	v_rcp_f32_e32 v100, v99
	v_div_scale_f32 v101, vcc, s70, v98, s70
	...
	v_div_fixup_f32 v98, v99, v98, s70
	...
	;;#ASMSTART
	v_perm_b32 v48, v3, v2, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v49, v5, v4, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v46, v7, v6, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v47, v9, v8, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v44, v11, v10, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v45, v13, v12, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v42, v15, v14, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v43, v17, v16, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v40, v19, v18, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v41, v21, v20, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v38, v23, v22, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v39, v25, v24, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v36, v27, v26, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v37, v29, v28, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v34, v31, v30, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v35, v33, v32, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v112, v113, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v110, v111, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v108, v109, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v106, v107, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v28, v104, v105, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v102, v103, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v100, v101, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v98, v99, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v51, v50, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v53, v52, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v55, v54, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v57, v56, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v59, v58, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v61, v60, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v63, v62, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v65, v64, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v67, v66, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v69, v68, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v71, v70, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v73, v72, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v75, v74, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v77, v76, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v79, v78, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v81, v80, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v83, v82, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v85, v84, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v87, v86, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v89, v88, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v91, v90, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v93, v92, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v95, v94, s73
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v97, v96, s73
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v50, v0
	;;#ASMEND
...
.LBB0_37:
	...
	s_barrier
.LBB0_38:
	v_mul_u32_u24_sdwa v95, v94, s76 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
.LBB0_65:
	...
	s_barrier
.LBB0_66:
	v_mul_u32_u24_sdwa v2, v88, s76 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v151, v3, s[58:59] sc0
.LBB0_70:
