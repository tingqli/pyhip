...
.LBB0_13:
	...
	v_lshl_add_u32 v7, s22, 8, v148
	s_mov_b32 s43, s7
	v_lshl_add_u32 v6, s22, 2, v117
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s23, v2
	s_add_i32 s36, s23, s44
...
.LBB0_15:
	...
	s_sub_i32 s59, s39, 32
	s_add_i32 s62, s59, s44
	s_add_i32 s40, s62, 1
	...
	s_cselect_b64 s[40:41], -1, 0
	s_and_b64 s[38:39], s[40:41], s[38:39]
	s_subb_u32 s63, s42, 0
	s_lshl_b32 s38, s63, 1
	s_ashr_i32 s39, s38, 31
	s_cmp_lt_i32 s63, 1
...
.LBB0_20:
	...
	buffer_load_dword v116, v98, s[4:7], 0 offen
	v_lshl_or_b32 v98, s58, 11, v149
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[0:1]
	ds_write_b128 v150, v[198:201]
	global_load_dwordx4 v[198:201], v[98:99], off
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s61, v116
	v_lshrrev_b32_e32 v100, 2, v98
	v_lshlrev_b32_e32 v99, 7, v98
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_b32_e32 v100, 8, v100
...
.LBB0_24:
	s_add_i32 s40, s13, s62
	s_add_i32 s42, s40, 31
	s_ashr_i32 s40, s42, 31
	s_lshr_b32 s40, s40, 27
	s_add_i32 s40, s42, s40
	s_ashr_i32 s62, s40, 5
	s_andn2_b32 s40, s40, 31
	s_cmp_lg_u32 s42, s40
	s_cselect_b64 s[40:41], -1, 0
	s_cmp_lt_i32 s42, 0
	s_cselect_b64 s[42:43], -1, 0
	s_and_b64 s[40:41], s[42:43], s[40:41]
	s_subb_u32 s40, s62, 0
	s_min_i32 s40, s40, s45
...
.LBB0_26:
	...
	v_mov_b32 v106, v0
	;;#ASMEND
	s_add_i32 s44, s60, s37
	v_lshlrev_b32_e32 v107, 3, v106
	v_bfe_i32 v106, v106, 5, 1
	s_mulk_i32 s44, 0x1800
	v_and_b32_e32 v107, 0xf8, v107
	v_and_b32_e32 v106, 0x600, v106
...
.LBB0_27:
	...
	s_cselect_b32 s64, s58, s60
	s_cselect_b32 s60, s61, s58
	s_cselect_b32 s58, s65, s61
	s_add_u32 s38, s38, 2
...
.LBB0_28:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[132:133], v[190:191], v[98:113]
	...
	v_and_or_b32 v132, v132, s49, v158
	v_add_u32_e32 v141, s62, v133
	v_add_u32_e32 v140, s59, v132
...
.LBB0_30:
	...
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v134, v135, s51
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v98, v133, s51
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v99, v132, s51
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
	...
	v_lshrrev_b32_e32 v132, 1, v132
	v_and_or_b32 v132, v132, s49, v158
	v_add_u32_e32 v133, s62, v133
	v_add_u32_e32 v132, s59, v132
...
.LBB0_73:
	...
	global_store_dword v152, v2, s[36:37]
	s_waitcnt vmcnt(0)
.LBB0_74:
