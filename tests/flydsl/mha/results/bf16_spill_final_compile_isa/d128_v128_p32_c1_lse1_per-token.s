...
.LBB0_18:
	ds_write_b128 v118, v[162:165] offset:8192
	s_waitcnt lgkmcnt(8)
	...
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[110:111], v[142:143], v[66:81]
	...
	v_add_co_u32_e32 v102, vcc, s81, v102
	s_nop 1
	v_addc_co_u32_e32 v103, vcc, 0, v103, vcc
	global_load_dwordx4 v[170:173], v[102:103], off
	...
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[106:107], v[158:159], v[66:81]
...
.LBB0_20:
	...
	global_load_dwordx4 v[186:189], v[102:103], off offset:1024
	s_waitcnt lgkmcnt(4)
	...
	global_load_dwordx4 v[182:185], v[102:103], off offset:512
...
.LBB0_28:
	...
	v_add_co_u32_e32 v100, vcc, s81, v100
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v101, vcc
	global_load_dwordx4 v[170:173], v[100:101], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[176:177], v[152:153], v[66:81]
	s_waitcnt lgkmcnt(2)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[178:179], v[154:155], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[180:181], v[156:157], v[66:81]
...
.LBB0_30:
	...
	;;#ASMSTART
	v_perm_b32 v66, v66, v76, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v67, v67, v75, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v68, v68, v74, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v69, v69, v73, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v70, v70, v72, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v71, v71, v108, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v72, v106, v107, s82
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v73, v100, v101, s82
	;;#ASMEND
	s_barrier
	s_setprio 1
	s_waitcnt vmcnt(7)
	...
	v_ashrrev_i32_e32 v101, 31, v100
	v_lshl_add_u64 v[100:101], v[100:101], 1, s[22:23]
	global_load_dwordx4 v[194:197], v[100:101], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[104:105], v[140:141], v[66:81]
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[110:111], v[142:143], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[112:113], v[144:145], v[66:81]
	global_load_dwordx4 v[198:201], v[100:101], off offset:512
	global_load_dwordx4 v[186:189], v[100:101], off offset:1024
	s_waitcnt lgkmcnt(4)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[170:171], v[146:147], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[172:173], v[148:149], v[66:81]
	s_waitcnt lgkmcnt(3)
	...
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v101, vcc
	global_load_dwordx4 v[182:185], v[100:101], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[176:177], v[152:153], v[66:81]
	s_waitcnt lgkmcnt(2)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[178:179], v[154:155], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[180:181], v[156:157], v[66:81]
	global_load_dwordx4 v[178:181], v[100:101], off offset:512
	global_load_dwordx4 v[174:177], v[100:101], off offset:1024
	global_load_dwordx4 v[170:173], v[100:101], off offset:1536
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[106:107], v[158:159], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[108:109], v[160:161], v[66:81]
	s_waitcnt vmcnt(9) lgkmcnt(0)
...
.LBB0_54:
	...
	v_mov_b32_e32 v3, s6
	global_atomic_add v3, v120, v3, s[70:71] sc0
.LBB0_57:
