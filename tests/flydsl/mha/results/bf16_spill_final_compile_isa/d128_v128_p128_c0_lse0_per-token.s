...
.LBB0_18:
	...
	global_load_dwordx4 v[162:165], v[102:103], off offset:1024
	s_waitcnt lgkmcnt(4)
	...
	global_load_dwordx4 v[174:177], v[102:103], off offset:1536
...
.LBB0_22:
	...
	v_add_co_u32_e32 v128, vcc, s90, v128
	s_nop 1
...
.LBB0_26:
	...
	s_add_i32 s13, s13, s98
	v_mfma_f32_32x32x8_bf16 v[66:81], v[172:173], v[132:133], v[66:81]
	buffer_load_dword v125, v125, s[68:71], 0 offen
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s99, v125
	s_waitcnt lgkmcnt(7)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[174:175], v[134:135], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[176:177], v[136:137], v[66:81]
	s_waitcnt lgkmcnt(6)
	...
	v_add_co_u32_e32 v118, vcc, s90, v118
	s_nop 1
...
.LBB0_28:
	...
	global_load_dwordx4 v[186:189], v[126:127], off offset:512
	v_mfma_f32_32x32x8_bf16 v[66:81], v[180:181], v[140:141], v[66:81]
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[182:183], v[142:143], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[184:185], v[144:145], v[66:81]
	global_load_dwordx4 v[190:193], v[126:127], off offset:1024
	global_load_dwordx4 v[182:185], v[126:127], off offset:1536
	...
	v_max3_f32 v125, v125, v78, v79
	v_max3_f32 v125, v125, v80, v81
	ds_bpermute_b32 v198, v121, v125
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v198, v198, v198
	v_max_f32_e32 v125, v125, v198
	;;#ASMSTART
	v_add_f32 v198, v86, v122
	;;#ASMEND
	s_nop 0
	v_cmp_gt_f32_e32 vcc, v125, v198
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_41:
	...
	global_load_dwordx4 v[174:177], v[102:103], off offset:1024
	global_load_dwordx4 v[126:129], v[102:103], off offset:1536
	s_waitcnt lgkmcnt(1)
...
.LBB0_43:
	...
	v_add_u32_e32 v127, 0xffffff49, v126
	v_cmp_gt_i32_e32 vcc, s37, v127
	v_add_u32_e32 v127, 0xffffff4a, v126
	v_cmp_gt_i32_e64 s[0:1], s37, v127
	v_add_u32_e32 v127, 0xffffff4b, v126
	v_cmp_gt_i32_e64 s[4:5], s37, v127
	v_add_u32_e32 v127, 0xffffff4c, v126
	v_cmp_gt_i32_e64 s[6:7], s37, v127
	v_add_u32_e32 v127, 0xffffff4d, v126
	v_cmp_gt_i32_e64 s[8:9], s37, v127
	v_add_u32_e32 v127, 0xffffff4e, v126
	v_cmp_gt_i32_e64 s[10:11], s37, v127
	v_add_u32_e32 v127, 0xffffff4f, v126
	v_cmp_gt_i32_e64 s[12:13], s37, v127
	v_add_u32_e32 v127, 0xffffff50, v126
	v_cmp_gt_i32_e64 s[14:15], s37, v127
	v_add_u32_e32 v127, 0xffffff59, v126
	v_cmp_gt_i32_e64 s[16:17], s37, v127
	v_add_u32_e32 v127, 0xffffff5a, v126
	v_cmp_gt_i32_e64 s[18:19], s37, v127
	v_add_u32_e32 v127, 0xffffff5b, v126
	v_cmp_gt_i32_e64 s[20:21], s37, v127
	v_add_u32_e32 v127, 0xffffff5c, v126
	v_cmp_gt_i32_e64 s[22:23], s37, v127
	v_add_u32_e32 v127, 0xffffff5d, v126
	v_cmp_gt_i32_e64 s[24:25], s37, v127
	v_add_u32_e32 v127, 0xffffff5e, v126
	v_cmp_gt_i32_e64 s[26:27], s37, v127
	v_add_u32_e32 v127, 0xffffff5f, v126
	v_add_u32_e32 v126, 0xffffff60, v126
...
.LBB0_47:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[196:197], v[132:133], v[66:81]
	buffer_load_dword v210, v162, s[68:71], 0 offen
	s_waitcnt vmcnt(0)
	...
	s_nop 1
	v_addc_co_u32_e32 v119, vcc, 0, v119, vcc
	global_load_dwordx4 v[190:193], v[118:119], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[184:185], v[152:153], v[66:81]
	s_waitcnt lgkmcnt(2)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[186:187], v[154:155], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[188:189], v[156:157], v[66:81]
	global_load_dwordx4 v[182:185], v[118:119], off offset:512
	global_load_dwordx4 v[178:181], v[118:119], off offset:1024
	global_load_dwordx4 v[174:177], v[118:119], off offset:1536
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[170:171], v[158:159], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[172:173], v[160:161], v[66:81]
	s_waitcnt vmcnt(9) lgkmcnt(0)
...
.LBB0_50:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[202:203], v[150:151], v[66:81]
	global_load_dwordx4 v[178:181], v[126:127], off
	global_load_dwordx4 v[170:173], v[126:127], off offset:512
	v_mfma_f32_32x32x8_bf16 v[66:81], v[204:205], v[152:153], v[66:81]
	s_waitcnt lgkmcnt(2)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[206:207], v[154:155], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[208:209], v[156:157], v[66:81]
	...
	v_add_u32_e32 v198, 0xffffffa9, v125
	v_cmp_gt_i32_e32 vcc, s37, v198
	v_add_u32_e32 v198, 0xffffffaa, v125
	v_cmp_gt_i32_e64 s[0:1], s37, v198
	v_add_u32_e32 v198, 0xffffffab, v125
	v_cmp_gt_i32_e64 s[4:5], s37, v198
	v_add_u32_e32 v198, 0xffffffac, v125
	v_cmp_gt_i32_e64 s[6:7], s37, v198
	v_add_u32_e32 v198, 0xffffffad, v125
	v_cmp_gt_i32_e64 s[8:9], s37, v198
	v_add_u32_e32 v198, 0xffffffae, v125
	v_cmp_gt_i32_e64 s[10:11], s37, v198
	v_add_u32_e32 v198, 0xffffffaf, v125
	v_cmp_gt_i32_e64 s[12:13], s37, v198
	v_add_u32_e32 v198, 0xffffffb0, v125
	v_cmp_gt_i32_e64 s[14:15], s37, v198
	v_add_u32_e32 v198, 0xffffffb9, v125
	v_cmp_gt_i32_e64 s[16:17], s37, v198
	v_add_u32_e32 v198, 0xffffffba, v125
	v_cmp_gt_i32_e64 s[18:19], s37, v198
	v_add_u32_e32 v198, 0xffffffbb, v125
	v_cmp_gt_i32_e64 s[20:21], s37, v198
	v_add_u32_e32 v198, 0xffffffbc, v125
	v_cmp_gt_i32_e64 s[22:23], s37, v198
	v_add_u32_e32 v198, 0xffffffbd, v125
	v_cmp_gt_i32_e64 s[24:25], s37, v198
	v_add_u32_e32 v198, 0xffffffbe, v125
	v_cmp_gt_i32_e64 s[26:27], s37, v198
	v_add_u32_e32 v198, 0xffffffbf, v125
	v_subrev_u32_e32 v125, 64, v125
	v_cmp_gt_i32_e64 s[28:29], s37, v198
