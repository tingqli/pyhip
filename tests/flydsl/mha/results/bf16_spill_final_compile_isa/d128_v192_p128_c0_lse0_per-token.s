...
.LBB0_9:
	...
	s_load_dwordx2 s[58:59], s[0:1], 0xc0
...
.LBB0_13:
	...
	v_lshl_add_u32 v7, s73, 8, v119
	s_mov_b32 s7, s39
	v_lshl_add_u32 v6, s73, 2, v1
	s_waitcnt vmcnt(0)
	...
	s_min_i32 s4, s5, s4
	s_sub_i32 s43, s4, s81
	s_waitcnt lgkmcnt(0)
	s_add_u32 s4, s50, s0
	s_addc_u32 s5, s51, s1
	s_add_u32 s0, s40, s0
	s_addc_u32 s1, s41, s1
	s_lshl_b32 s10, s81, 11
...
.LBB0_15:
	...
	s_add_u32 s62, s46, s4
	s_addc_u32 s63, s47, s5
	s_ashr_i32 s1, s0, 31
	s_lshl_b64 s[0:1], s[0:1], 2
	s_add_u32 s36, s52, s0
	s_addc_u32 s0, s53, s1
	s_lshl_b32 s38, s60, 2
	s_and_b32 s37, s0, 0xffff
...
.LBB0_18:
	...
	v_and_or_b32 v136, v99, s74, v100
...
.LBB0_20:
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v134, v99, s74, v100
	v_and_b32_e32 v135, 48, v98
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v135, v135, v135
	v_max_f32_e32 v157, v134, v135
	;;#ASMSTART
	v_add_f32 v134, v118, v154
	;;#ASMEND
	v_mov_b32_e32 v135, v118
	v_cmp_gt_f32_e32 vcc, v157, v134
...
.LBB0_22:
	...
	;;#ASMEND
	v_pk_add_f32 v[102:103], v[102:103], v[138:139] neg_lo:[0,1] neg_hi:[0,1]
	v_add_f32_e32 v157, 0, v98
	v_add_f32_e32 v157, v157, v99
	;;#ASMSTART
	v_exp_f32 v100, v100
	;;#ASMEND
	;;#ASMSTART
	...
	;;#ASMEND
	v_pk_add_f32 v[104:105], v[104:105], v[140:141] neg_lo:[0,1] neg_hi:[0,1]
	v_add_f32_e32 v157, v157, v100
	v_add_f32_e32 v157, v157, v101
	v_add_f32_e32 v157, v157, v102
	;;#ASMSTART
	v_exp_f32 v103, v103
	;;#ASMEND
	;;#ASMSTART
	...
	;;#ASMEND
	v_pk_add_f32 v[106:107], v[106:107], v[142:143] neg_lo:[0,1] neg_hi:[0,1]
	v_add_f32_e32 v157, v157, v103
	v_add_f32_e32 v157, v157, v104
	;;#ASMSTART
	v_exp_f32 v105, v105
	;;#ASMEND
	;;#ASMSTART
	...
	;;#ASMEND
	v_pk_add_f32 v[108:109], v[108:109], v[144:145] neg_lo:[0,1] neg_hi:[0,1]
	v_add_f32_e32 v157, v157, v105
	v_add_f32_e32 v157, v157, v106
	;;#ASMSTART
	v_exp_f32 v107, v107
	;;#ASMEND
	;;#ASMSTART
	...
	;;#ASMEND
	v_pk_add_f32 v[110:111], v[110:111], v[146:147] neg_lo:[0,1] neg_hi:[0,1]
	v_add_f32_e32 v157, v157, v107
	v_add_f32_e32 v157, v157, v108
	;;#ASMSTART
	v_exp_f32 v109, v109
	;;#ASMEND
	;;#ASMSTART
	...
	;;#ASMEND
	v_pk_add_f32 v[112:113], v[112:113], v[148:149] neg_lo:[0,1] neg_hi:[0,1]
	v_add_f32_e32 v157, v157, v109
	v_add_f32_e32 v157, v157, v110
	;;#ASMSTART
	v_exp_f32 v111, v111
	;;#ASMEND
	;;#ASMSTART
	...
	;;#ASMEND
	s_nop 0
	v_add_f32_e32 v157, v157, v111
	v_add_f32_e32 v157, v157, v112
	v_add_f32_e32 v157, v157, v113
	;;#ASMSTART
	v_fma_f32 v158, v151, v150, v157
	;;#ASMEND
	;;#ASMSTART
	...
	v_lshl_add_u64 v[150:151], v[98:99], 2, s[62:63]
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v157, v99, s74, v100
	v_and_b32_e32 v159, 48, v98
	v_or_b32_e32 v98, v157, v159
	v_lshlrev_b32_e32 v98, 1, v98
	...
	v_or_b32_e32 v157, 0x1070, v157
	v_lshrrev_b32_e32 v159, 3, v157
	v_and_b32_e32 v159, 56, v159
	v_xor_b32_e32 v157, v159, v157
	v_lshlrev_b32_e32 v157, 1, v157
	ds_read_b128 v[198:201], v157
	s_waitcnt lgkmcnt(0)
	...
	ds_bpermute_b32 v159, v153, v157
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v159, v159, v159
	v_max_f32_e32 v160, v157, v159
	;;#ASMSTART
	v_add_f32 v157, v118, v154
	;;#ASMEND
	v_mov_b32_e32 v159, 1.0
	v_cmp_gt_f32_e32 vcc, v160, v157
...
.LBB0_24:
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v159, v99, s74, v100
	...
	;;#ASMSTART
	v_add_f32 v134, v159, v155
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v118, v118, v134
	v_exp_f32_e32 v157, v118
	v_mov_b32_e32 v118, v134
	v_mov_b32_e32 v135, v134
	v_mov_b32_e32 v136, v134
	v_mov_b32_e32 v137, v134
...
.LBB0_26:
	...
	buffer_load_dword v157, v98, s[36:39], 0 offen
	...
	;;#ASMEND
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s85, v157
	v_lshrrev_b32_e32 v100, 2, v98
	v_lshlrev_b32_e32 v99, 7, v98
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_b32_e32 v100, 8, v100
	v_and_b32_e32 v150, 48, v98
	v_and_or_b32 v151, v99, s74, v100
	...
	v_mfma_f32_32x32x8_bf16 v[98:113], v[194:195], v[162:163], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[196:197], v[164:165], v[98:113]
	v_or_b32_e32 v157, 0x1010, v151
	v_xor_b32_e32 v157, v157, v150
	v_lshlrev_b32_e32 v157, 1, v157
	ds_read_b128 v[194:197], v157
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[194:195], v[166:167], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[196:197], v[168:169], v[98:113]
	v_or_b32_e32 v157, 0x1020, v151
	v_xor_b32_e32 v157, v157, v150
	v_lshlrev_b32_e32 v157, 1, v157
	ds_read_b128 v[194:197], v157
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[194:195], v[170:171], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[196:197], v[172:173], v[98:113]
	v_or_b32_e32 v157, 0x1030, v151
	v_xor_b32_e32 v150, v157, v150
...
.LBB0_28:
	...
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v157, v99, s74, v100
	v_and_b32_e32 v158, 48, v98
	v_or_b32_e32 v98, v157, v158
	v_lshlrev_b32_e32 v98, 1, v98
	ds_read_b128 v[194:197], v98
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[194:195], v[162:163], 0
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[158:159], v[174:175], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[160:161], v[176:177], v[98:113]
	v_or_b32_e32 v158, 64, v157
	...
	v_max3_f32 v157, v157, v110, v111
	v_max3_f32 v157, v157, v112, v113
	ds_bpermute_b32 v158, v153, v157
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v158, v158, v158
	v_max_f32_e32 v157, v157, v158
	;;#ASMSTART
	v_add_f32 v158, v118, v154
	;;#ASMEND
	s_nop 0
	v_cmp_gt_f32_e32 vcc, v157, v158
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_30:
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v158, v99, s74, v100
	v_and_b32_e32 v159, 48, v98
...
.LBB0_32:
	...
	v_and_b32_e32 v100, 8, v100
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_or_b32 v150, v99, s74, v100
	...
	v_or_b32_e32 v159, 16, v150
	v_xor_b32_e32 v159, v159, v151
	v_lshlrev_b32_e32 v159, 1, v159
	...
	v_or_b32_e32 v159, 48, v150
	v_xor_b32_e32 v151, v159, v151
...
.LBB0_39:
	...
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[62:63]
	global_load_dwordx4 v[158:161], v[98:99], off offset:1536
	ds_write_b128 v152, v[194:197]
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s90, v134
	v_lshrrev_b32_e32 v100, 2, v98
	v_lshlrev_b32_e32 v99, 7, v98
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_b32_e32 v100, 8, v100
...
.LBB0_41:
	...
	;;#ASMSTART
	v_perm_b32 v100, v100, v109, s75
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v108, s75
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v102, v107, s75
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v103, v106, s75
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v105, v104, s75
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v136, v137, s75
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v98, v135, s75
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v99, v134, s75
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
...
.LBB0_43:
	...
	v_add_u32_e32 v158, s87, v158
	v_add_u32_e32 v159, 0xffffff49, v158
	v_cmp_gt_i32_e32 vcc, s86, v159
	v_add_u32_e32 v159, 0xffffff4a, v158
	v_cmp_gt_i32_e64 s[0:1], s86, v159
	v_add_u32_e32 v159, 0xffffff4b, v158
	v_cmp_gt_i32_e64 s[4:5], s86, v159
	v_add_u32_e32 v159, 0xffffff4c, v158
	v_cmp_gt_i32_e64 s[6:7], s86, v159
	v_add_u32_e32 v159, 0xffffff4d, v158
	v_cmp_gt_i32_e64 s[8:9], s86, v159
	v_add_u32_e32 v159, 0xffffff4e, v158
	v_cmp_gt_i32_e64 s[10:11], s86, v159
	v_add_u32_e32 v159, 0xffffff4f, v158
	v_cmp_gt_i32_e64 s[12:13], s86, v159
	v_add_u32_e32 v159, 0xffffff50, v158
	v_cmp_gt_i32_e64 s[14:15], s86, v159
	v_add_u32_e32 v159, 0xffffff59, v158
	v_cmp_gt_i32_e64 s[16:17], s86, v159
	v_add_u32_e32 v159, 0xffffff5a, v158
	v_cmp_gt_i32_e64 s[18:19], s86, v159
	v_add_u32_e32 v159, 0xffffff5b, v158
	v_cmp_gt_i32_e64 s[20:21], s86, v159
	v_add_u32_e32 v159, 0xffffff5c, v158
	v_cmp_gt_i32_e64 s[22:23], s86, v159
	v_add_u32_e32 v159, 0xffffff5d, v158
	v_cmp_gt_i32_e64 s[24:25], s86, v159
	v_add_u32_e32 v159, 0xffffff5e, v158
	v_cmp_gt_i32_e64 s[26:27], s86, v159
	v_add_u32_e32 v159, 0xffffff5f, v158
	v_add_u32_e32 v158, 0xffffff60, v158
	v_cmp_gt_i32_e64 s[28:29], s86, v159
	v_cmp_gt_i32_e64 s[30:31], s86, v158
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
	s_or_b64 s[24:25], s[26:27], s[24:25]
	s_or_b64 s[22:23], s[24:25], s[22:23]
...
.LBB0_45:
	...
	v_add_u32_e32 v159, s87, v159
	v_add_u32_e32 v160, 0xffffff69, v159
	v_cmp_gt_i32_e32 vcc, s86, v160
	v_add_u32_e32 v160, 0xffffff6a, v159
	v_cmp_gt_i32_e64 s[0:1], s86, v160
	v_add_u32_e32 v160, 0xffffff6b, v159
	v_cmp_gt_i32_e64 s[4:5], s86, v160
	v_add_u32_e32 v160, 0xffffff6c, v159
	v_cmp_gt_i32_e64 s[6:7], s86, v160
	v_add_u32_e32 v160, 0xffffff6d, v159
	v_cmp_gt_i32_e64 s[8:9], s86, v160
	v_add_u32_e32 v160, 0xffffff6e, v159
	v_cmp_gt_i32_e64 s[10:11], s86, v160
	v_add_u32_e32 v160, 0xffffff6f, v159
	v_cmp_gt_i32_e64 s[12:13], s86, v160
	v_add_u32_e32 v160, 0xffffff70, v159
	v_cmp_gt_i32_e64 s[14:15], s86, v160
	v_add_u32_e32 v160, 0xffffff79, v159
	v_cmp_gt_i32_e64 s[16:17], s86, v160
	v_add_u32_e32 v160, 0xffffff7a, v159
	v_cmp_gt_i32_e64 s[18:19], s86, v160
	v_add_u32_e32 v160, 0xffffff7b, v159
	v_cmp_gt_i32_e64 s[20:21], s86, v160
	v_add_u32_e32 v160, 0xffffff7c, v159
	v_cmp_gt_i32_e64 s[22:23], s86, v160
	v_add_u32_e32 v160, 0xffffff7d, v159
	v_cmp_gt_i32_e64 s[24:25], s86, v160
	v_add_u32_e32 v160, 0xffffff7e, v159
	v_cmp_gt_i32_e64 s[26:27], s86, v160
	v_add_u32_e32 v160, 0xffffff7f, v159
	v_add_u32_e32 v159, 0xffffff80, v159
	v_cmp_gt_i32_e64 s[28:29], s86, v160
	v_cmp_gt_i32_e64 s[30:31], s86, v159
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
	s_or_b64 s[24:25], s[26:27], s[24:25]
	s_or_b64 s[22:23], s[24:25], s[22:23]
...
.LBB0_47:
	...
	ds_read_b128 v[158:161], v158
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[158:159], v[166:167], v[98:113]
	...
	ds_read_b128 v[158:161], v158
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[158:159], v[170:171], v[98:113]
...
.LBB0_50:
	...
	v_add_u32_e32 v158, 0xffffffa9, v157
	v_cmp_gt_i32_e32 vcc, s86, v158
	v_add_u32_e32 v158, 0xffffffaa, v157
	v_cmp_gt_i32_e64 s[0:1], s86, v158
	v_add_u32_e32 v158, 0xffffffab, v157
	v_cmp_gt_i32_e64 s[4:5], s86, v158
	v_add_u32_e32 v158, 0xffffffac, v157
	v_cmp_gt_i32_e64 s[6:7], s86, v158
	v_add_u32_e32 v158, 0xffffffad, v157
	v_cmp_gt_i32_e64 s[8:9], s86, v158
	v_add_u32_e32 v158, 0xffffffae, v157
	v_cmp_gt_i32_e64 s[10:11], s86, v158
	v_add_u32_e32 v158, 0xffffffaf, v157
	v_cmp_gt_i32_e64 s[12:13], s86, v158
	v_add_u32_e32 v158, 0xffffffb0, v157
	v_cmp_gt_i32_e64 s[14:15], s86, v158
	v_add_u32_e32 v158, 0xffffffb9, v157
	v_cmp_gt_i32_e64 s[16:17], s86, v158
	v_add_u32_e32 v158, 0xffffffba, v157
	v_cmp_gt_i32_e64 s[18:19], s86, v158
	v_add_u32_e32 v158, 0xffffffbb, v157
	v_cmp_gt_i32_e64 s[20:21], s86, v158
	v_add_u32_e32 v158, 0xffffffbc, v157
	v_cmp_gt_i32_e64 s[22:23], s86, v158
	v_add_u32_e32 v158, 0xffffffbd, v157
	v_cmp_gt_i32_e64 s[24:25], s86, v158
	v_add_u32_e32 v158, 0xffffffbe, v157
	v_cmp_gt_i32_e64 s[26:27], s86, v158
	v_add_u32_e32 v158, 0xffffffbf, v157
	v_subrev_u32_e32 v157, 64, v157
...
.LBB0_52:
	...
	v_and_b32_e32 v158, 8, v158
	v_add_u32_e32 v158, s87, v158
	v_subrev_u32_e32 v159, 55, v158
	v_cmp_gt_i32_e32 vcc, s86, v159
	v_subrev_u32_e32 v159, 54, v158
	v_cmp_gt_i32_e64 s[0:1], s86, v159
	v_subrev_u32_e32 v159, 53, v158
	v_cmp_gt_i32_e64 s[4:5], s86, v159
	v_subrev_u32_e32 v159, 52, v158
	v_cmp_gt_i32_e64 s[6:7], s86, v159
	v_subrev_u32_e32 v159, 51, v158
	v_cmp_gt_i32_e64 s[8:9], s86, v159
	v_subrev_u32_e32 v159, 50, v158
	v_cmp_gt_i32_e64 s[10:11], s86, v159
	v_subrev_u32_e32 v159, 49, v158
	v_cmp_gt_i32_e64 s[12:13], s86, v159
	v_subrev_u32_e32 v159, 48, v158
	v_cmp_gt_i32_e64 s[14:15], s86, v159
	v_subrev_u32_e32 v159, 39, v158
	v_cmp_gt_i32_e64 s[16:17], s86, v159
	v_subrev_u32_e32 v159, 38, v158
	v_cmp_gt_i32_e64 s[18:19], s86, v159
	v_subrev_u32_e32 v159, 37, v158
	v_cmp_gt_i32_e64 s[20:21], s86, v159
	v_subrev_u32_e32 v159, 36, v158
	v_cmp_gt_i32_e64 s[22:23], s86, v159
	v_subrev_u32_e32 v159, 35, v158
	v_cmp_gt_i32_e64 s[24:25], s86, v159
	v_subrev_u32_e32 v159, 34, v158
	v_cmp_gt_i32_e64 s[26:27], s86, v159
	v_subrev_u32_e32 v159, 33, v158
	v_subrev_u32_e32 v158, 32, v158
	v_cmp_gt_i32_e64 s[28:29], s86, v159
	v_cmp_gt_i32_e64 s[30:31], s86, v158
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
