...
.LBB0_9:
	...
	v_xor_b32_e32 v149, v2, v3
	v_and_b32_e32 v2, 63, v0
	v_lshlrev_b32_e32 v2, 2, v2
	v_lshlrev_b32_e32 v1, 6, v1
	v_xor_b32_e32 v150, 0x80, v2
	...
	s_movk_i32 s79, 0x2000
	s_mov_b32 s80, 0xaaab
	s_movk_i32 s81, 0xff
	s_mov_b32 s82, s2
...
.LBB0_13:
	...
	global_load_dwordx2 v[2:3], v151, s[4:5]
	s_mul_i32 s47, s75, 0xc0
	s_mov_b32 s43, s39
	v_add_lshl_u32 v7, s47, v117, 1
	v_lshl_add_u32 v6, s75, 2, v1
	s_waitcnt vmcnt(0)
	...
	global_load_dwordx2 v[4:5], v151, s[6:7]
	global_load_dword v3, v151, s[0:1]
	s_addc_u32 s0, s49, s65
	s_mul_i32 s42, s10, 0x1800
	s_and_b32 s41, s0, 0xffff
	buffer_load_dwordx4 v[174:177], v7, s[40:43], 0 offen
	buffer_load_dwordx4 v[178:181], v7, s[40:43], 0 offen offset:32
	buffer_load_dwordx4 v[182:185], v7, s[40:43], 0 offen offset:64
	buffer_load_dwordx4 v[186:189], v7, s[40:43], 0 offen offset:96
	buffer_load_dwordx4 v[190:193], v7, s[40:43], 0 offen offset:128
	buffer_load_dwordx4 v[194:197], v7, s[40:43], 0 offen offset:160
	buffer_load_dwordx4 v[198:201], v7, s[40:43], 0 offen offset:192
	buffer_load_dwordx4 v[202:205], v7, s[40:43], 0 offen offset:224
	buffer_load_dwordx4 v[206:209], v7, s[40:43], 0 offen offset:256
	buffer_load_dwordx4 v[210:213], v7, s[40:43], 0 offen offset:288
	s_ashr_i32 s9, s8, 31
	...
	buffer_load_dwordx4 v[214:217], v7, s[40:43], 0 offen offset:320
	buffer_load_dwordx4 v[218:221], v7, s[40:43], 0 offen offset:352
	s_waitcnt vmcnt(14)
...
.LBB0_19:
	...
	ds_write_b128 v149, v[162:165] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[0:1]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_25:
	...
	;;#ASMSTART
	v_perm_b32 v100, v99, v98, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v132, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v105, v104, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v107, v106, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v109, v108, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v111, v110, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v113, v112, s77
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
	...
	v_add_co_u32_e32 v100, vcc, s78, v106
	s_nop 1
...
.LBB0_26:
	...
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s83, v98
	s_and_saveexec_b64 s[4:5], vcc
	s_cbranch_execz .LBB0_28
	ds_write_b128 v149, v[166:169] offset:12288
	ds_write_b128 v149, v[170:173] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v98, v0
...
.LBB0_47:
	...
	v_cndmask_b32_e64 v139, v154, v99, s[0:1]
	v_cndmask_b32_e32 v138, v154, v98, vcc
	...
	v_cndmask_b32_e64 v133, v154, v105, s[14:15]
	v_cndmask_b32_e64 v132, v154, v104, s[12:13]
	v_cndmask_b32_e64 v137, v154, v101, s[6:7]
	v_cndmask_b32_e64 v136, v154, v100, s[4:5]
	...
	v_cndmask_b32_e64 v135, v154, v103, s[10:11]
	v_cndmask_b32_e64 v134, v154, v102, s[8:9]
...
.LBB0_49:
	...
	;;#ASMSTART
	v_perm_b32 v100, v100, v109, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v108, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v102, v107, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v103, v106, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v105, v104, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v134, v135, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v98, v133, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v99, v132, s77
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
...
.LBB0_54:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v133, v133, v133
	v_max_f32_e32 v157, v132, v133
	;;#ASMSTART
	v_add_f32 v132, v116, v152
	;;#ASMEND
	v_mov_b32_e32 v133, v116
	v_cmp_gt_f32_e32 vcc, v157, v132
	v_mov_b32_e32 v132, v116
	v_mov_b32_e32 v138, v116
	v_mov_b32_e32 v139, v116
	v_mov_b32_e32 v140, v116
	...
	;;#ASMSTART
	v_add_f32 v132, v157, v153
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v116, v116, v132
	v_exp_f32_e32 v156, v116
	v_mov_b32_e32 v116, v132
	v_mov_b32_e32 v133, v132
	v_mov_b32_e32 v134, v132
	v_mov_b32_e32 v135, v132
...
.LBB0_57:
	...
	;;#ASMSTART
	v_perm_b32 v48, v3, v2, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v49, v5, v4, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v46, v7, v6, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v47, v9, v8, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v44, v11, v10, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v45, v13, v12, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v42, v15, v14, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v43, v17, v16, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v40, v19, v18, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v41, v21, v20, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v38, v23, v22, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v39, v25, v24, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v36, v27, v26, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v37, v29, v28, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v34, v31, v30, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v35, v33, v32, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v112, v113, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v110, v111, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v108, v109, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v106, v107, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v28, v104, v105, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v102, v103, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v100, v101, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v98, v99, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v51, v50, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v53, v52, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v55, v54, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v57, v56, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v59, v58, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v61, v60, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v63, v62, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v65, v64, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v67, v66, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v69, v68, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v71, v70, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v73, v72, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v75, v74, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v77, v76, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v79, v78, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v81, v80, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v83, v82, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v85, v84, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v87, v86, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v89, v88, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v91, v90, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v93, v92, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v95, v94, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v97, v96, s77
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v50, v0
	;;#ASMEND
...
.LBB0_61:
	...
	s_barrier
.LBB0_62:
	v_mul_u32_u24_sdwa v95, v94, s80 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
.LBB0_89:
	...
	s_barrier
.LBB0_90:
	v_mul_u32_u24_sdwa v2, v88, s80 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v151, v3, s[62:63] sc0
.LBB0_94:
	...
	global_store_dword v151, v2, s[6:7]
	s_waitcnt vmcnt(0)
.LBB0_95:
	s_or_b64 exec, exec, s[4:5]
	s_lshl_b64 s[0:1], s[0:1], 2
	...
	s_barrier
	global_load_dword v2, v151, s[0:1]
	s_waitcnt vmcnt(0)
	s_barrier
	v_readfirstlane_b32 s4, v2
	s_add_i32 s0, s4, s33
...
.LBB0_98:
	...
	global_load_dwordx2 v[2:3], v151, s[6:7] offset:4
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s6, v3
