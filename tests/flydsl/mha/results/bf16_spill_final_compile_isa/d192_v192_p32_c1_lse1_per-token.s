...
.LBB0_13:
	...
	global_load_dwordx2 v[4:5], v152, s[8:9]
...
.LBB0_15:
	...
	s_mul_i32 s47, s68, 0xc00
	v_add_u32_e32 v4, s47, v149
...
.LBB0_19:
	...
	ds_write_b128 v150, v[162:165]
	ds_write_b128 v150, v[166:169] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[8:9]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_25:
	...
	;;#ASMSTART
	v_perm_b32 v100, v99, v98, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v132, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v105, v104, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v107, v106, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v109, v108, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v111, v110, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v113, v112, s55
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
	...
	v_add_co_u32_e32 v100, vcc, s56, v106
	s_nop 1
...
.LBB0_26:
	...
	s_mov_b32 s71, s65
	v_cmp_ne_u32_e32 vcc, s54, v99
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s62, v98
	s_and_saveexec_b64 s[46:47], vcc
	s_cbranch_execz .LBB0_28
	ds_write_b128 v150, v[170:173] offset:12288
	ds_write_b128 v150, v[174:177] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[46:47]
	;;#ASMSTART
	v_mov_b32 v98, v0
	...
	v_cmp_ne_u32_e32 vcc, s54, v98
	s_and_saveexec_b64 s[46:47], vcc
	s_cbranch_execz .LBB0_30
	s_mul_i32 s65, s71, 0xc00
...
.LBB0_30:
	...
	v_mfma_f32_32x32x8_bf16 v[98:113], v[136:137], v[224:225], v[98:113]
	s_waitcnt vmcnt(2) lgkmcnt(0)
	s_barrier
	s_setprio 0
	s_nop 7
...
.LBB0_32:
	...
	global_load_dwordx4 v[158:161], v[106:107], off offset:2048
...
.LBB0_34:
	...
	s_mul_i32 s68, s62, 0xc00
	v_add_u32_e32 v98, s68, v149
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[0:1]
...
.LBB0_36:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v133, v133, v133
	v_max_f32_e32 v159, v116, v133
	;;#ASMSTART
	v_add_f32 v116, v132, v153
	;;#ASMEND
	v_mov_b32_e32 v133, v132
	v_cmp_gt_f32_e32 vcc, v159, v116
	...
	;;#ASMSTART
	v_add_f32 v116, v159, v154
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v132, v132, v116
	v_exp_f32_e32 v158, v132
	v_mov_b32_e32 v132, v116
...
.LBB0_43:
	...
	s_cselect_b32 s68, s62, s64
	s_cselect_b32 s64, s65, s62
	s_cselect_b32 s62, s69, s65
	s_add_u32 s8, s8, 2
	s_addc_u32 s9, s9, 0
...
.LBB0_46:
	...
	s_mul_i32 s48, s65, 0xc00
	v_add_u32_e32 v98, s48, v149
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[0:1]
	global_load_dwordx4 v[170:173], v[98:99], off
	global_load_dwordx4 v[174:177], v[98:99], off offset:256
.LBB0_48:
	...
	v_and_or_b32 v132, v132, s53, v158
	v_add_u32_e32 v141, s66, v133
	v_add_u32_e32 v140, s63, v132
...
.LBB0_50:
	...
	;;#ASMSTART
	v_perm_b32 v100, v100, v109, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v108, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v102, v107, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v103, v106, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v105, v104, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v134, v135, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v98, v133, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v99, v132, s55
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
...
.LBB0_60:
	...
	;;#ASMSTART
	v_perm_b32 v48, v3, v2, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v49, v5, v4, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v46, v7, v6, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v47, v9, v8, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v44, v11, v10, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v45, v13, v12, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v42, v15, v14, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v43, v17, v16, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v40, v19, v18, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v41, v21, v20, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v38, v23, v22, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v39, v25, v24, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v36, v27, v26, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v37, v29, v28, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v34, v31, v30, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v35, v33, v32, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v112, v113, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v110, v111, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v108, v109, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v106, v107, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v28, v104, v105, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v102, v103, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v100, v101, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v98, v99, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v51, v50, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v53, v52, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v55, v54, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v57, v56, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v59, v58, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v61, v60, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v63, v62, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v65, v64, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v67, v66, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v69, v68, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v71, v70, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v73, v72, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v75, v74, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v77, v76, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v79, v78, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v81, v80, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v83, v82, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v85, v84, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v87, v86, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v89, v88, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v91, v90, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v93, v92, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v95, v94, s55
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v97, v96, s55
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v50, v0
	;;#ASMEND
...
.LBB0_64:
	...
	s_barrier
.LBB0_65:
	v_mul_u32_u24_sdwa v95, v94, s59 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
.LBB0_92:
	...
	s_barrier
.LBB0_93:
	v_mul_u32_u24_sdwa v2, v88, s59 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	...
	v_mov_b32_e32 v3, s6
	global_atomic_add v3, v152, v3, s[38:39] sc0
.LBB0_97:
	s_or_b64 exec, exec, s[8:9]
	...
	global_store_dword v152, v2, s[8:9]
	s_waitcnt vmcnt(0)
.LBB0_98:
...
.LBB0_101:
	...
	global_load_dwordx2 v[2:3], v152, s[8:9] offset:4
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s6, v3
