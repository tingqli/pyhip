...
.LBB0_19:
	...
	ds_write_b128 v149, v[160:163]
	ds_write_b128 v149, v[164:167] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[0:1]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_26:
	...
	ds_write_b128 v149, v[168:171] offset:12288
	ds_write_b128 v149, v[172:175] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v98, v0
...
.LBB0_49:
	...
	;;#ASMSTART
	v_perm_b32 v100, v100, v109, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v108, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v102, v107, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v103, v106, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v105, v104, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v134, v135, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v98, v133, s83
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v99, v132, s83
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
...
.LBB0_92:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v151, v3, s[66:67] sc0
.LBB0_96:
