...
.LBB0_13:
	...
	s_add_i32 s4, s76, 0x100
	s_min_i32 s4, s4, s5
	s_sub_i32 s77, s4, s76
	s_add_u32 s4, s52, s0
	s_addc_u32 s5, s53, s1
	s_add_u32 s0, s46, s0
	s_addc_u32 s1, s47, s1
	s_lshl_b32 s8, s76, 11
	s_ashr_i32 s9, s8, 31
	s_lshl_b32 s6, s76, 4
...
.LBB0_15:
	...
	v_and_or_b32 v3, v3, s90, v4
	v_and_b32_e32 v2, 48, v2
	v_or_b32_e32 v4, v3, v2
	v_lshlrev_b32_e32 v4, 1, v4
	ds_read_b128 v[184:187], v4
...
.LBB0_17:
	...
	;;#ASMSTART
	v_perm_b32 v66, v67, v66, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v67, v69, v68, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v68, v71, v70, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v69, v73, v72, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v70, v75, v74, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v71, v77, v76, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v72, v79, v78, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v73, v81, v80, s92
	;;#ASMEND
	s_barrier
	s_setprio 1
	s_waitcnt vmcnt(7)
...
.LBB0_18:
	ds_write_b128 v117, v[160:163] offset:8192
	s_waitcnt lgkmcnt(8)
	...
	global_load_dwordx4 v[160:163], v[114:115], off
	;;#ASMSTART
	v_mov_b32 v101, v0
	;;#ASMEND
	s_nop 0
	...
	v_add_co_u32_e32 v102, vcc, s91, v102
	s_nop 1
...
.LBB0_20:
	...
	global_load_dwordx4 v[184:187], v[102:103], off offset:1024
	s_waitcnt lgkmcnt(4)
...
.LBB0_26:
	...
	s_cselect_b32 s6, s93, s95
	s_cselect_b32 s95, s94, s93
	s_cselect_b32 s93, s43, s94
	s_add_u32 s82, s82, 2
...
.LBB0_27:
	...
	v_lshl_or_b32 v100, s94, 11, v116
	v_ashrrev_i32_e32 v101, 31, v100
	v_lshl_add_u64 v[100:101], v[100:101], 2, s[80:81]
	s_waitcnt vmcnt(0)
	...
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[102:103], v[136:137], v[66:81]
	global_load_dwordx4 v[160:163], v[100:101], off
	;;#ASMSTART
	v_mov_b32 v100, v0
	;;#ASMEND
	s_nop 0
	...
	global_load_dwordx4 v[188:191], v[100:101], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[104:105], v[138:139], v[66:81]
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[110:111], v[140:141], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[112:113], v[142:143], v[66:81]
	global_load_dwordx4 v[192:195], v[100:101], off offset:512
	global_load_dwordx4 v[180:183], v[100:101], off offset:1024
	s_waitcnt lgkmcnt(4)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[168:169], v[144:145], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[170:171], v[146:147], v[66:81]
	s_waitcnt lgkmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[172:173], v[148:149], v[66:81]
	global_load_dwordx4 v[184:187], v[100:101], off offset:1536
	v_add_co_u32_e32 v100, vcc, s91, v100
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v101, vcc
	global_load_dwordx4 v[168:171], v[100:101], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[174:175], v[150:151], v[66:81]
	s_waitcnt lgkmcnt(2)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[176:177], v[152:153], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[178:179], v[154:155], v[66:81]
	global_load_dwordx4 v[172:175], v[100:101], off offset:512
...
.LBB0_29:
	...
	;;#ASMSTART
	v_perm_b32 v66, v66, v75, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v67, v67, v74, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v68, v68, v73, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v69, v69, v72, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v70, v71, v70, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v71, v106, v107, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v72, v100, v101, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v73, v81, v80, s92
	;;#ASMEND
	...
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[102:103], v[136:137], v[66:81]
	global_load_dwordx4 v[164:167], v[100:101], off
	;;#ASMSTART
	v_mov_b32 v100, v0
	;;#ASMEND
	s_nop 0
	...
	v_ashrrev_i32_e32 v101, 31, v100
	v_lshl_add_u64 v[100:101], v[100:101], 1, s[84:85]
	global_load_dwordx4 v[192:195], v[100:101], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[104:105], v[138:139], v[66:81]
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[110:111], v[140:141], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[112:113], v[142:143], v[66:81]
	global_load_dwordx4 v[196:199], v[100:101], off offset:512
	global_load_dwordx4 v[184:187], v[100:101], off offset:1024
	s_waitcnt lgkmcnt(4)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[168:169], v[144:145], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[170:171], v[146:147], v[66:81]
	s_waitcnt lgkmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[172:173], v[148:149], v[66:81]
	global_load_dwordx4 v[188:191], v[100:101], off offset:1536
	v_add_co_u32_e32 v100, vcc, s91, v100
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v101, vcc
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[176:177], v[152:153], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[178:179], v[154:155], v[66:81]
	global_load_dwordx4 v[176:179], v[100:101], off offset:512
	global_load_dwordx4 v[172:175], v[100:101], off offset:1024
	global_load_dwordx4 v[168:171], v[100:101], off offset:1536
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[106:107], v[156:157], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[108:109], v[158:159], v[66:81]
	s_waitcnt vmcnt(9) lgkmcnt(0)
	...
	;;#ASMSTART
	v_add_f32 v80, v126, v121
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v81, v84, v80
	v_exp_f32_e32 v125, v81
...
.LBB0_33:
	...
	v_cmp_gt_i32_e64 s[0:1], s77, v67
	...
	s_lshl_b64 s[4:5], s[76:77], 6
	v_cndmask_b32_e64 v69, 0, 32, vcc
	v_ldexp_f32 v69, v66, v69
	v_log_f32_e32 v69, v69
	v_cndmask_b32_e32 v68, 0, v123, vcc
	v_readlane_b32 s6, v127, 0
	v_readlane_b32 s7, v127, 1
	...
	s_add_u32 s4, s6, s4
	s_addc_u32 s5, s7, s5
	v_cndmask_b32_e32 v68, v122, v68, vcc
...
.LBB0_35:
	...
	;;#ASMSTART
	v_perm_b32 v28, v3, v2, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v5, v4, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v7, v6, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v9, v8, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v11, v10, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v13, v12, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v15, v14, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v17, v16, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v19, v18, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v21, v20, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v23, v22, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v74, v75, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v72, v73, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v70, v71, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v68, v69, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v66, v67, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v35, v34, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v37, v36, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v39, v38, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v41, v40, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v43, v42, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v45, v44, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v47, v46, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v49, v48, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v51, v50, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v53, v52, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v55, v54, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v57, v56, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v59, v58, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v61, v60, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v63, v62, s92
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v65, v64, s92
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v34, v0
	;;#ASMEND
...
.LBB0_53:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v119, v3, s[98:99] sc0
.LBB0_56:
