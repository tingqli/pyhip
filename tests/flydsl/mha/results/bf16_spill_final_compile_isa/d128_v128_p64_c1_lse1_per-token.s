...
.LBB0_22:
	...
	buffer_load_dword v125, v125, s[4:7], 0 offen
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s87, v125
	s_waitcnt lgkmcnt(7)
	...
	global_load_dwordx4 v[198:201], v[128:129], off offset:512
	global_load_dwordx4 v[186:189], v[128:129], off offset:1024
	s_waitcnt lgkmcnt(4)
	...
	global_load_dwordx4 v[178:181], v[128:129], off
	...
	global_load_dwordx4 v[182:185], v[128:129], off offset:512
	global_load_dwordx4 v[174:177], v[128:129], off offset:1024
	...
	ds_bpermute_b32 v127, v120, v125
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v127, v127, v127
	v_max_f32_e32 v128, v125, v127
	;;#ASMSTART
	v_add_f32 v125, v86, v121
	;;#ASMEND
	v_mov_b32_e32 v127, 1.0
	v_cmp_gt_f32_e32 vcc, v128, v125
	v_mov_b32_e32 v125, 1.0
	s_and_saveexec_b64 s[40:41], vcc
...
.LBB0_32:
	...
	v_and_or_b32 v102, v102, s81, v125
	v_add_u32_e32 v176, s37, v103
	v_add_u32_e32 v127, s11, v102
	v_add_u32_e32 v102, 0xffffff89, v176
	v_cmp_lt_i32_e32 vcc, v102, v127
	s_nop 1
	v_cndmask_b32_e32 v103, v123, v67, vcc
	v_cmp_le_i32_e32 vcc, v102, v127
	v_add_u32_e32 v67, 0xffffffa0, v176
	s_nop 0
	v_cndmask_b32_e32 v102, v123, v66, vcc
	v_add_u32_e32 v66, 0xffffff8b, v176
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff8c, v176
	s_nop 0
	v_cndmask_b32_e32 v116, v123, v68, vcc
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff8d, v176
	s_nop 0
	v_cndmask_b32_e32 v117, v123, v69, vcc
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff8e, v176
	s_nop 0
	v_cndmask_b32_e32 v128, v123, v70, vcc
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff8f, v176
	s_nop 0
	v_cndmask_b32_e32 v129, v123, v71, vcc
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff90, v176
	s_nop 0
	v_cndmask_b32_e32 v174, v123, v72, vcc
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff99, v176
	s_nop 0
	v_cndmask_b32_e32 v175, v123, v73, vcc
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff9a, v176
	s_nop 0
	v_cndmask_b32_e32 v72, v123, v74, vcc
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff9b, v176
	s_nop 0
	v_cndmask_b32_e32 v73, v123, v75, vcc
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff9c, v176
	v_pk_mul_f32 v[74:75], v[92:93], v[174:175]
	v_cndmask_b32_e32 v70, v123, v76, vcc
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff9d, v176
	v_pk_mul_f32 v[72:73], v[94:95], v[72:73]
	v_cndmask_b32_e32 v71, v123, v77, vcc
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff9e, v176
	v_pk_mul_f32 v[76:77], v[90:91], v[128:129]
	v_cndmask_b32_e32 v68, v123, v78, vcc
	v_cmp_le_i32_e32 vcc, v66, v127
	v_add_u32_e32 v66, 0xffffff9f, v176
...
.LBB0_36:
	...
	v_lshl_add_u64 v[128:129], s[42:43], 0, v[82:83]
	v_lshl_add_u64 v[128:129], v[128:129], 2, s[8:9]
	...
	s_waitcnt lgkmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[186:187], v[150:151], v[66:81]
	global_load_dwordx4 v[198:201], v[128:129], off offset:1536
	v_add_co_u32_e32 v128, vcc, s83, v128
	s_nop 1
	v_addc_co_u32_e32 v129, vcc, 0, v129, vcc
	global_load_dwordx4 v[182:185], v[128:129], off
	...
	v_and_or_b32 v127, v127, s81, v125
...
.LBB0_39:
	...
	v_and_or_b32 v128, v128, s81, v125
	v_add_u32_e32 v129, s37, v129
	v_add_u32_e32 v128, s11, v128
	v_subrev_u32_e32 v202, 23, v129
	v_cmp_lt_i32_e32 vcc, v202, v128
	s_nop 1
	v_cndmask_b32_e32 v67, v123, v67, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_subrev_u32_e32 v202, 21, v129
	s_nop 0
	v_cndmask_b32_e32 v66, v123, v66, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_subrev_u32_e32 v202, 20, v129
	v_pk_mul_f32 v[66:67], v[84:85], v[66:67]
	v_cndmask_b32_e32 v68, v123, v68, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_subrev_u32_e32 v202, 19, v129
	s_nop 0
	v_cndmask_b32_e32 v69, v123, v69, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_subrev_u32_e32 v202, 18, v129
	v_pk_mul_f32 v[68:69], v[88:89], v[68:69]
	v_cndmask_b32_e32 v70, v123, v70, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_subrev_u32_e32 v202, 17, v129
	s_nop 0
	v_cndmask_b32_e32 v71, v123, v71, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_add_u32_e32 v202, -16, v129
	v_pk_mul_f32 v[70:71], v[90:91], v[70:71]
	v_cndmask_b32_e32 v72, v123, v72, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_add_u32_e32 v202, -7, v129
	s_nop 0
	v_cndmask_b32_e32 v73, v123, v73, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_add_u32_e32 v202, -6, v129
	v_pk_mul_f32 v[72:73], v[92:93], v[72:73]
	v_cndmask_b32_e32 v74, v123, v74, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_add_u32_e32 v202, -5, v129
	s_nop 0
	v_cndmask_b32_e32 v75, v123, v75, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_add_u32_e32 v202, -4, v129
	v_pk_mul_f32 v[74:75], v[94:95], v[74:75]
	v_cndmask_b32_e32 v76, v123, v76, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_add_u32_e32 v202, -3, v129
	s_nop 0
	v_cndmask_b32_e32 v77, v123, v77, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_add_u32_e32 v202, -2, v129
	v_pk_mul_f32 v[76:77], v[96:97], v[76:77]
	v_cndmask_b32_e32 v78, v123, v78, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_add_u32_e32 v202, -1, v129
	s_nop 0
	v_cndmask_b32_e32 v79, v123, v79, vcc
	v_cmp_le_i32_e32 vcc, v202, v128
	v_pk_mul_f32 v[78:79], v[98:99], v[78:79]
