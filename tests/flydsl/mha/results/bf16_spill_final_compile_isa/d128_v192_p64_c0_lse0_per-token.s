...
.LBB0_13:
	...
	s_add_u32 s4, s54, s0
	buffer_load_dwordx4 v[160:163], v7, s[36:39], 0 offen
	buffer_load_dwordx4 v[164:167], v7, s[36:39], 0 offen offset:32
	buffer_load_dwordx4 v[168:171], v7, s[36:39], 0 offen offset:64
	buffer_load_dwordx4 v[172:175], v7, s[36:39], 0 offen offset:96
	buffer_load_dwordx4 v[176:179], v7, s[36:39], 0 offen offset:128
	buffer_load_dwordx4 v[180:183], v7, s[36:39], 0 offen offset:160
	s_addc_u32 s0, s55, s1
	s_lshl_b32 s6, s43, 6
	s_and_b32 s5, s0, 0xffff
	buffer_load_dword v2, v6, s[4:7], 0 offen
	buffer_load_dwordx4 v[184:187], v7, s[36:39], 0 offen offset:192
	buffer_load_dwordx4 v[188:191], v7, s[36:39], 0 offen offset:224
	s_waitcnt vmcnt(10)
...
.LBB0_18:
	...
	global_load_dwordx4 v[204:207], v[98:99], off offset:512
	ds_write_b128 v150, v[192:195]
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_mov_b32 s11, s83
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[138:139], v[160:161], 0
	s_mov_b32 s12, s85
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s83, v134
	v_mfma_f32_32x32x8_bf16 v[98:113], v[140:141], v[162:163], v[98:113]
...
.LBB0_20:
	...
	ds_write_b128 v150, v[196:199] offset:8192
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_nop 0
...
.LBB0_22:
	...
	v_mfma_f32_32x32x8_bf16 v[2:17], v[108:109], v[100:101], v[2:17]
	s_waitcnt vmcnt(4)
	v_mfma_f32_32x32x8_bf16 v[18:33], v[156:157], v[100:101], v[18:33]
	s_waitcnt vmcnt(3)
	...
	v_mfma_f32_32x32x8_bf16 v[2:17], v[110:111], v[102:103], v[2:17]
	global_load_dwordx4 v[108:111], v[100:101], off offset:2048
	v_mfma_f32_32x32x8_bf16 v[18:33], v[158:159], v[102:103], v[18:33]
	global_load_dwordx4 v[156:159], v[100:101], off offset:2560
	...
	v_or_b32_e32 v156, 0x1070, v158
	v_lshrrev_b32_e32 v157, 3, v156
	v_and_b32_e32 v157, 56, v157
	v_xor_b32_e32 v156, v157, v156
	v_lshlrev_b32_e32 v156, 1, v156
	ds_read_b128 v[156:159], v156
	s_waitcnt lgkmcnt(0)
	...
	v_max_f32_e32 v158, v156, v157
	;;#ASMSTART
	v_add_f32 v156, v118, v152
	;;#ASMEND
	v_mov_b32_e32 v157, 1.0
	v_cmp_gt_f32_e32 vcc, v158, v156
	v_mov_b32_e32 v156, 1.0
	s_and_saveexec_b64 s[4:5], vcc
	s_cbranch_execz .LBB0_24
	;;#ASMSTART
	v_add_f32 v134, v158, v153
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v118, v118, v134
...
.LBB0_24:
	...
	ds_write_b128 v150, v[200:203] offset:8192
	;;#ASMSTART
	v_mov_b32 v98, v0
	;;#ASMEND
	s_nop 0
	...
	v_lshlrev_b32_e32 v98, 1, v98
	ds_read_b128 v[200:203], v98
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[200:201], v[160:161], 0
...
.LBB0_35:
	...
	global_load_dwordx4 v[204:207], v[106:107], off offset:1536
	global_load_dwordx4 v[208:211], v[106:107], off offset:2048
	global_load_dwordx4 v[212:215], v[106:107], off offset:2560
	s_waitcnt vmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[2:17], v[108:109], v[100:101], v[2:17]
	...
	global_load_dwordx4 v[204:207], v[100:101], off offset:3584
	v_add_co_u32_e32 v100, vcc, s77, v106
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v107, vcc
	v_mfma_f32_32x32x8_bf16 v[66:81], v[210:211], v[102:103], v[66:81]
	...
	v_mfma_f32_32x32x8_bf16 v[50:65], v[204:205], v[104:105], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[110:111], v[98:99], v[2:17]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[106:107], v[104:105], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[82:97], v[100:101], v[104:105], v[82:97]
	v_mfma_f32_32x32x8_bf16 v[18:33], v[158:159], v[98:99], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[202:203], v[98:99], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[206:207], v[98:99], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[108:109], v[98:99], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[82:97], v[102:103], v[98:99], v[82:97]
