...
.LBB0_19:
	...
	ds_write_b128 v117, v[132:135] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[0:1]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_25:
	...
	v_add_co_u32_e32 v66, vcc, s82, v74
	s_nop 1
...
.LBB0_26:
	...
	ds_write_b128 v117, v[136:139] offset:12288
	ds_write_b128 v117, v[140:143] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v66, v0
...
.LBB0_30:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[104:105], v[158:159], v[66:81]
	s_waitcnt lgkmcnt(7)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[106:107], v[160:161], v[66:81]
...
.LBB0_47:
	...
	v_cndmask_b32_e64 v105, v122, v67, s[0:1]
	v_cndmask_b32_e32 v104, v122, v66, vcc
	...
	v_cndmask_b32_e64 v103, v122, v69, s[6:7]
	v_cndmask_b32_e64 v102, v122, v68, s[4:5]
