...
.LBB0_32:
	...
	;;#ASMEND
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s60, v115
	v_lshrrev_b32_e32 v100, 2, v98
	v_lshlrev_b32_e32 v99, 7, v98
	v_lshlrev_b32_e32 v98, 4, v98
	v_and_b32_e32 v100, 8, v100
	v_and_b32_e32 v120, 48, v98
	v_and_or_b32 v121, v99, s44, v100
	...
	v_and_or_b32 v115, v115, s48, v137
	v_add_u32_e32 v122, s58, v120
	v_add_u32_e32 v115, s55, v115
...
.LBB0_75:
	...
	global_atomic_add v3, v141, v3, s[28:29] sc0
.LBB0_79:
	...
	global_store_dword v141, v2, s[30:31]
	s_waitcnt vmcnt(0)
.LBB0_80:
