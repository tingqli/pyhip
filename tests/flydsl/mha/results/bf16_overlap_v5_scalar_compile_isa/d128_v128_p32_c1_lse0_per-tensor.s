...
.LBB0_18:
	...
	v_add_co_u32_e32 v94, vcc, s74, v102
...
.LBB0_22:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v84, v84, v84
	v_max_f32_e32 v127, v83, v84
	;;#ASMSTART
	v_add_f32 v83, v88, v123
	;;#ASMEND
	v_mov_b32_e32 v84, v88
	v_cmp_gt_f32_e32 vcc, v127, v83
	v_mov_b32_e32 v83, 1.0
...
.LBB0_32:
	...
	s_add_i32 s40, s44, -4
	v_mov_b32_e32 v83, s40
	v_lshl_or_b32 v88, s81, 11, v104
	v_ashrrev_i32_e32 v89, 31, v88
	v_lshl_add_u64 v[88:89], v[88:89], 2, s[16:17]
	s_add_i32 s40, s83, s19
	s_lshl_b32 s40, s40, 12
	v_mfma_f32_32x32x8_bf16 v[66:81], v[188:189], v[132:133], v[66:81]
	buffer_load_dword v83, v83, s[12:15], 0 offen
	s_waitcnt vmcnt(0)
	...
	v_and_or_b32 v83, v83, s76, v127
	v_add_u32_e32 v90, s37, v88
	v_add_u32_e32 v83, s80, v83
...
.LBB0_42:
	...
	;;#ASMEND
	s_nop 0
	v_div_scale_f32 v67, s[12:13], v66, v66, s72
...
.LBB0_60:
	...
	global_atomic_add v3, v122, v3, s[34:35] sc0
.LBB0_63:
	s_or_b64 exec, exec, s[16:17]
