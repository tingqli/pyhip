...
.LBB0_22:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v124, v124, v124
	v_max_f32_e32 v146, v119, v124
	;;#ASMSTART
	v_add_f32 v119, v116, v141
	;;#ASMEND
	v_mov_b32_e32 v124, v116
	v_cmp_gt_f32_e32 vcc, v146, v119
	v_mov_b32_e32 v119, 1.0
...
.LBB0_26:
	...
	v_or_b32_e32 v119, 0x1010, v147
	v_xor_b32_e32 v119, v119, v146
	v_lshlrev_b32_e32 v119, 1, v119
	ds_read_b128 v[184:187], v119
	s_waitcnt lgkmcnt(0)
	...
	v_or_b32_e32 v119, 0x1040, v147
	v_lshrrev_b32_e32 v146, 3, v119
	v_and_b32_e32 v146, 56, v146
	v_xor_b32_e32 v119, v146, v119
	v_lshlrev_b32_e32 v119, 1, v119
	ds_read_b128 v[184:187], v119
	s_waitcnt lgkmcnt(0)
	...
	v_max3_f32 v119, v119, v110, v111
	v_max3_f32 v119, v119, v112, v113
	ds_bpermute_b32 v146, v140, v119
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v146, v146, v146
	v_max_f32_e32 v146, v119, v146
	;;#ASMSTART
	v_add_f32 v119, v116, v141
	;;#ASMEND
	s_nop 0
...
.LBB0_39:
	...
	v_pk_mul_f32 v[104:105], v[118:119], v[104:105]
	v_pk_mul_f32 v[102:103], v[118:119], v[102:103]
	v_max_f32_e32 v119, v100, v101
	v_max3_f32 v119, v119, v98, v99
	v_max3_f32 v119, v119, v102, v103
	v_max3_f32 v119, v119, v104, v105
	v_max3_f32 v119, v119, v106, v107
	v_max3_f32 v119, v119, v108, v109
	...
	v_max_f32_e32 v122, v119, v122
	;;#ASMSTART
	v_add_f32 v119, v116, v141
	;;#ASMEND
	s_nop 0
	v_cmp_gt_f32_e32 vcc, v122, v119
	v_mov_b32_e32 v119, 1.0
	s_and_saveexec_b64 s[0:1], vcc
	s_cbranch_execz .LBB0_41
	;;#ASMSTART
	v_add_f32 v122, v122, v142
	;;#ASMEND
	s_nop 0
...
.LBB0_41:
	s_or_b64 exec, exec, s[0:1]
	v_pk_add_f32 v[122:123], v[98:99], v[116:117] op_sel_hi:[1,0] neg_lo:[0,1] neg_hi:[0,1]
...
.LBB0_43:
	...
	v_and_b32_e32 v119, 8, v119
	v_add_u32_e32 v119, s92, v119
	v_add_u32_e32 v122, 0xffffffa9, v119
	v_cmp_gt_i32_e32 vcc, s91, v122
	v_add_u32_e32 v122, 0xffffffaa, v119
	v_cmp_gt_i32_e64 s[0:1], s91, v122
	v_add_u32_e32 v122, 0xffffffab, v119
	v_cmp_gt_i32_e64 s[4:5], s91, v122
	v_add_u32_e32 v122, 0xffffffac, v119
	v_cmp_gt_i32_e64 s[6:7], s91, v122
	v_add_u32_e32 v122, 0xffffffad, v119
	v_cmp_gt_i32_e64 s[8:9], s91, v122
	v_add_u32_e32 v122, 0xffffffae, v119
	v_cmp_gt_i32_e64 s[10:11], s91, v122
	v_add_u32_e32 v122, 0xffffffaf, v119
	v_cmp_gt_i32_e64 s[12:13], s91, v122
	v_add_u32_e32 v122, 0xffffffb0, v119
	v_cmp_gt_i32_e64 s[14:15], s91, v122
	v_add_u32_e32 v122, 0xffffffb9, v119
	v_cmp_gt_i32_e64 s[16:17], s91, v122
	v_add_u32_e32 v122, 0xffffffba, v119
	v_cmp_gt_i32_e64 s[18:19], s91, v122
	v_add_u32_e32 v122, 0xffffffbb, v119
	v_cmp_gt_i32_e64 s[20:21], s91, v122
	v_add_u32_e32 v122, 0xffffffbc, v119
	v_cmp_gt_i32_e64 s[22:23], s91, v122
	v_add_u32_e32 v122, 0xffffffbd, v119
	v_cmp_gt_i32_e64 s[24:25], s91, v122
	v_add_u32_e32 v122, 0xffffffbe, v119
	v_cmp_gt_i32_e64 s[26:27], s91, v122
	v_add_u32_e32 v122, 0xffffffbf, v119
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v122, v122, v122
	v_max_f32_e32 v139, v119, v122
	;;#ASMSTART
	v_add_f32 v119, v116, v141
	;;#ASMEND
	v_mov_b32_e32 v122, v116
	v_cmp_gt_f32_e32 vcc, v139, v119
	v_mov_b32_e32 v119, 1.0
	v_mov_b32_e32 v128, v116
	v_mov_b32_e32 v129, v116
	v_mov_b32_e32 v130, v116
...
.LBB0_47:
	...
	v_max3_f32 v119, v119, v110, v111
	v_max3_f32 v119, v119, v112, v113
	ds_bpermute_b32 v139, v140, v119
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v139, v139, v139
	v_max_f32_e32 v139, v119, v139
	;;#ASMSTART
	v_add_f32 v119, v116, v141
	;;#ASMEND
	s_nop 0
...
.LBB0_52:
	...
	v_mfma_f32_32x32x8_bf16 v[98:113], v[188:189], v[156:157], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[190:191], v[158:159], v[98:113]
	v_or_b32_e32 v145, 48, v119
	v_xor_b32_e32 v139, v145, v139
	v_lshlrev_b32_e32 v139, 1, v139
	ds_read_b128 v[188:191], v139
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[188:189], v[160:161], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[190:191], v[162:163], v[98:113]
	v_or_b32_e32 v139, 64, v119
	v_lshrrev_b32_e32 v145, 3, v139
	...
	v_and_b32_e32 v119, 8, v119
	v_add_u32_e32 v119, s92, v119
	v_subrev_u32_e32 v139, 23, v119
	v_cmp_gt_i32_e32 vcc, s91, v139
	v_subrev_u32_e32 v139, 22, v119
	v_cmp_gt_i32_e64 s[0:1], s91, v139
	v_subrev_u32_e32 v139, 21, v119
	v_cmp_gt_i32_e64 s[4:5], s91, v139
	v_subrev_u32_e32 v139, 20, v119
	v_cmp_gt_i32_e64 s[6:7], s91, v139
	v_subrev_u32_e32 v139, 19, v119
	v_cmp_gt_i32_e64 s[8:9], s91, v139
	v_subrev_u32_e32 v139, 18, v119
	v_cmp_gt_i32_e64 s[10:11], s91, v139
	v_subrev_u32_e32 v139, 17, v119
	v_cmp_gt_i32_e64 s[12:13], s91, v139
	v_add_u32_e32 v139, -16, v119
	v_cmp_gt_i32_e64 s[14:15], s91, v139
	v_add_u32_e32 v139, -7, v119
	v_cmp_gt_i32_e64 s[16:17], s91, v139
	v_add_u32_e32 v139, -6, v119
	v_cmp_gt_i32_e64 s[18:19], s91, v139
	v_add_u32_e32 v139, -5, v119
	v_cmp_gt_i32_e64 s[20:21], s91, v139
	v_add_u32_e32 v139, -4, v119
	v_cmp_gt_i32_e64 s[22:23], s91, v139
	v_add_u32_e32 v139, -3, v119
	v_cmp_gt_i32_e64 s[24:25], s91, v139
	v_add_u32_e32 v139, -2, v119
	v_cmp_gt_i32_e64 s[26:27], s91, v139
	v_add_u32_e32 v139, -1, v119
	v_cmp_gt_i32_e64 s[28:29], s91, v139
	v_cmp_gt_i32_e64 s[30:31], s91, v119
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
