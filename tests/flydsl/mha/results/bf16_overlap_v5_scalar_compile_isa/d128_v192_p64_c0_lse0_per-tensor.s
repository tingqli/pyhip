...
.LBB0_13:
	...
	buffer_load_dwordx4 v[146:149], v3, s[44:47], 0 offen
	buffer_load_dwordx4 v[150:153], v3, s[44:47], 0 offen offset:32
	buffer_load_dwordx4 v[154:157], v3, s[44:47], 0 offen offset:64
	buffer_load_dwordx4 v[158:161], v3, s[44:47], 0 offen offset:96
	buffer_load_dwordx4 v[162:165], v3, s[44:47], 0 offen offset:128
	buffer_load_dwordx4 v[166:169], v3, s[44:47], 0 offen offset:160
	buffer_load_dwordx4 v[170:173], v3, s[44:47], 0 offen offset:192
	buffer_load_dwordx4 v[174:177], v3, s[44:47], 0 offen offset:224
	;;#ASMSTART
	v_mov_b32 v3, v0
	;;#ASMEND
	s_waitcnt vmcnt(9)
...
.LBB0_15:
	...
	global_load_dwordx4 v[178:181], v[2:3], off offset:512
	s_waitcnt vmcnt(1)
...
.LBB0_17:
	...
	global_load_dwordx4 v[186:189], v[106:107], off offset:2048
	...
	s_waitcnt vmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[186:187], v[100:101], v[66:81]
	s_waitcnt vmcnt(0)
	...
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v107, vcc
	v_mfma_f32_32x32x8_bf16 v[66:81], v[188:189], v[102:103], v[66:81]
...
.LBB0_18:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[126:127], v[146:147], 0
	s_mov_b32 s12, s85
	s_waitcnt vmcnt(1)
	v_readfirstlane_b32 s83, v117
	v_mfma_f32_32x32x8_bf16 v[98:113], v[128:129], v[148:149], v[98:113]
...
.LBB0_22:
	...
	global_load_dwordx4 v[178:181], v[106:107], off offset:2560
	s_waitcnt vmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[2:17], v[108:109], v[100:101], v[2:17]
	s_waitcnt vmcnt(4)
	v_mfma_f32_32x32x8_bf16 v[18:33], v[124:125], v[100:101], v[18:33]
	...
	s_waitcnt vmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[82:97], v[178:179], v[100:101], v[82:97]
	v_add_co_u32_e32 v100, vcc, s76, v106
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v107, vcc
	v_mfma_f32_32x32x8_bf16 v[2:17], v[110:111], v[102:103], v[2:17]
	...
	v_mfma_f32_32x32x8_bf16 v[82:97], v[180:181], v[102:103], v[82:97]
	s_waitcnt vmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[2:17], v[108:109], v[104:105], v[2:17]
	global_load_dwordx4 v[106:109], v[100:101], off
	s_nop 0
...
.LBB0_26:
	...
	v_mfma_f32_32x32x8_bf16 v[2:17], v[108:109], v[100:101], v[2:17]
	s_waitcnt vmcnt(4)
	v_mfma_f32_32x32x8_bf16 v[18:33], v[178:179], v[100:101], v[18:33]
	s_waitcnt vmcnt(3)
	...
	v_mfma_f32_32x32x8_bf16 v[2:17], v[110:111], v[102:103], v[2:17]
	global_load_dwordx4 v[108:111], v[100:101], off offset:2048
	v_mfma_f32_32x32x8_bf16 v[18:33], v[180:181], v[102:103], v[18:33]
	global_load_dwordx4 v[178:181], v[100:101], off offset:2560
	...
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[62:63]
	global_load_dwordx4 v[178:181], v[98:99], off offset:512
	...
	v_and_or_b32 v182, v99, s74, v100
	v_or_b32_e32 v98, v182, v145
	v_lshlrev_b32_e32 v98, 1, v98
	ds_read_b128 v[190:193], v98 offset:8192
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[190:191], v[146:147], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[192:193], v[148:149], v[98:113]
	v_or_b32_e32 v117, 0x1010, v182
	...
	v_max3_f32 v117, v117, v110, v111
	v_max3_f32 v117, v117, v112, v113
	ds_bpermute_b32 v145, v140, v117
	s_waitcnt lgkmcnt(0)
...
.LBB0_30:
	...
	v_and_or_b32 v117, v99, s74, v100
	v_and_b32_e32 v145, 48, v98
	v_or_b32_e32 v98, v117, v145
	v_lshlrev_b32_e32 v98, 1, v98
	ds_read_b128 v[186:189], v98
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[186:187], v[146:147], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[188:189], v[148:149], v[98:113]
	v_or_b32_e32 v186, 16, v117
	v_xor_b32_e32 v186, v186, v145
	...
	v_or_b32_e32 v186, 48, v117
	v_xor_b32_e32 v145, v186, v145
	v_lshlrev_b32_e32 v145, 1, v145
	ds_read_b128 v[186:189], v145
	s_waitcnt lgkmcnt(0)
	...
	v_or_b32_e32 v145, 64, v117
	v_lshrrev_b32_e32 v186, 3, v145
...
.LBB0_37:
	...
	global_load_dwordx4 v[186:189], v[106:107], off offset:2560
	s_waitcnt vmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[2:17], v[108:109], v[100:101], v[2:17]
	s_waitcnt vmcnt(4)
	...
	s_waitcnt vmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[82:97], v[186:187], v[100:101], v[82:97]
	v_add_co_u32_e32 v100, vcc, s76, v106
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v107, vcc
	v_mfma_f32_32x32x8_bf16 v[2:17], v[110:111], v[102:103], v[2:17]
	...
	v_mfma_f32_32x32x8_bf16 v[82:97], v[188:189], v[102:103], v[82:97]
	s_waitcnt vmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[2:17], v[108:109], v[104:105], v[2:17]
	global_load_dwordx4 v[106:109], v[100:101], off
	s_nop 0
...
.LBB0_39:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[124:125], v[146:147], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[126:127], v[148:149], v[98:113]
...
.LBB0_43:
	...
	v_and_b32_e32 v117, 8, v117
	v_add_u32_e32 v117, s87, v117
	v_add_u32_e32 v122, 0xffffffa9, v117
	v_cmp_gt_i32_e32 vcc, s86, v122
	v_add_u32_e32 v122, 0xffffffaa, v117
	v_cmp_gt_i32_e64 s[0:1], s86, v122
	v_add_u32_e32 v122, 0xffffffab, v117
	v_cmp_gt_i32_e64 s[4:5], s86, v122
	v_add_u32_e32 v122, 0xffffffac, v117
	v_cmp_gt_i32_e64 s[6:7], s86, v122
	v_add_u32_e32 v122, 0xffffffad, v117
	v_cmp_gt_i32_e64 s[8:9], s86, v122
	v_add_u32_e32 v122, 0xffffffae, v117
	v_cmp_gt_i32_e64 s[10:11], s86, v122
	v_add_u32_e32 v122, 0xffffffaf, v117
	v_cmp_gt_i32_e64 s[12:13], s86, v122
	v_add_u32_e32 v122, 0xffffffb0, v117
	v_cmp_gt_i32_e64 s[14:15], s86, v122
	v_add_u32_e32 v122, 0xffffffb9, v117
	v_cmp_gt_i32_e64 s[16:17], s86, v122
	v_add_u32_e32 v122, 0xffffffba, v117
	v_cmp_gt_i32_e64 s[18:19], s86, v122
	v_add_u32_e32 v122, 0xffffffbb, v117
	v_cmp_gt_i32_e64 s[20:21], s86, v122
	v_add_u32_e32 v122, 0xffffffbc, v117
	v_cmp_gt_i32_e64 s[22:23], s86, v122
	v_add_u32_e32 v122, 0xffffffbd, v117
	v_cmp_gt_i32_e64 s[24:25], s86, v122
	v_add_u32_e32 v122, 0xffffffbe, v117
	v_cmp_gt_i32_e64 s[26:27], s86, v122
	v_add_u32_e32 v122, 0xffffffbf, v117
...
.LBB0_47:
	...
	v_max3_f32 v117, v117, v110, v111
	v_max3_f32 v117, v117, v112, v113
	ds_bpermute_b32 v139, v140, v117
	s_waitcnt lgkmcnt(0)
...
.LBB0_52:
	...
	v_xor_b32_e32 v139, v144, v139
	v_lshlrev_b32_e32 v139, 1, v139
	ds_read_b128 v[186:189], v139
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[186:187], v[158:159], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[188:189], v[160:161], v[98:113]
	v_or_b32_e32 v139, 64, v117
	v_lshrrev_b32_e32 v144, 3, v139
	...
	v_and_b32_e32 v117, 8, v117
	v_add_u32_e32 v117, s87, v117
	v_subrev_u32_e32 v139, 23, v117
	v_cmp_gt_i32_e32 vcc, s86, v139
	v_subrev_u32_e32 v139, 22, v117
	v_cmp_gt_i32_e64 s[0:1], s86, v139
	v_subrev_u32_e32 v139, 21, v117
	v_cmp_gt_i32_e64 s[4:5], s86, v139
	v_subrev_u32_e32 v139, 20, v117
	v_cmp_gt_i32_e64 s[6:7], s86, v139
	v_subrev_u32_e32 v139, 19, v117
	v_cmp_gt_i32_e64 s[8:9], s86, v139
	v_subrev_u32_e32 v139, 18, v117
	v_cmp_gt_i32_e64 s[10:11], s86, v139
	v_subrev_u32_e32 v139, 17, v117
	v_cmp_gt_i32_e64 s[12:13], s86, v139
	v_add_u32_e32 v139, -16, v117
	v_cmp_gt_i32_e64 s[14:15], s86, v139
	v_add_u32_e32 v139, -7, v117
	v_cmp_gt_i32_e64 s[16:17], s86, v139
	v_add_u32_e32 v139, -6, v117
	v_cmp_gt_i32_e64 s[18:19], s86, v139
	v_add_u32_e32 v139, -5, v117
	v_cmp_gt_i32_e64 s[20:21], s86, v139
	v_add_u32_e32 v139, -4, v117
	v_cmp_gt_i32_e64 s[22:23], s86, v139
	v_add_u32_e32 v139, -3, v117
	v_cmp_gt_i32_e64 s[24:25], s86, v139
	v_add_u32_e32 v139, -2, v117
	v_cmp_gt_i32_e64 s[26:27], s86, v139
	v_add_u32_e32 v139, -1, v117
	v_cmp_gt_i32_e64 s[28:29], s86, v139
	v_cmp_gt_i32_e64 s[30:31], s86, v117
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
