...
.LBB0_22:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v90, v90, v90
	v_max_f32_e32 v126, v85, v90
	;;#ASMSTART
	v_add_f32 v85, v86, v122
	;;#ASMEND
	v_mov_b32_e32 v90, v86
	v_cmp_gt_f32_e32 vcc, v126, v85
	v_mov_b32_e32 v85, 1.0
...
.LBB0_26:
	...
	s_ashr_i32 s5, s4, 31
	v_lshl_add_u64 v[126:127], s[4:5], 0, v[82:83]
	v_lshl_add_u64 v[126:127], v[126:127], 2, s[70:71]
	s_lshl_b32 s6, s93, 13
	s_add_i32 s6, s6, s98
	v_mfma_f32_32x32x8_bf16 v[66:81], v[202:203], v[130:131], v[66:81]
	buffer_load_dword v85, v85, s[76:79], 0 offen
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s99, v85
	s_waitcnt lgkmcnt(7)
	...
	global_load_dwordx4 v[160:163], v[126:127], off offset:512
	;;#ASMSTART
	v_mov_b32 v126, v0
	;;#ASMEND
	s_nop 0
	...
	v_or3_b32 v126, v127, v126, s6
	v_ashrrev_i32_e32 v127, 31, v126
	v_lshl_add_u64 v[126:127], v[126:127], 1, s[86:87]
	global_load_dwordx4 v[172:175], v[126:127], off
	...
	global_load_dwordx4 v[184:187], v[126:127], off offset:512
	...
	global_load_dwordx4 v[188:191], v[126:127], off offset:1536
	v_add_co_u32_e32 v126, vcc, s91, v126
	s_nop 1
	...
	global_load_dwordx4 v[192:195], v[126:127], off offset:512
	...
	v_max3_f32 v85, v85, v78, v79
	v_max3_f32 v85, v85, v80, v81
	ds_bpermute_b32 v126, v121, v85
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v126, v126, v126
	v_max_f32_e32 v126, v85, v126
	;;#ASMSTART
	v_add_f32 v85, v86, v122
	;;#ASMEND
	s_nop 0
...
.LBB0_30:
	...
	;;#ASMEND
	s_nop 0
	v_lshlrev_b32_e32 v126, 3, v85
	v_lshlrev_b32_e32 v85, 5, v85
	v_and_b32_e32 v126, 0xf8, v126
	s_waitcnt lgkmcnt(7)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[204:205], v[132:133], v[66:81]
	v_and_b32_e32 v85, 0x400, v85
	v_or3_b32 v126, v126, v85, s6
	v_ashrrev_i32_e32 v127, 31, v126
	v_lshl_add_u64 v[126:127], v[126:127], 1, s[86:87]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[206:207], v[134:135], v[66:81]
	s_waitcnt lgkmcnt(6)
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[214:215], v[142:143], v[66:81]
	global_load_dwordx4 v[176:179], v[126:127], off offset:1024
	global_load_dwordx4 v[204:207], v[126:127], off offset:1536
	v_add_co_u32_e32 v126, vcc, s91, v126
	s_nop 1
	v_addc_co_u32_e32 v127, vcc, 0, v127, vcc
	s_waitcnt lgkmcnt(4)
	...
	global_load_dwordx4 v[208:211], v[126:127], off
	global_load_dwordx4 v[212:215], v[126:127], off offset:512
	...
	global_load_dwordx4 v[216:219], v[126:127], off offset:1024
	global_load_dwordx4 v[200:203], v[126:127], off offset:1536
	s_waitcnt lgkmcnt(1)
...
.LBB0_38:
	...
	s_cselect_b32 s8, s83, s93
	s_cselect_b32 s93, s99, s83
...
.LBB0_47:
	...
	v_and_b32_e32 v127, 0xf8, v127
	v_and_b32_e32 v126, 0x400, v126
	v_or3_b32 v126, v127, v126, s41
	v_ashrrev_i32_e32 v127, 31, v126
	v_lshl_add_u64 v[126:127], v[126:127], 1, s[86:87]
	global_load_dwordx4 v[192:195], v[126:127], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[190:191], v[138:139], v[66:81]
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[180:181], v[140:141], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[182:183], v[142:143], v[66:81]
	global_load_dwordx4 v[188:191], v[126:127], off offset:512
	global_load_dwordx4 v[180:183], v[126:127], off offset:1024
	s_waitcnt lgkmcnt(4)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[184:185], v[144:145], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[186:187], v[146:147], v[66:81]
	s_waitcnt lgkmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[172:173], v[148:149], v[66:81]
	global_load_dwordx4 v[196:199], v[126:127], off offset:1536
	v_add_co_u32_e32 v126, vcc, s91, v126
	s_nop 1
	v_addc_co_u32_e32 v127, vcc, 0, v127, vcc
	global_load_dwordx4 v[184:187], v[126:127], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[174:175], v[150:151], v[66:81]
	s_waitcnt lgkmcnt(2)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[176:177], v[152:153], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[178:179], v[154:155], v[66:81]
	global_load_dwordx4 v[176:179], v[126:127], off offset:512
	global_load_dwordx4 v[200:203], v[126:127], off offset:1024
	global_load_dwordx4 v[172:175], v[126:127], off offset:1536
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[168:169], v[156:157], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[170:171], v[158:159], v[66:81]
	s_waitcnt vmcnt(9) lgkmcnt(0)
...
.LBB0_52:
	...
	v_and_b32_e32 v85, 8, v85
	v_add_u32_e32 v85, s42, v85
	v_subrev_u32_e32 v126, 23, v85
	v_cmp_gt_i32_e32 vcc, s37, v126
	v_subrev_u32_e32 v126, 22, v85
	v_cmp_gt_i32_e64 s[0:1], s37, v126
	v_subrev_u32_e32 v126, 21, v85
	v_cmp_gt_i32_e64 s[4:5], s37, v126
	v_subrev_u32_e32 v126, 20, v85
	v_cmp_gt_i32_e64 s[6:7], s37, v126
	v_subrev_u32_e32 v126, 19, v85
	v_cmp_gt_i32_e64 s[8:9], s37, v126
	v_subrev_u32_e32 v126, 18, v85
	v_cmp_gt_i32_e64 s[10:11], s37, v126
	v_subrev_u32_e32 v126, 17, v85
	v_cmp_gt_i32_e64 s[12:13], s37, v126
	v_add_u32_e32 v126, -16, v85
	v_cmp_gt_i32_e64 s[14:15], s37, v126
	v_add_u32_e32 v126, -7, v85
	v_cmp_gt_i32_e64 s[16:17], s37, v126
	v_add_u32_e32 v126, -6, v85
	v_cmp_gt_i32_e64 s[18:19], s37, v126
	v_add_u32_e32 v126, -5, v85
	v_cmp_gt_i32_e64 s[20:21], s37, v126
	v_add_u32_e32 v126, -4, v85
	v_cmp_gt_i32_e64 s[22:23], s37, v126
	v_add_u32_e32 v126, -3, v85
	v_cmp_gt_i32_e64 s[24:25], s37, v126
	v_add_u32_e32 v126, -2, v85
	v_cmp_gt_i32_e64 s[26:27], s37, v126
	v_add_u32_e32 v126, -1, v85
	v_cmp_gt_i32_e64 s[28:29], s37, v126
	v_cmp_gt_i32_e64 s[30:31], s37, v85
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
