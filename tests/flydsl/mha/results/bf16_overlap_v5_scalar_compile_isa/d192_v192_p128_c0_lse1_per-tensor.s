...
.LBB0_8:
	...
	s_mov_b32 s33, s2
.LBB0_9:
	s_load_dword s81, s[38:39], 0x0
	s_load_dword s82, s[40:41], 0x0
	s_cmp_ge_i32 s52, s3
	...
	s_movk_i32 s0, 0x80
	v_xor_b32_e32 v137, v2, v3
	v_and_b32_e32 v2, 63, v0
	v_add_u32_sdwa v136, v115, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	s_movk_i32 s0, 0x100
	s_movk_i32 s83, 0x180
	v_lshlrev_b32_e32 v2, 2, v2
	v_add_u32_sdwa v138, v115, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	v_add_u32_sdwa v139, v115, s83 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
.LBB0_13:
	...
	global_load_dwordx2 v[4:5], v141, s[4:5]
	global_load_dword v2, v141, s[36:37]
	s_mul_i32 s53, s58, 0xc0
	s_mov_b32 s51, s47
	v_add_lshl_u32 v3, s53, v1, 1
	s_waitcnt vmcnt(1)
	...
	global_load_dwordx2 v[4:5], v141, s[6:7]
	global_load_dword v6, v141, s[0:1]
	s_addc_u32 s0, s39, s69
	s_mul_i32 s50, s71, 0x1800
	s_and_b32 s49, s0, 0xffff
	buffer_load_dwordx4 v[148:151], v3, s[48:51], 0 offen
	buffer_load_dwordx4 v[152:155], v3, s[48:51], 0 offen offset:32
	buffer_load_dwordx4 v[156:159], v3, s[48:51], 0 offen offset:64
	buffer_load_dwordx4 v[160:163], v3, s[48:51], 0 offen offset:96
	buffer_load_dwordx4 v[164:167], v3, s[48:51], 0 offen offset:128
	buffer_load_dwordx4 v[168:171], v3, s[48:51], 0 offen offset:160
	buffer_load_dwordx4 v[172:175], v3, s[48:51], 0 offen offset:192
	buffer_load_dwordx4 v[176:179], v3, s[48:51], 0 offen offset:224
	buffer_load_dwordx4 v[180:183], v3, s[48:51], 0 offen offset:256
	buffer_load_dwordx4 v[184:187], v3, s[48:51], 0 offen offset:288
	buffer_load_dwordx4 v[188:191], v3, s[48:51], 0 offen offset:320
	buffer_load_dwordx4 v[192:195], v3, s[48:51], 0 offen offset:352
	;;#ASMSTART
	v_mov_b32 v3, v0
	;;#ASMEND
	s_waitcnt vmcnt(13)
...
.LBB0_15:
	...
	s_add_u32 s74, s40, s4
	s_addc_u32 s75, s41, s5
	s_ashr_i32 s1, s0, 31
	...
	v_add_u32_sdwa v4, s4, v115 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_ashrrev_i32_e32 v5, 31, v4
	v_lshl_add_u64 v[4:5], v[4:5], 2, s[74:75]
	global_load_dwordx4 v[196:199], v[4:5], off
	global_load_dwordx4 v[200:203], v[4:5], off offset:256
.LBB0_17:
	...
	v_add_u32_e32 v4, s4, v136
	v_ashrrev_i32_e32 v5, 31, v4
	v_lshl_add_u64 v[4:5], v[4:5], 2, s[74:75]
	global_load_dwordx4 v[204:207], v[4:5], off
	global_load_dwordx4 v[208:211], v[4:5], off offset:256
.LBB0_19:
	s_or_b64 exec, exec, s[0:1]
	s_waitcnt vmcnt(2) lgkmcnt(0)
	s_barrier
	...
	s_waitcnt vmcnt(1)
	ds_write_b128 v137, v[196:199] offset:12288
	s_waitcnt vmcnt(0)
	ds_write_b128 v137, v[200:203] offset:18432
.LBB0_21:
	s_or_b64 exec, exec, s[0:1]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_25:
	...
	;;#ASMSTART
	v_perm_b32 v100, v99, v98, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v101, v117, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v103, v105, v104, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v104, v107, v106, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v105, v109, v108, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v98, v111, v110, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v99, v113, v112, s84
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
...
.LBB0_26:
	...
	s_mov_b32 s10, s92
	v_cmp_ne_u32_e32 vcc, s83, v99
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s51, v98
	s_and_saveexec_b64 s[4:5], vcc
	s_cbranch_execz .LBB0_28
	ds_write_b128 v137, v[204:207]
	ds_write_b128 v137, v[208:211] offset:6144
.LBB0_28:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v98, v0
...
.LBB0_30:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[120:121], v[148:149], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[122:123], v[150:151], v[98:113]
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[120:121], v[152:153], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[122:123], v[154:155], v[98:113]
	...
	ds_read_b128 v[120:123], v120
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[120:121], v[156:157], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[122:123], v[158:159], v[98:113]
	...
	ds_read_b128 v[120:123], v120
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[120:121], v[160:161], v[98:113]
...
.LBB0_34:
	...
	v_add_u32_sdwa v98, s11, v115 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[74:75]
	global_load_dwordx4 v[196:199], v[98:99], off
	global_load_dwordx4 v[200:203], v[98:99], off offset:256
.LBB0_36:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v98, v0
...
.LBB0_42:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[212:213], v[148:149], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[214:215], v[150:151], v[98:113]
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[212:213], v[152:153], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[214:215], v[154:155], v[98:113]
	...
	ds_read_b128 v[212:215], v147
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[212:213], v[156:157], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[214:215], v[158:159], v[98:113]
	...
	ds_read_b128 v[212:215], v147
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[212:213], v[160:161], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[214:215], v[162:163], v[98:113]
	...
	ds_read_b128 v[212:215], v147
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[212:213], v[164:165], v[98:113]
	...
	v_max3_f32 v117, v117, v110, v111
	v_max3_f32 v117, v117, v112, v113
	ds_bpermute_b32 v147, v140, v117
	s_waitcnt lgkmcnt(0)
...
.LBB0_78:
	...
	s_cselect_b32 s78, s51, s73
	s_cselect_b32 s73, s92, s51
	s_cselect_b32 s51, s97, s92
	s_add_u32 s76, s76, 2
...
.LBB0_83:
	...
	v_add_u32_e32 v117, s94, v117
	v_add_u32_e32 v120, 0xffffff09, v117
	v_cmp_gt_i32_e32 vcc, s93, v120
	v_add_u32_e32 v120, 0xffffff0a, v117
	v_cmp_gt_i32_e64 s[0:1], s93, v120
	v_add_u32_e32 v120, 0xffffff0b, v117
	v_cmp_gt_i32_e64 s[4:5], s93, v120
	v_add_u32_e32 v120, 0xffffff0c, v117
	v_cmp_gt_i32_e64 s[6:7], s93, v120
	v_add_u32_e32 v120, 0xffffff0d, v117
	v_cmp_gt_i32_e64 s[8:9], s93, v120
	v_add_u32_e32 v120, 0xffffff0e, v117
	v_cmp_gt_i32_e64 s[10:11], s93, v120
	v_add_u32_e32 v120, 0xffffff0f, v117
	v_cmp_gt_i32_e64 s[12:13], s93, v120
	v_add_u32_e32 v120, 0xffffff10, v117
	v_cmp_gt_i32_e64 s[14:15], s93, v120
	v_add_u32_e32 v120, 0xffffff19, v117
	v_cmp_gt_i32_e64 s[16:17], s93, v120
	v_add_u32_e32 v120, 0xffffff1a, v117
	v_cmp_gt_i32_e64 s[18:19], s93, v120
	v_add_u32_e32 v120, 0xffffff1b, v117
	v_cmp_gt_i32_e64 s[20:21], s93, v120
	v_add_u32_e32 v120, 0xffffff1c, v117
	v_cmp_gt_i32_e64 s[22:23], s93, v120
	v_add_u32_e32 v120, 0xffffff1d, v117
	v_cmp_gt_i32_e64 s[24:25], s93, v120
	v_add_u32_e32 v120, 0xffffff1e, v117
	v_cmp_gt_i32_e64 s[26:27], s93, v120
	v_add_u32_e32 v120, 0xffffff1f, v117
	v_add_u32_e32 v117, 0xffffff20, v117
	v_cmp_gt_i32_e64 s[28:29], s93, v120
	v_cmp_gt_i32_e64 s[30:31], s93, v117
	...
	v_cndmask_b32_e64 v101, v144, v101, s[6:7]
	v_cndmask_b32_e64 v100, v144, v100, s[4:5]
	v_cndmask_b32_e64 v121, v144, v99, s[0:1]
	v_cndmask_b32_e32 v120, v144, v98, vcc
	v_mov_b32_e32 v117, v116
	v_cndmask_b32_e64 v113, v144, v113, s[30:31]
	v_cndmask_b32_e64 v112, v144, v112, s[28:29]
	v_cndmask_b32_e64 v111, v144, v111, s[26:27]
	v_cndmask_b32_e64 v110, v144, v110, s[24:25]
	v_cndmask_b32_e64 v109, v144, v109, s[22:23]
	v_cndmask_b32_e64 v108, v144, v108, s[20:21]
	v_cndmask_b32_e64 v107, v144, v107, s[18:19]
	v_cndmask_b32_e64 v106, v144, v106, s[16:17]
	v_cndmask_b32_e64 v105, v144, v105, s[14:15]
	v_cndmask_b32_e64 v104, v144, v104, s[12:13]
	v_cndmask_b32_e64 v103, v144, v103, s[10:11]
	v_cndmask_b32_e64 v102, v144, v102, s[8:9]
...
.LBB0_85:
	...
	v_add_u32_e32 v106, 0x8000, v106
	;;#ASMSTART
	v_perm_b32 v100, v101, v100, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v101, v99, v98, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v102, v103, v102, s84
	;;#ASMEND
...
.LBB0_87:
	...
	v_add_u32_sdwa v98, s99, v115 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_ashrrev_i32_e32 v99, 31, v98
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[74:75]
	global_load_dwordx4 v[196:199], v[98:99], off
	global_load_dwordx4 v[200:203], v[98:99], off offset:256
.LBB0_89:
	...
	v_and_b32_e32 v117, 8, v117
	v_add_u32_e32 v117, s94, v117
	v_add_u32_e32 v120, 0xffffff29, v117
	v_cmp_gt_i32_e32 vcc, s93, v120
	v_add_u32_e32 v120, 0xffffff2a, v117
	v_cmp_gt_i32_e64 s[0:1], s93, v120
	v_add_u32_e32 v120, 0xffffff2b, v117
	v_cmp_gt_i32_e64 s[4:5], s93, v120
	v_add_u32_e32 v120, 0xffffff2c, v117
	v_cmp_gt_i32_e64 s[6:7], s93, v120
	v_add_u32_e32 v120, 0xffffff2d, v117
	v_cmp_gt_i32_e64 s[8:9], s93, v120
	v_add_u32_e32 v120, 0xffffff2e, v117
	v_cmp_gt_i32_e64 s[10:11], s93, v120
	v_add_u32_e32 v120, 0xffffff2f, v117
	v_cmp_gt_i32_e64 s[12:13], s93, v120
	v_add_u32_e32 v120, 0xffffff30, v117
	v_cmp_gt_i32_e64 s[14:15], s93, v120
	v_add_u32_e32 v120, 0xffffff39, v117
	v_cmp_gt_i32_e64 s[16:17], s93, v120
	v_add_u32_e32 v120, 0xffffff3a, v117
	v_cmp_gt_i32_e64 s[18:19], s93, v120
	v_add_u32_e32 v120, 0xffffff3b, v117
	v_cmp_gt_i32_e64 s[20:21], s93, v120
	v_add_u32_e32 v120, 0xffffff3c, v117
	v_cmp_gt_i32_e64 s[22:23], s93, v120
	v_add_u32_e32 v120, 0xffffff3d, v117
	v_cmp_gt_i32_e64 s[24:25], s93, v120
	v_add_u32_e32 v120, 0xffffff3e, v117
	v_cmp_gt_i32_e64 s[26:27], s93, v120
	v_add_u32_e32 v120, 0xffffff3f, v117
	...
	s_or_b64 s[0:1], s[4:5], s[0:1]
	s_or_b64 vcc, s[0:1], vcc
	v_cndmask_b32_e64 v99, v144, v99, s[0:1]
...
.LBB0_95:
	...
	v_and_b32_e32 v117, 8, v117
	v_add_u32_e32 v117, s94, v117
	v_add_u32_e32 v147, 0xffffff49, v117
	v_cmp_gt_i32_e32 vcc, s93, v147
	v_add_u32_e32 v147, 0xffffff4a, v117
	v_cmp_gt_i32_e64 s[0:1], s93, v147
	v_add_u32_e32 v147, 0xffffff4b, v117
	v_cmp_gt_i32_e64 s[4:5], s93, v147
	v_add_u32_e32 v147, 0xffffff4c, v117
	v_cmp_gt_i32_e64 s[6:7], s93, v147
	v_add_u32_e32 v147, 0xffffff4d, v117
	v_cmp_gt_i32_e64 s[8:9], s93, v147
	v_add_u32_e32 v147, 0xffffff4e, v117
	v_cmp_gt_i32_e64 s[10:11], s93, v147
	v_add_u32_e32 v147, 0xffffff4f, v117
	v_cmp_gt_i32_e64 s[12:13], s93, v147
	v_add_u32_e32 v147, 0xffffff50, v117
	v_cmp_gt_i32_e64 s[14:15], s93, v147
	v_add_u32_e32 v147, 0xffffff59, v117
	v_cmp_gt_i32_e64 s[16:17], s93, v147
	v_add_u32_e32 v147, 0xffffff5a, v117
	v_cmp_gt_i32_e64 s[18:19], s93, v147
	v_add_u32_e32 v147, 0xffffff5b, v117
	v_cmp_gt_i32_e64 s[20:21], s93, v147
	v_add_u32_e32 v147, 0xffffff5c, v117
	v_cmp_gt_i32_e64 s[22:23], s93, v147
	v_add_u32_e32 v147, 0xffffff5d, v117
	v_cmp_gt_i32_e64 s[24:25], s93, v147
	v_add_u32_e32 v147, 0xffffff5e, v117
	v_cmp_gt_i32_e64 s[26:27], s93, v147
	v_add_u32_e32 v147, 0xffffff5f, v117
	v_add_u32_e32 v117, 0xffffff60, v117
	v_cmp_gt_i32_e64 s[28:29], s93, v147
	v_cmp_gt_i32_e64 s[30:31], s93, v117
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
	s_or_b64 s[24:25], s[26:27], s[24:25]
...
.LBB0_101:
	...
	v_and_b32_e32 v117, 8, v117
	v_add_u32_e32 v117, s94, v117
	v_add_u32_e32 v147, 0xffffff69, v117
	v_cmp_gt_i32_e32 vcc, s93, v147
	v_add_u32_e32 v147, 0xffffff6a, v117
	v_cmp_gt_i32_e64 s[0:1], s93, v147
	v_add_u32_e32 v147, 0xffffff6b, v117
	v_cmp_gt_i32_e64 s[4:5], s93, v147
	v_add_u32_e32 v147, 0xffffff6c, v117
	v_cmp_gt_i32_e64 s[6:7], s93, v147
	v_add_u32_e32 v147, 0xffffff6d, v117
	v_cmp_gt_i32_e64 s[8:9], s93, v147
	v_add_u32_e32 v147, 0xffffff6e, v117
	v_cmp_gt_i32_e64 s[10:11], s93, v147
	v_add_u32_e32 v147, 0xffffff6f, v117
	v_cmp_gt_i32_e64 s[12:13], s93, v147
	v_add_u32_e32 v147, 0xffffff70, v117
	v_cmp_gt_i32_e64 s[14:15], s93, v147
	v_add_u32_e32 v147, 0xffffff79, v117
	v_cmp_gt_i32_e64 s[16:17], s93, v147
	v_add_u32_e32 v147, 0xffffff7a, v117
	v_cmp_gt_i32_e64 s[18:19], s93, v147
	v_add_u32_e32 v147, 0xffffff7b, v117
	v_cmp_gt_i32_e64 s[20:21], s93, v147
	v_add_u32_e32 v147, 0xffffff7c, v117
	v_cmp_gt_i32_e64 s[22:23], s93, v147
	v_add_u32_e32 v147, 0xffffff7d, v117
	v_cmp_gt_i32_e64 s[24:25], s93, v147
	v_add_u32_e32 v147, 0xffffff7e, v117
	v_cmp_gt_i32_e64 s[26:27], s93, v147
	v_add_u32_e32 v147, 0xffffff7f, v117
...
.LBB0_103:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[108:109], v[98:99], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[82:97], v[102:103], v[98:99], v[82:97]
	s_cmp_gt_i32 s48, s95
	s_cselect_b64 s[78:79], -1, 0
	s_cmp_le_i32 s48, s95
...
.LBB0_108:
	...
	v_and_b32_e32 v117, 8, v117
	v_add_u32_e32 v117, s94, v117
	v_add_u32_e32 v147, 0xffffff89, v117
	v_cmp_gt_i32_e32 vcc, s93, v147
	v_add_u32_e32 v147, 0xffffff8a, v117
	v_cmp_gt_i32_e64 s[0:1], s93, v147
	v_add_u32_e32 v147, 0xffffff8b, v117
	v_cmp_gt_i32_e64 s[4:5], s93, v147
	v_add_u32_e32 v147, 0xffffff8c, v117
	v_cmp_gt_i32_e64 s[6:7], s93, v147
	v_add_u32_e32 v147, 0xffffff8d, v117
	v_cmp_gt_i32_e64 s[8:9], s93, v147
	v_add_u32_e32 v147, 0xffffff8e, v117
	v_cmp_gt_i32_e64 s[10:11], s93, v147
	v_add_u32_e32 v147, 0xffffff8f, v117
	v_cmp_gt_i32_e64 s[12:13], s93, v147
	v_add_u32_e32 v147, 0xffffff90, v117
	v_cmp_gt_i32_e64 s[14:15], s93, v147
	v_add_u32_e32 v147, 0xffffff99, v117
	v_cmp_gt_i32_e64 s[16:17], s93, v147
	v_add_u32_e32 v147, 0xffffff9a, v117
	v_cmp_gt_i32_e64 s[18:19], s93, v147
	v_add_u32_e32 v147, 0xffffff9b, v117
	v_cmp_gt_i32_e64 s[20:21], s93, v147
	v_add_u32_e32 v147, 0xffffff9c, v117
	v_cmp_gt_i32_e64 s[22:23], s93, v147
	v_add_u32_e32 v147, 0xffffff9d, v117
	v_cmp_gt_i32_e64 s[24:25], s93, v147
	v_add_u32_e32 v147, 0xffffff9e, v117
	v_cmp_gt_i32_e64 s[26:27], s93, v147
	v_add_u32_e32 v147, 0xffffff9f, v117
...
.LBB0_114:
	...
	v_and_b32_e32 v117, 8, v117
	v_add_u32_e32 v117, s94, v117
	v_add_u32_e32 v147, 0xffffffa9, v117
	v_cmp_gt_i32_e32 vcc, s93, v147
	v_add_u32_e32 v147, 0xffffffaa, v117
	v_cmp_gt_i32_e64 s[0:1], s93, v147
	v_add_u32_e32 v147, 0xffffffab, v117
	v_cmp_gt_i32_e64 s[4:5], s93, v147
	v_add_u32_e32 v147, 0xffffffac, v117
	v_cmp_gt_i32_e64 s[6:7], s93, v147
	v_add_u32_e32 v147, 0xffffffad, v117
	v_cmp_gt_i32_e64 s[8:9], s93, v147
	v_add_u32_e32 v147, 0xffffffae, v117
	v_cmp_gt_i32_e64 s[10:11], s93, v147
	v_add_u32_e32 v147, 0xffffffaf, v117
	v_cmp_gt_i32_e64 s[12:13], s93, v147
	v_add_u32_e32 v147, 0xffffffb0, v117
	v_cmp_gt_i32_e64 s[14:15], s93, v147
	v_add_u32_e32 v147, 0xffffffb9, v117
	v_cmp_gt_i32_e64 s[16:17], s93, v147
	v_add_u32_e32 v147, 0xffffffba, v117
	v_cmp_gt_i32_e64 s[18:19], s93, v147
	v_add_u32_e32 v147, 0xffffffbb, v117
	v_cmp_gt_i32_e64 s[20:21], s93, v147
	v_add_u32_e32 v147, 0xffffffbc, v117
	v_cmp_gt_i32_e64 s[22:23], s93, v147
	v_add_u32_e32 v147, 0xffffffbd, v117
	v_cmp_gt_i32_e64 s[24:25], s93, v147
	v_add_u32_e32 v147, 0xffffffbe, v117
	v_cmp_gt_i32_e64 s[26:27], s93, v147
	v_add_u32_e32 v147, 0xffffffbf, v117
...
.LBB0_120:
	...
	v_and_b32_e32 v117, 8, v117
	v_add_u32_e32 v117, s94, v117
	v_subrev_u32_e32 v147, 55, v117
	v_cmp_gt_i32_e32 vcc, s93, v147
	v_subrev_u32_e32 v147, 54, v117
	v_cmp_gt_i32_e64 s[0:1], s93, v147
	v_subrev_u32_e32 v147, 53, v117
	v_cmp_gt_i32_e64 s[4:5], s93, v147
	v_subrev_u32_e32 v147, 52, v117
	v_cmp_gt_i32_e64 s[6:7], s93, v147
	v_subrev_u32_e32 v147, 51, v117
	v_cmp_gt_i32_e64 s[8:9], s93, v147
	v_subrev_u32_e32 v147, 50, v117
	v_cmp_gt_i32_e64 s[10:11], s93, v147
	v_subrev_u32_e32 v147, 49, v117
	v_cmp_gt_i32_e64 s[12:13], s93, v147
	v_subrev_u32_e32 v147, 48, v117
	v_cmp_gt_i32_e64 s[14:15], s93, v147
	v_subrev_u32_e32 v147, 39, v117
	v_cmp_gt_i32_e64 s[16:17], s93, v147
	v_subrev_u32_e32 v147, 38, v117
	v_cmp_gt_i32_e64 s[18:19], s93, v147
	v_subrev_u32_e32 v147, 37, v117
	v_cmp_gt_i32_e64 s[20:21], s93, v147
	v_subrev_u32_e32 v147, 36, v117
	v_cmp_gt_i32_e64 s[22:23], s93, v147
	v_subrev_u32_e32 v147, 35, v117
	v_cmp_gt_i32_e64 s[24:25], s93, v147
	v_subrev_u32_e32 v147, 34, v117
	v_cmp_gt_i32_e64 s[26:27], s93, v147
	v_subrev_u32_e32 v147, 33, v117
...
.LBB0_126:
	...
	v_and_b32_e32 v117, 8, v117
	v_add_u32_e32 v117, s94, v117
	v_subrev_u32_e32 v147, 23, v117
	v_cmp_gt_i32_e32 vcc, s93, v147
	v_subrev_u32_e32 v147, 22, v117
	v_cmp_gt_i32_e64 s[0:1], s93, v147
	v_subrev_u32_e32 v147, 21, v117
	v_cmp_gt_i32_e64 s[4:5], s93, v147
	v_subrev_u32_e32 v147, 20, v117
	v_cmp_gt_i32_e64 s[6:7], s93, v147
	v_subrev_u32_e32 v147, 19, v117
	v_cmp_gt_i32_e64 s[8:9], s93, v147
	v_subrev_u32_e32 v147, 18, v117
	v_cmp_gt_i32_e64 s[10:11], s93, v147
	v_subrev_u32_e32 v147, 17, v117
	v_cmp_gt_i32_e64 s[12:13], s93, v147
	v_add_u32_e32 v147, -16, v117
	v_cmp_gt_i32_e64 s[14:15], s93, v147
	v_add_u32_e32 v147, -7, v117
	v_cmp_gt_i32_e64 s[16:17], s93, v147
	v_add_u32_e32 v147, -6, v117
	v_cmp_gt_i32_e64 s[18:19], s93, v147
	v_add_u32_e32 v147, -5, v117
	v_cmp_gt_i32_e64 s[20:21], s93, v147
	v_add_u32_e32 v147, -4, v117
	v_cmp_gt_i32_e64 s[22:23], s93, v147
	v_add_u32_e32 v147, -3, v117
	v_cmp_gt_i32_e64 s[24:25], s93, v147
	v_add_u32_e32 v147, -2, v117
	v_cmp_gt_i32_e64 s[26:27], s93, v147
	v_add_u32_e32 v147, -1, v117
	v_cmp_gt_i32_e64 s[28:29], s93, v147
	v_cmp_gt_i32_e64 s[30:31], s93, v117
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
...
.LBB0_129:
	...
	v_mov_b32 v100, v0
	;;#ASMEND
	ds_bpermute_b32 v98, v140, v146
	v_lshrrev_b32_e32 v99, 1, v100
	v_and_b32_e32 v101, 31, v100
	v_and_or_b32 v99, v99, s87, v101
	...
	v_cndmask_b32_e32 v100, 0, v145, vcc
	s_add_u32 s6, s64, s4
...
.LBB0_131:
	...
	;;#ASMSTART
	v_perm_b32 v48, v3, v2, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v49, v5, v4, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v46, v7, v6, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v47, v9, v8, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v44, v11, v10, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v45, v13, v12, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v42, v15, v14, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v43, v17, v16, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v40, v19, v18, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v41, v21, v20, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v38, v23, v22, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v39, v25, v24, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v36, v27, v26, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v37, v29, v28, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v34, v31, v30, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v35, v33, v32, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v112, v113, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v110, v111, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v108, v109, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v106, v107, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v28, v104, v105, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v102, v103, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v100, v101, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v98, v99, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v51, v50, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v53, v52, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v55, v54, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v57, v56, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v59, v58, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v61, v60, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v63, v62, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v65, v64, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v67, v66, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v69, v68, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v71, v70, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v73, v72, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v75, v74, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v77, v76, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v79, v78, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v81, v80, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v83, v82, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v85, v84, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v87, v86, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v89, v88, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v91, v90, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v93, v92, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v95, v94, s84
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v97, v96, s84
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v50, v0
	;;#ASMEND
...
.LBB0_164:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v141, v3, s[66:67] sc0
.LBB0_168:
	...
	global_store_dword v141, v2, s[6:7]
	s_waitcnt vmcnt(0)
.LBB0_169:
	s_or_b64 exec, exec, s[4:5]
	s_lshl_b64 s[0:1], s[0:1], 2
	...
	s_barrier
	global_load_dword v2, v141, s[0:1]
	s_sub_i32 s0, s33, s2
	s_waitcnt vmcnt(0)
	s_barrier
...
.LBB0_172:
	...
	global_load_dwordx2 v[2:3], v141, s[6:7] offset:4
	s_waitcnt vmcnt(0)
