...
.LBB0_38:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v116, v116, v116
	v_max_f32_e32 v142, v115, v116
	;;#ASMSTART
	v_add_f32 v115, v120, v138
	;;#ASMEND
	v_mov_b32_e32 v116, v120
	v_cmp_gt_f32_e32 vcc, v142, v115
	v_mov_b32_e32 v115, 1.0
...
.LBB0_46:
	...
	s_cselect_b32 s70, s84, s85
	s_cselect_b32 s85, s86, s84
	s_cselect_b32 s84, s91, s86
	s_add_u32 s68, s68, 2
...
.LBB0_51:
	...
	v_add_u32_e32 v115, s88, v115
	v_subrev_u32_e32 v120, 55, v115
	v_cmp_gt_i32_e32 vcc, s87, v120
	v_subrev_u32_e32 v120, 54, v115
	v_cmp_gt_i32_e64 s[0:1], s87, v120
	v_subrev_u32_e32 v120, 53, v115
	v_cmp_gt_i32_e64 s[4:5], s87, v120
	v_subrev_u32_e32 v120, 52, v115
	v_cmp_gt_i32_e64 s[6:7], s87, v120
	v_subrev_u32_e32 v120, 51, v115
	v_cmp_gt_i32_e64 s[8:9], s87, v120
	v_subrev_u32_e32 v120, 50, v115
	v_cmp_gt_i32_e64 s[10:11], s87, v120
	v_subrev_u32_e32 v120, 49, v115
	v_cmp_gt_i32_e64 s[12:13], s87, v120
	v_subrev_u32_e32 v120, 48, v115
	v_cmp_gt_i32_e64 s[14:15], s87, v120
	v_subrev_u32_e32 v120, 39, v115
	v_cmp_gt_i32_e64 s[16:17], s87, v120
	v_subrev_u32_e32 v120, 38, v115
	v_cmp_gt_i32_e64 s[18:19], s87, v120
	v_subrev_u32_e32 v120, 37, v115
	v_cmp_gt_i32_e64 s[20:21], s87, v120
	v_subrev_u32_e32 v120, 36, v115
	v_cmp_gt_i32_e64 s[22:23], s87, v120
	v_subrev_u32_e32 v120, 35, v115
	v_cmp_gt_i32_e64 s[24:25], s87, v120
	v_subrev_u32_e32 v120, 34, v115
	v_cmp_gt_i32_e64 s[26:27], s87, v120
	v_subrev_u32_e32 v120, 33, v115
	v_subrev_u32_e32 v115, 32, v115
	v_cmp_gt_i32_e64 s[28:29], s87, v120
	v_cmp_gt_i32_e64 s[30:31], s87, v115
...
.LBB0_55:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[108:109], v[98:99], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[82:97], v[102:103], v[98:99], v[82:97]
	s_cmp_gt_i32 s48, s89
	s_cselect_b64 s[70:71], -1, 0
	s_cmp_le_i32 s48, s89
	s_cbranch_scc1 .LBB0_64
	v_mov_b32_e32 v98, s90
	buffer_load_dword v98, v98, s[44:47], 0 offen
	;;#ASMSTART
	v_mov_b32 v99, v0
	;;#ASMEND
...
.LBB0_69:
	...
	s_barrier
.LBB0_70:
	v_mul_u32_u24_sdwa v95, v94, s81 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
.LBB0_97:
	...
	s_barrier
.LBB0_98:
	v_mul_u32_u24_sdwa v2, v88, s81 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v137, v3, s[62:63] sc0
.LBB0_102:
