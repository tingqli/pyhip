...
.LBB0_9:
	...
	v_or3_b32 v104, v5, v3, v2
	v_lshlrev_b32_e32 v2, 1, v0
	v_and_b32_e32 v2, 0x70, v2
	v_lshlrev_b32_e32 v3, 4, v0
	v_xor_b32_e32 v105, v3, v2
...
.LBB0_13:
	...
	global_load_dwordx2 v[4:5], v122, s[12:13]
	global_load_dword v2, v122, s[4:5]
	s_mov_b32 s19, s15
	s_waitcnt vmcnt(1)
	...
	global_load_dwordx2 v[4:5], v122, s[16:17]
...
.LBB0_15:
	...
	s_barrier
	s_setprio 1
	ds_read_b128 v[186:189], v106
	ds_read_b128 v[182:185], v107
	ds_read_b128 v[178:181], v108
	ds_read_b128 v[170:173], v109
	ds_read_b128 v[174:177], v110
	ds_read_b128 v[94:97], v111
	ds_read_b128 v[98:101], v112
	ds_read_b128 v[90:93], v113
...
.LBB0_17:
	...
	;;#ASMSTART
	v_perm_b32 v66, v67, v66, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v67, v69, v68, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v68, v71, v70, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v69, v73, v72, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v70, v75, v74, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v71, v77, v76, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v72, v79, v78, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v73, v81, v80, s80
	;;#ASMEND
	s_barrier
	s_setprio 1
	s_waitcnt vmcnt(0)
	...
	ds_read_b128 v[98:101], v112
	ds_read_b128 v[90:93], v113
	v_mfma_f32_32x32x8_bf16 v[18:33], v[210:211], v[70:71], v[18:33]
	...
	v_mfma_f32_32x32x8_bf16 v[18:33], v[212:213], v[72:73], v[18:33]
...
.LBB0_18:
	ds_write_b128 v105, v[162:165] offset:8192
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[186:187], v[130:131], 0
	s_add_i32 s40, s37, -4
	v_mov_b32_e32 v83, s40
	s_mov_b32 s42, s87
	v_lshl_or_b32 v102, s42, 11, v104
	...
	s_waitcnt lgkmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[94:95], v[150:151], v[66:81]
	v_add_co_u32_e32 v94, vcc, s79, v102
	global_load_dwordx4 v[186:189], v[102:103], off offset:1536
	s_nop 0
	v_addc_co_u32_e32 v95, vcc, 0, v103, vcc
	global_load_dwordx4 v[174:177], v[94:95], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[96:97], v[152:153], v[66:81]
	s_waitcnt lgkmcnt(2)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[98:99], v[154:155], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[100:101], v[156:157], v[66:81]
	global_load_dwordx4 v[98:101], v[94:95], off offset:512
	global_load_dwordx4 v[190:193], v[94:95], off offset:1024
	s_nop 0
	global_load_dwordx4 v[94:97], v[94:95], off offset:1536
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[90:91], v[158:159], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[92:93], v[160:161], v[66:81]
	...
	ds_bpermute_b32 v84, v121, v83
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v84, v84, v84
	v_max_f32_e32 v84, v83, v84
	;;#ASMSTART
	v_add_f32 v83, v88, v123
	;;#ASMEND
	s_nop 0
...
.LBB0_22:
	...
	s_setprio 1
	s_waitcnt vmcnt(0)
	ds_read_b128 v[90:93], v106 offset:8192
	ds_read_b128 v[194:197], v114
	...
	ds_read_b128 v[198:201], v115
	ds_read_b128 v[202:205], v116
	...
	ds_read_b128 v[178:181], v117
	ds_read_b128 v[182:185], v118
	...
	ds_write_b128 v105, v[166:169]
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[90:91], v[130:131], 0
	v_mov_b32_e32 v83, s37
	v_lshl_or_b32 v90, s85, 11, v104
	v_ashrrev_i32_e32 v91, 31, v90
	v_lshl_add_u64 v[90:91], v[90:91], 2, s[0:1]
	s_add_i32 s40, s88, s19
	s_lshl_b32 s40, s40, 12
	v_mfma_f32_32x32x8_bf16 v[66:81], v[92:93], v[132:133], v[66:81]
	buffer_load_dword v83, v83, s[12:15], 0 offen
	s_waitcnt vmcnt(0)
	...
	global_load_dwordx4 v[202:205], v[90:91], off offset:512
	global_load_dwordx4 v[194:197], v[90:91], off offset:1024
	s_waitcnt lgkmcnt(4)
	...
	v_add_co_u32_e32 v90, vcc, s79, v90
	s_nop 1
	v_addc_co_u32_e32 v91, vcc, 0, v91, vcc
	global_load_dwordx4 v[198:201], v[90:91], off
	...
	global_load_dwordx4 v[210:213], v[90:91], off offset:512
	global_load_dwordx4 v[214:217], v[90:91], off offset:1024
	global_load_dwordx4 v[190:193], v[90:91], off offset:1536
	s_waitcnt lgkmcnt(1)
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v84, v84, v84
	v_max_f32_e32 v128, v83, v84
	;;#ASMSTART
	v_add_f32 v83, v88, v123
	;;#ASMEND
	v_mov_b32_e32 v84, v88
	v_cmp_gt_f32_e32 vcc, v128, v83
	v_mov_b32_e32 v83, 1.0
...
.LBB0_32:
	...
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[178:179], v[138:139], v[66:81]
	global_load_dwordx4 v[162:165], v[88:89], off
	;;#ASMSTART
	v_mov_b32 v88, v0
	;;#ASMEND
	s_nop 0
	...
	global_load_dwordx4 v[194:197], v[88:89], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[180:181], v[140:141], v[66:81]
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[170:171], v[142:143], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[172:173], v[144:145], v[66:81]
	global_load_dwordx4 v[206:209], v[88:89], off offset:512
	global_load_dwordx4 v[198:201], v[88:89], off offset:1024
	s_waitcnt lgkmcnt(4)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[174:175], v[146:147], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[176:177], v[148:149], v[66:81]
	s_waitcnt lgkmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[94:95], v[150:151], v[66:81]
	global_load_dwordx4 v[210:213], v[88:89], off offset:1536
	v_add_co_u32_e32 v88, vcc, s79, v88
	s_nop 1
	v_addc_co_u32_e32 v89, vcc, 0, v89, vcc
	global_load_dwordx4 v[202:205], v[88:89], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[96:97], v[152:153], v[66:81]
	s_waitcnt lgkmcnt(2)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[98:99], v[154:155], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[100:101], v[156:157], v[66:81]
	global_load_dwordx4 v[214:217], v[88:89], off offset:512
	global_load_dwordx4 v[218:221], v[88:89], off offset:1024
	global_load_dwordx4 v[190:193], v[88:89], off offset:1536
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[90:91], v[158:159], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[92:93], v[160:161], v[66:81]
	s_waitcnt vmcnt(9) lgkmcnt(0)
	...
	v_max3_f32 v83, v83, v78, v79
	v_max3_f32 v83, v83, v80, v81
	ds_bpermute_b32 v88, v121, v83
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v88, v88, v88
	v_max_f32_e32 v88, v83, v88
	;;#ASMSTART
	v_add_f32 v83, v84, v123
	;;#ASMEND
	s_nop 0
...
.LBB0_36:
	...
	ds_read_b128 v[182:185], v114
	v_mfma_f32_32x32x8_bf16 v[2:17], v[194:195], v[66:67], v[2:17]
	v_mfma_f32_32x32x8_bf16 v[18:33], v[206:207], v[66:67], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[198:199], v[66:67], v[34:49]
	ds_read_b128 v[178:181], v115
	ds_read_b128 v[170:173], v116
	v_mfma_f32_32x32x8_bf16 v[50:65], v[210:211], v[66:67], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[196:197], v[68:69], v[2:17]
	v_mfma_f32_32x32x8_bf16 v[18:33], v[208:209], v[68:69], v[18:33]
	ds_read_b128 v[174:177], v117
	ds_read_b128 v[94:97], v118
	v_mfma_f32_32x32x8_bf16 v[34:49], v[200:201], v[68:69], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[212:213], v[68:69], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[202:203], v[70:71], v[2:17]
	ds_read_b128 v[98:101], v119
	ds_read_b128 v[90:93], v120
	v_mfma_f32_32x32x8_bf16 v[18:33], v[214:215], v[70:71], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[218:219], v[70:71], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[190:191], v[70:71], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[204:205], v[72:73], v[2:17]
	...
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[178:179], v[138:139], v[66:81]
	global_load_dwordx4 v[166:169], v[88:89], off
	;;#ASMSTART
	v_mov_b32 v88, v0
	;;#ASMEND
	s_nop 0
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v88, v88, v88
	v_max_f32_e32 v129, v83, v88
	;;#ASMSTART
	v_add_f32 v83, v84, v123
	;;#ASMEND
	v_mov_b32_e32 v88, v84
	v_cmp_gt_f32_e32 vcc, v129, v83
	v_mov_b32_e32 v83, 1.0
	s_and_saveexec_b64 s[42:43], vcc
	s_cbranch_execz .LBB0_39
	;;#ASMSTART
	v_add_f32 v88, v129, v124
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v83, v84, v88
	v_exp_f32_e32 v83, v83
...
.LBB0_44:
	...
	;;#ASMSTART
	v_perm_b32 v28, v3, v2, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v5, v4, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v7, v6, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v9, v8, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v11, v10, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v13, v12, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v15, v14, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v17, v16, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v19, v18, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v21, v20, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v23, v22, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v74, v75, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v72, v73, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v70, v71, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v68, v69, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v66, v67, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v35, v34, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v37, v36, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v39, v38, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v41, v40, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v43, v42, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v45, v44, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v47, v46, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v49, v48, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v51, v50, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v53, v52, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v55, v54, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v57, v56, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v59, v58, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v61, v60, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v63, v62, s80
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v65, v64, s80
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v34, v0
	;;#ASMEND
...
.LBB0_62:
	...
	global_atomic_add v3, v122, v3, s[70:71] sc0
.LBB0_65:
	...
	global_store_dword v122, v2, s[16:17]
	s_waitcnt vmcnt(0)
.LBB0_66:
...
.LBB0_69:
	...
	global_load_dwordx2 v[2:3], v122, s[16:17] offset:4
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s14, v3
