...
.LBB0_77:
	...
	v_mov_b32 v106, v0
	;;#ASMEND
	s_addk_i32 s93, 0x3000
	v_lshlrev_b32_e32 v107, 3, v106
	v_bfe_i32 v106, v106, 5, 1
	v_and_b32_e32 v107, 0xf8, v107
	v_and_b32_e32 v106, 0x600, v106
	v_or3_b32 v106, v107, v106, s93
	v_ashrrev_i32_e32 v107, 31, v106
	v_lshl_add_u64 v[106:107], v[106:107], 1, s[52:53]
	global_load_dwordx4 v[108:111], v[106:107], off
	global_load_dwordx4 v[132:135], v[106:107], off offset:512
...
.LBB0_108:
	...
	v_and_b32_e32 v159, 8, v159
	v_add_u32_e32 v159, s87, v159
	v_add_u32_e32 v160, 0xffffff89, v159
	v_cmp_gt_i32_e32 vcc, s86, v160
	v_add_u32_e32 v160, 0xffffff8a, v159
	v_cmp_gt_i32_e64 s[0:1], s86, v160
	v_add_u32_e32 v160, 0xffffff8b, v159
	v_cmp_gt_i32_e64 s[4:5], s86, v160
	v_add_u32_e32 v160, 0xffffff8c, v159
	v_cmp_gt_i32_e64 s[6:7], s86, v160
	v_add_u32_e32 v160, 0xffffff8d, v159
	v_cmp_gt_i32_e64 s[8:9], s86, v160
	v_add_u32_e32 v160, 0xffffff8e, v159
	v_cmp_gt_i32_e64 s[10:11], s86, v160
	v_add_u32_e32 v160, 0xffffff8f, v159
	v_cmp_gt_i32_e64 s[12:13], s86, v160
	v_add_u32_e32 v160, 0xffffff90, v159
	v_cmp_gt_i32_e64 s[14:15], s86, v160
	v_add_u32_e32 v160, 0xffffff99, v159
	v_cmp_gt_i32_e64 s[16:17], s86, v160
	v_add_u32_e32 v160, 0xffffff9a, v159
	v_cmp_gt_i32_e64 s[18:19], s86, v160
	v_add_u32_e32 v160, 0xffffff9b, v159
	v_cmp_gt_i32_e64 s[20:21], s86, v160
	v_add_u32_e32 v160, 0xffffff9c, v159
	v_cmp_gt_i32_e64 s[22:23], s86, v160
	v_add_u32_e32 v160, 0xffffff9d, v159
	v_cmp_gt_i32_e64 s[24:25], s86, v160
	v_add_u32_e32 v160, 0xffffff9e, v159
	v_cmp_gt_i32_e64 s[26:27], s86, v160
	v_add_u32_e32 v160, 0xffffff9f, v159
	v_add_u32_e32 v159, 0xffffffa0, v159
	v_cmp_gt_i32_e64 s[28:29], s86, v160
	v_cmp_gt_i32_e64 s[30:31], s86, v159
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
...
.LBB0_110:
	...
	v_mov_b32 v106, v0
	;;#ASMEND
	s_mul_i32 s93, s67, 0x6000
	v_lshlrev_b32_e32 v107, 3, v106
	v_bfe_i32 v106, v106, 5, 1
	s_add_i32 s93, s93, s66
	v_and_b32_e32 v107, 0xf8, v107
	v_and_b32_e32 v106, 0x600, v106
	v_or3_b32 v106, v107, v106, s93
	v_ashrrev_i32_e32 v107, 31, v106
...
.LBB0_114:
	...
	v_and_b32_e32 v159, 8, v159
	v_add_u32_e32 v159, s87, v159
	v_add_u32_e32 v160, 0xffffffa9, v159
	v_cmp_gt_i32_e32 vcc, s86, v160
	v_add_u32_e32 v160, 0xffffffaa, v159
	v_cmp_gt_i32_e64 s[0:1], s86, v160
	v_add_u32_e32 v160, 0xffffffab, v159
	v_cmp_gt_i32_e64 s[4:5], s86, v160
	v_add_u32_e32 v160, 0xffffffac, v159
	v_cmp_gt_i32_e64 s[6:7], s86, v160
	v_add_u32_e32 v160, 0xffffffad, v159
	v_cmp_gt_i32_e64 s[8:9], s86, v160
	v_add_u32_e32 v160, 0xffffffae, v159
	v_cmp_gt_i32_e64 s[10:11], s86, v160
	v_add_u32_e32 v160, 0xffffffaf, v159
	v_cmp_gt_i32_e64 s[12:13], s86, v160
	v_add_u32_e32 v160, 0xffffffb0, v159
	v_cmp_gt_i32_e64 s[14:15], s86, v160
	v_add_u32_e32 v160, 0xffffffb9, v159
	v_cmp_gt_i32_e64 s[16:17], s86, v160
	v_add_u32_e32 v160, 0xffffffba, v159
	v_cmp_gt_i32_e64 s[18:19], s86, v160
	v_add_u32_e32 v160, 0xffffffbb, v159
	v_cmp_gt_i32_e64 s[20:21], s86, v160
	v_add_u32_e32 v160, 0xffffffbc, v159
	v_cmp_gt_i32_e64 s[22:23], s86, v160
	v_add_u32_e32 v160, 0xffffffbd, v159
	v_cmp_gt_i32_e64 s[24:25], s86, v160
	v_add_u32_e32 v160, 0xffffffbe, v159
	v_cmp_gt_i32_e64 s[26:27], s86, v160
	v_add_u32_e32 v160, 0xffffffbf, v159
	v_subrev_u32_e32 v159, 64, v159
	v_cmp_gt_i32_e64 s[28:29], s86, v160
	v_cmp_gt_i32_e64 s[30:31], s86, v159
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
...
.LBB0_126:
	...
	v_and_b32_e32 v159, 8, v159
	v_add_u32_e32 v159, s87, v159
	v_subrev_u32_e32 v160, 23, v159
	v_cmp_gt_i32_e32 vcc, s86, v160
	v_subrev_u32_e32 v160, 22, v159
	v_cmp_gt_i32_e64 s[0:1], s86, v160
	v_subrev_u32_e32 v160, 21, v159
	v_cmp_gt_i32_e64 s[4:5], s86, v160
	v_subrev_u32_e32 v160, 20, v159
	v_cmp_gt_i32_e64 s[6:7], s86, v160
	v_subrev_u32_e32 v160, 19, v159
	v_cmp_gt_i32_e64 s[8:9], s86, v160
	v_subrev_u32_e32 v160, 18, v159
	v_cmp_gt_i32_e64 s[10:11], s86, v160
	v_subrev_u32_e32 v160, 17, v159
	v_cmp_gt_i32_e64 s[12:13], s86, v160
	v_add_u32_e32 v160, -16, v159
	v_cmp_gt_i32_e64 s[14:15], s86, v160
	v_add_u32_e32 v160, -7, v159
	v_cmp_gt_i32_e64 s[16:17], s86, v160
	v_add_u32_e32 v160, -6, v159
	v_cmp_gt_i32_e64 s[18:19], s86, v160
	v_add_u32_e32 v160, -5, v159
	v_cmp_gt_i32_e64 s[20:21], s86, v160
	v_add_u32_e32 v160, -4, v159
	v_cmp_gt_i32_e64 s[22:23], s86, v160
	v_add_u32_e32 v160, -3, v159
	v_cmp_gt_i32_e64 s[24:25], s86, v160
	v_add_u32_e32 v160, -2, v159
	v_cmp_gt_i32_e64 s[26:27], s86, v160
	v_add_u32_e32 v160, -1, v159
	v_cmp_gt_i32_e64 s[28:29], s86, v160
	v_cmp_gt_i32_e64 s[30:31], s86, v159
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
...
.LBB0_162:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v154, v3, s[62:63] sc0
.LBB0_166:
