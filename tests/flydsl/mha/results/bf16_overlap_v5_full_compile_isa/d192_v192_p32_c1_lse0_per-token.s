...
.LBB0_13:
	...
	s_mul_i32 s17, s47, 0xc0
	s_mov_b32 s11, s7
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s38, v2
	s_add_i32 s5, s38, s42
	...
	s_add_u32 s4, s28, s4
	v_and_or_b32 v2, v6, s49, v2
	s_addc_u32 s5, s29, s5
	s_lshl_b32 s36, s47, 2
	s_lshl_b32 s6, s43, 6
	s_and_b32 s5, s5, 0xffff
	v_lshl_add_u32 v2, v2, 6, s36
	...
	buffer_load_dwordx4 v[174:177], v6, s[8:11], 0 offen
	buffer_load_dwordx4 v[178:181], v6, s[8:11], 0 offen offset:32
	buffer_load_dwordx4 v[182:185], v6, s[8:11], 0 offen offset:64
	buffer_load_dwordx4 v[186:189], v6, s[8:11], 0 offen offset:96
	buffer_load_dwordx4 v[190:193], v6, s[8:11], 0 offen offset:128
	buffer_load_dwordx4 v[194:197], v6, s[8:11], 0 offen offset:160
	buffer_load_dwordx4 v[198:201], v6, s[8:11], 0 offen offset:192
	buffer_load_dwordx4 v[202:205], v6, s[8:11], 0 offen offset:224
	buffer_load_dwordx4 v[206:209], v6, s[8:11], 0 offen offset:256
	buffer_load_dwordx4 v[210:213], v6, s[8:11], 0 offen offset:288
	buffer_load_dwordx4 v[214:217], v6, s[8:11], 0 offen offset:320
	buffer_load_dwordx4 v[218:221], v6, s[8:11], 0 offen offset:352
	s_waitcnt vmcnt(14)
...
.LBB0_52:
	...
	v_and_or_b32 v132, v132, s49, v155
	v_add_u32_e32 v141, s61, v133
	v_add_u32_e32 v140, s58, v132
...
.LBB0_61:
	...
	v_lshrrev_b32_e32 v132, 1, v132
	v_and_or_b32 v132, v132, s49, v155
	v_add_u32_e32 v133, s61, v133
	v_add_u32_e32 v132, s58, v132
...
.LBB0_65:
	...
	s_branch .LBB0_47
.LBB0_66:
	ds_bpermute_b32 v98, v149, v154
	s_waitcnt lgkmcnt(0)
	;;#ASMSTART
	v_add_f32 v98, v154, v98
	;;#ASMEND
	s_nop 0
	v_div_scale_f32 v99, s[4:5], v98, v98, s46
...
.LBB0_99:
	...
	v_mov_b32_e32 v3, s6
	global_atomic_add v3, v150, v3, s[34:35] sc0
.LBB0_103:
	s_or_b64 exec, exec, s[8:9]
