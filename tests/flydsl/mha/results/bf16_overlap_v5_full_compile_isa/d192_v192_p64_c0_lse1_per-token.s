...
.LBB0_46:
	...
	v_lshrrev_b32_e32 v224, 3, v159
	v_and_b32_e32 v224, 56, v224
	v_xor_b32_e32 v159, v224, v159
...
.LBB0_54:
	...
	v_mfma_f32_32x32x8_bf16 v[98:113], v[224:225], v[176:177], 0
	v_mfma_f32_32x32x8_bf16 v[98:113], v[226:227], v[178:179], v[98:113]
	v_or_b32_e32 v224, 16, v158
	v_xor_b32_e32 v224, v224, v159
	v_lshlrev_b32_e32 v224, 1, v224
	ds_read_b128 v[224:227], v224
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[224:225], v[180:181], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[226:227], v[182:183], v[98:113]
	v_or_b32_e32 v224, 32, v158
	v_xor_b32_e32 v224, v224, v159
	v_lshlrev_b32_e32 v224, 1, v224
	ds_read_b128 v[224:227], v224
	s_waitcnt lgkmcnt(0)
...
.LBB0_84:
	...
	v_add_u32_e32 v158, s94, v158
	v_subrev_u32_e32 v159, 55, v158
	v_cmp_gt_i32_e32 vcc, s93, v159
	v_subrev_u32_e32 v159, 54, v158
	v_cmp_gt_i32_e64 s[0:1], s93, v159
	v_subrev_u32_e32 v159, 53, v158
	v_cmp_gt_i32_e64 s[4:5], s93, v159
	v_subrev_u32_e32 v159, 52, v158
	v_cmp_gt_i32_e64 s[6:7], s93, v159
	v_subrev_u32_e32 v159, 51, v158
	v_cmp_gt_i32_e64 s[8:9], s93, v159
	v_subrev_u32_e32 v159, 50, v158
	v_cmp_gt_i32_e64 s[10:11], s93, v159
	v_subrev_u32_e32 v159, 49, v158
	v_cmp_gt_i32_e64 s[12:13], s93, v159
	v_subrev_u32_e32 v159, 48, v158
	v_cmp_gt_i32_e64 s[14:15], s93, v159
	v_subrev_u32_e32 v159, 39, v158
	v_cmp_gt_i32_e64 s[16:17], s93, v159
	v_subrev_u32_e32 v159, 38, v158
	v_cmp_gt_i32_e64 s[18:19], s93, v159
	v_subrev_u32_e32 v159, 37, v158
	v_cmp_gt_i32_e64 s[20:21], s93, v159
	v_subrev_u32_e32 v159, 36, v158
	v_cmp_gt_i32_e64 s[22:23], s93, v159
	v_subrev_u32_e32 v159, 35, v158
	v_cmp_gt_i32_e64 s[24:25], s93, v159
	v_subrev_u32_e32 v159, 34, v158
	v_cmp_gt_i32_e64 s[26:27], s93, v159
	v_subrev_u32_e32 v159, 33, v158
	v_subrev_u32_e32 v158, 32, v158
	v_cmp_gt_i32_e64 s[28:29], s93, v159
	v_cmp_gt_i32_e64 s[30:31], s93, v158
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
	s_or_b64 s[24:25], s[26:27], s[24:25]
	s_or_b64 s[22:23], s[24:25], s[22:23]
...
.LBB0_132:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v152, v3, s[66:67] sc0
.LBB0_136:
