...
.LBB0_9:
	...
	v_and_b32_e32 v116, 31, v0
	v_xor_b32_e32 v117, 0x80, v2
	v_mov_b32_e32 v118, 0
	s_movk_i32 s75, 0xc00
	s_mov_b32 s7, 0x27000
	s_movk_i32 s76, 0xe0
	s_movk_i32 s77, 0x180
	v_mov_b32_e32 v119, 0x40e00000
	v_mov_b32_e32 v120, 1.0
	s_mov_b32 s78, 0x7060302
	s_movk_i32 s79, 0x1000
	s_mov_b32 s80, 0x800000
	s_movk_i32 s81, 0xf80
	s_mov_b32 s82, s2
	v_mov_b32_e32 v121, 0xff800000
	v_mov_b32_e32 v122, 0x42000000
	s_mov_b32 s36, 0
	s_branch .LBB0_13
.LBB0_11:
	s_mov_b32 s72, s6
...
.LBB0_13:
	s_ashr_i32 s13, s12, 31
	s_lshl_b32 s87, s33, 8
	s_lshl_b64 s[0:1], s[12:13], 2
	s_add_u32 s4, s8, s0
	s_addc_u32 s5, s9, s1
	global_load_dwordx2 v[2:3], v118, s[4:5]
	s_mov_b32 s47, s7
	s_mul_i32 s23, s22, 0xc0
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s40, v2
	s_add_i32 s68, s40, s87
	...
	global_load_dwordx2 v[4:5], v118, s[38:39]
	global_load_dword v3, v118, s[0:1]
	...
	buffer_load_dword v2, v2, s[44:47], 0 offen
	;;#ASMSTART
	v_mov_b32 v6, v0
	;;#ASMEND
	...
	v_mad_u32_u24 v6, v7, s75, v6
	v_add_lshl_u32 v6, v6, v8, 1
	buffer_load_dwordx4 v[144:147], v6, s[4:7], 0 offen
	buffer_load_dwordx4 v[148:151], v6, s[4:7], 0 offen offset:32
	buffer_load_dwordx4 v[152:155], v6, s[4:7], 0 offen offset:64
	buffer_load_dwordx4 v[156:159], v6, s[4:7], 0 offen offset:96
	buffer_load_dwordx4 v[160:163], v6, s[4:7], 0 offen offset:128
	buffer_load_dwordx4 v[164:167], v6, s[4:7], 0 offen offset:160
	buffer_load_dwordx4 v[168:171], v6, s[4:7], 0 offen offset:192
	buffer_load_dwordx4 v[172:175], v6, s[4:7], 0 offen offset:224
	buffer_load_dwordx4 v[176:179], v6, s[4:7], 0 offen offset:256
	buffer_load_dwordx4 v[180:183], v6, s[4:7], 0 offen offset:288
	buffer_load_dwordx4 v[184:187], v6, s[4:7], 0 offen offset:320
	buffer_load_dwordx4 v[188:191], v6, s[4:7], 0 offen offset:352
	s_waitcnt vmcnt(14)
...
.LBB0_15:
	...
	s_mul_i32 s42, s91, 0xc00
	v_add_u32_sdwa v4, s42, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
...
.LBB0_19:
	...
	ds_write_b128 v85, v[132:135] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[38:39]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_23:
	...
	s_sub_i32 s84, s38, 32
	s_add_i32 s90, s84, s87
	s_add_i32 s37, s90, 1
	...
	s_cselect_b64 s[40:41], -1, 0
	s_and_b64 s[38:39], s[40:41], s[38:39]
	s_subb_u32 s89, s42, 0
	s_lshl_b32 s70, s89, 1
...
.LBB0_25:
	...
	;;#ASMSTART
	v_perm_b32 v72, v67, v66, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v73, v69, v68, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v70, v71, v70, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v71, v100, v101, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v68, v75, v74, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v69, v77, v76, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v66, v79, v78, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v67, v81, v80, s78
	;;#ASMEND
	s_barrier
	s_setprio 1
	;;#ASMSTART
	...
	global_load_dwordx4 v[194:197], v[74:75], off offset:512
	global_load_dwordx4 v[202:205], v[74:75], off offset:1024
	global_load_dwordx4 v[206:209], v[74:75], off offset:1536
	v_add_co_u32_e32 v74, vcc, s79, v74
	s_nop 1
	v_addc_co_u32_e32 v75, vcc, 0, v75, vcc
	global_load_dwordx4 v[124:127], v[74:75], off
	global_load_dwordx4 v[214:217], v[74:75], off offset:512
	...
	ds_read_b128 v[200:203], v72
	ds_read_b128 v[196:199], v73
	v_mfma_f32_32x32x8_bf16 v[34:49], v[204:205], v[70:71], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[208:209], v[70:71], v[50:65]
	...
	v_mfma_f32_32x32x8_bf16 v[2:17], v[124:125], v[68:69], v[2:17]
	v_lshlrev_b32_e32 v70, 1, v70
	ds_read_b128 v[204:207], v71
	v_add_u32_e32 v71, 0x90, v100
	ds_read_b128 v[208:211], v70
	v_add_u32_e32 v70, 0x80, v100
	v_lshrrev_b32_e32 v73, 3, v71
	v_lshrrev_b32_e32 v72, 3, v70
	v_mfma_f32_32x32x8_bf16 v[18:33], v[214:215], v[68:69], v[18:33]
	v_and_b32_e32 v72, 56, v72
	...
	ds_read_b128 v[224:227], v69
	v_lshrrev_b32_e32 v69, 3, v68
	v_and_b32_e32 v69, 56, v69
	v_xor_b32_e32 v68, v69, v68
	v_lshlrev_b32_e32 v68, 1, v68
	v_mfma_f32_32x32x8_bf16 v[2:17], v[126:127], v[66:67], v[2:17]
...
.LBB0_26:
	...
	ds_write_b128 v85, v[136:139] offset:12288
	ds_write_b128 v85, v[140:143] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[40:41]
	;;#ASMSTART
	v_mov_b32 v66, v0
	...
	v_add_u32_sdwa v66, s44, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
...
.LBB0_30:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[110:111], v[144:145], 0
	v_mfma_f32_32x32x8_bf16 v[66:81], v[112:113], v[146:147], v[66:81]
	s_waitcnt lgkmcnt(10)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[102:103], v[148:149], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[104:105], v[150:151], v[66:81]
	s_waitcnt lgkmcnt(9)
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[222:223], v[190:191], v[66:81]
	s_waitcnt vmcnt(2) lgkmcnt(0)
	s_barrier
	s_setprio 0
	s_nop 7
...
.LBB0_34:
	...
	v_add_u32_e32 v70, 0x8000, v70
	;;#ASMSTART
	v_perm_b32 v74, v67, v66, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v75, v69, v68, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v76, v71, v70, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v77, v73, v72, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v68, v102, v103, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v69, v84, v101, s78
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v66, v79, v78, s78
	;;#ASMEND
	...
	v_mov_b32 v70, v0
	;;#ASMEND
	s_add_i32 s40, s91, s69
	v_lshlrev_b32_e32 v71, 3, v70
	v_lshlrev_b32_e32 v70, 5, v70
	s_lshl_b32 s40, s40, 12
	v_and_b32_e32 v71, 0xf8, v71
	v_and_b32_e32 v70, 0x400, v70
	v_or3_b32 v70, v71, v70, s40
	v_ashrrev_i32_e32 v71, 31, v70
	v_lshl_add_u64 v[70:71], v[70:71], 1, s[18:19]
	global_load_dwordx4 v[124:127], v[70:71], off
	global_load_dwordx4 v[194:197], v[70:71], off offset:512
	global_load_dwordx4 v[202:205], v[70:71], off offset:1024
	global_load_dwordx4 v[206:209], v[70:71], off offset:1536
	v_add_co_u32_e32 v70, vcc, s79, v70
	s_nop 1
	v_addc_co_u32_e32 v71, vcc, 0, v71, vcc
	global_load_dwordx4 v[210:213], v[70:71], off
	global_load_dwordx4 v[222:225], v[70:71], off offset:512
	global_load_dwordx4 v[226:229], v[70:71], off offset:1024
	s_nop 0
	...
	v_mfma_f32_32x32x8_bf16 v[2:17], v[124:125], v[74:75], v[2:17]
	v_mfma_f32_32x32x8_bf16 v[18:33], v[194:195], v[74:75], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[202:203], v[74:75], v[34:49]
	ds_read_b128 v[192:195], v79
	ds_read_b128 v[106:109], v80
	v_mfma_f32_32x32x8_bf16 v[50:65], v[206:207], v[74:75], v[50:65]
	...
	v_mfma_f32_32x32x8_bf16 v[2:17], v[126:127], v[76:77], v[2:17]
	v_xor_b32_e32 v75, v80, v75
	v_lshlrev_b32_e32 v74, 1, v74
	v_lshlrev_b32_e32 v75, 1, v75
	v_mfma_f32_32x32x8_bf16 v[18:33], v[196:197], v[76:77], v[18:33]
	ds_read_b128 v[200:203], v74
	ds_read_b128 v[124:127], v75
	v_add_u32_e32 v75, 0x1870, v78
	v_add_u32_e32 v74, 0x1860, v78
	v_mfma_f32_32x32x8_bf16 v[34:49], v[204:205], v[76:77], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[208:209], v[76:77], v[50:65]
	...
	ds_read_b128 v[220:223], v69
	v_lshrrev_b32_e32 v69, 3, v68
	v_and_b32_e32 v69, 56, v69
	v_xor_b32_e32 v68, v69, v68
	v_lshlrev_b32_e32 v68, 1, v68
	v_mfma_f32_32x32x8_bf16 v[2:17], v[212:213], v[66:67], v[2:17]
...
.LBB0_38:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v101, v101, v101
	v_max_f32_e32 v125, v84, v101
	;;#ASMSTART
	v_add_f32 v84, v100, v119
	;;#ASMEND
	v_mov_b32_e32 v101, v100
	v_cmp_gt_f32_e32 vcc, v125, v84
	...
	;;#ASMSTART
	v_add_f32 v84, v125, v120
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v100, v100, v84
	v_exp_f32_e32 v124, v100
	v_mov_b32_e32 v100, v84
...
.LBB0_44:
	...
	v_mov_b32_e32 v98, v82
	v_mov_b32_e32 v99, v82
	v_or_b32_e32 v124, s87, v116
	s_or_b32 s37, s37, 55
	s_lshl3_add_u32 s44, s89, 20
	s_branch .LBB0_48
.LBB0_46:
	...
	s_nop 1
	v_addc_co_u32_e32 v75, vcc, 0, v75, vcc
	global_load_dwordx4 v[214:217], v[74:75], off
	global_load_dwordx4 v[218:221], v[74:75], off offset:512
	global_load_dwordx4 v[78:81], v[74:75], off offset:1024
	s_nop 0
	global_load_dwordx4 v[74:77], v[74:75], off offset:1536
	s_waitcnt vmcnt(0)
...
.LBB0_47:
	...
	s_cselect_b32 s91, s83, s85
	s_cselect_b32 s85, s86, s83
	s_cselect_b32 s83, s45, s86
	s_add_u32 s70, s70, 2
...
.LBB0_52:
	...
	v_and_or_b32 v100, v100, s76, v124
	v_add_u32_e32 v109, s37, v101
	v_add_u32_e32 v108, s84, v100
...
.LBB0_59:
	...
	v_add_u32_sdwa v66, s47, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_ashrrev_i32_e32 v67, 31, v66
	v_lshl_add_u64 v[66:67], v[66:67], 2, s[0:1]
	global_load_dwordx4 v[128:131], v[66:67], off
	global_load_dwordx4 v[132:135], v[66:67], off offset:256
.LBB0_61:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v101, v101, v101
	v_max_f32_e32 v126, v100, v101
	;;#ASMSTART
	v_add_f32 v100, v84, v119
	;;#ASMEND
	v_mov_b32_e32 v101, v84
	v_cmp_gt_f32_e32 vcc, v126, v100
	v_mov_b32_e32 v100, v84
	s_and_saveexec_b64 s[42:43], vcc
	s_cbranch_execz .LBB0_63
	;;#ASMSTART
	v_add_f32 v100, v126, v120
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v84, v84, v100
	v_exp_f32_e32 v125, v84
	v_mov_b32_e32 v84, v100
	v_mov_b32_e32 v101, v100
	v_mov_b32_e32 v102, v100
	v_mov_b32_e32 v103, v100
...
.LBB0_66:
	...
	v_mov_b32 v68, v0
	;;#ASMEND
	ds_bpermute_b32 v66, v117, v123
	v_lshrrev_b32_e32 v67, 1, v68
	v_and_b32_e32 v69, 31, v68
	v_and_or_b32 v67, v67, s76, v69
	...
	v_cndmask_b32_e32 v68, 0, v122, vcc
	s_add_u32 s6, s30, s4
...
.LBB0_86:
	...
	v_mov_b32_e32 v3, s6
	global_atomic_add v3, v118, v3, s[34:35] sc0
.LBB0_89:
	s_or_b64 exec, exec, s[38:39]
	...
	global_store_dword v118, v2, s[38:39]
	s_waitcnt vmcnt(0)
.LBB0_90:
	...
	s_barrier
	global_load_dword v2, v118, s[0:1]
	s_waitcnt vmcnt(0)
	s_barrier
...
.LBB0_93:
	...
	s_add_u32 s12, s8, s12
	s_addc_u32 s13, s9, s13
	global_load_dwordx2 v[2:3], v118, s[12:13] offset:4
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s6, v3
...
.Lfunc_end0:
	...
	.set .Lattn_kernel_0.numbered_sgpr, 92
