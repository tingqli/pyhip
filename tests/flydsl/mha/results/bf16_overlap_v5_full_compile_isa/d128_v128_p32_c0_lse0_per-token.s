...
.LBB0_9:
	...
	s_load_dwordx2 s[90:91], s[0:1], 0x70
	...
	v_lshlrev_b32_e32 v132, 1, v2
	v_and_b32_e32 v2, 63, v0
	v_lshlrev_b32_e32 v2, 2, v2
	v_lshlrev_b32_e32 v1, 6, v1
	v_xor_b32_e32 v133, 0x80, v2
...
.LBB0_13:
	...
	global_load_dwordx2 v[2:3], v134, s[4:5]
	s_mov_b32 s75, s71
	...
	global_load_dwordx2 v[4:5], v134, s[4:5]
	global_load_dword v3, v134, s[0:1]
...
.LBB0_15:
	...
	s_barrier
	s_setprio 1
	ds_read_b128 v[198:201], v118
	ds_read_b128 v[194:197], v119
	ds_read_b128 v[190:193], v120
	ds_read_b128 v[182:185], v121
	ds_read_b128 v[186:189], v122
	ds_read_b128 v[106:109], v123
	ds_read_b128 v[110:113], v124
	ds_read_b128 v[102:105], v125
	s_add_i32 s0, s72, -2
	s_bitcmp0_b32 s72, 0
...
.LBB0_17:
	...
	;;#ASMSTART
	v_perm_b32 v66, v67, v66, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v67, v69, v68, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v68, v71, v70, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v69, v73, v72, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v70, v75, v74, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v71, v77, v76, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v72, v79, v78, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v73, v81, v80, s86
	;;#ASMEND
	s_barrier
	s_setprio 1
	s_waitcnt vmcnt(0)
	...
	v_mfma_f32_32x32x8_bf16 v[18:33], v[214:215], v[66:67], v[18:33]
	...
	ds_read_b128 v[110:113], v124
	ds_read_b128 v[102:105], v125
	v_mfma_f32_32x32x8_bf16 v[18:33], v[222:223], v[70:71], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[226:227], v[70:71], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[202:203], v[70:71], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[212:213], v[72:73], v[2:17]
	v_mfma_f32_32x32x8_bf16 v[18:33], v[224:225], v[72:73], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[228:229], v[72:73], v[34:49]
...
.LBB0_18:
	ds_write_b128 v117, v[174:177] offset:8192
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[198:199], v[142:143], 0
	s_add_i32 s4, s9, -4
	...
	global_load_dwordx4 v[174:177], v[114:115], off
	;;#ASMSTART
	v_mov_b32 v101, v0
	;;#ASMEND
	s_nop 0
	...
	v_or3_b32 v114, v114, v101, s4
	v_ashrrev_i32_e32 v115, 31, v114
	v_lshl_add_u64 v[114:115], v[114:115], 1, s[84:85]
	global_load_dwordx4 v[194:197], v[114:115], off
	...
	global_load_dwordx4 v[190:193], v[114:115], off offset:512
	...
	v_add_co_u32_e32 v106, vcc, s83, v114
	global_load_dwordx4 v[198:201], v[114:115], off offset:1536
	s_nop 0
...
.LBB0_22:
	...
	s_setprio 1
	s_waitcnt vmcnt(0)
	ds_read_b128 v[102:105], v118 offset:8192
	ds_read_b128 v[206:209], v126
	...
	ds_read_b128 v[210:213], v127
	ds_read_b128 v[214:217], v128
	...
	ds_read_b128 v[190:193], v129
	ds_read_b128 v[194:197], v130
	...
	ds_read_b128 v[198:201], v131
	ds_read_b128 v[230:233], v132
	...
	ds_write_b128 v117, v[178:181]
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[102:103], v[142:143], 0
	v_mov_b32_e32 v84, s9
	v_lshl_or_b32 v102, s87, 11, v116
	v_ashrrev_i32_e32 v103, 31, v102
	v_lshl_add_u64 v[102:103], v[102:103], 2, s[98:99]
	s_add_i32 s4, s89, s75
	s_lshl_b32 s4, s4, 12
	v_mfma_f32_32x32x8_bf16 v[66:81], v[104:105], v[144:145], v[66:81]
	buffer_load_dword v84, v84, s[68:71], 0 offen
	s_waitcnt vmcnt(0)
	...
	global_load_dwordx4 v[214:217], v[102:103], off offset:512
	global_load_dwordx4 v[206:209], v[102:103], off offset:1024
	s_waitcnt lgkmcnt(4)
	...
	global_load_dwordx4 v[210:213], v[102:103], off
	...
	global_load_dwordx4 v[226:229], v[102:103], off offset:1024
	global_load_dwordx4 v[202:205], v[102:103], off offset:1536
	s_waitcnt lgkmcnt(1)
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v101, v101, v101
	v_max_f32_e32 v140, v84, v101
	;;#ASMSTART
	v_add_f32 v84, v100, v135
	;;#ASMEND
	v_mov_b32_e32 v101, v100
	v_cmp_gt_f32_e32 vcc, v140, v84
	...
	;;#ASMSTART
	v_add_f32 v84, v140, v136
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v100, v100, v84
	v_exp_f32_e32 v139, v100
	v_mov_b32_e32 v100, v84
...
.LBB0_29:
	...
	ds_read_b128 v[190:193], v120
	ds_read_b128 v[182:185], v121
	v_mfma_f32_32x32x8_bf16 v[50:65], v[222:223], v[66:67], v[50:65]
...
.LBB0_30:
	...
	s_cselect_b32 s6, s87, s89
	s_cselect_b32 s89, s88, s87
	s_cselect_b32 s87, s43, s88
	s_add_u32 s76, s76, 2
...
.LBB0_31:
	...
	v_lshl_or_b32 v100, s88, 11, v116
	...
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[190:191], v[150:151], v[66:81]
	global_load_dwordx4 v[174:177], v[100:101], off
	;;#ASMSTART
	v_mov_b32 v100, v0
	;;#ASMEND
	s_nop 0
	...
	global_load_dwordx4 v[206:209], v[100:101], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[192:193], v[152:153], v[66:81]
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[182:183], v[154:155], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[184:185], v[156:157], v[66:81]
	global_load_dwordx4 v[218:221], v[100:101], off offset:512
	global_load_dwordx4 v[210:213], v[100:101], off offset:1024
	s_waitcnt lgkmcnt(4)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[186:187], v[158:159], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[188:189], v[160:161], v[66:81]
	s_waitcnt lgkmcnt(3)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[106:107], v[162:163], v[66:81]
	global_load_dwordx4 v[222:225], v[100:101], off offset:1536
	v_add_co_u32_e32 v100, vcc, s83, v100
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v101, vcc
	global_load_dwordx4 v[214:217], v[100:101], off
	v_mfma_f32_32x32x8_bf16 v[66:81], v[108:109], v[164:165], v[66:81]
	s_waitcnt lgkmcnt(2)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[110:111], v[166:167], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[112:113], v[168:169], v[66:81]
	global_load_dwordx4 v[226:229], v[100:101], off offset:512
	global_load_dwordx4 v[230:233], v[100:101], off offset:1024
	global_load_dwordx4 v[202:205], v[100:101], off offset:1536
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[102:103], v[170:171], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[104:105], v[172:173], v[66:81]
	s_waitcnt vmcnt(9) lgkmcnt(0)
	...
	v_cndmask_b32_e64 v105, v137, v67, s[0:1]
	v_cndmask_b32_e32 v104, v137, v66, vcc
	...
	v_cndmask_b32_e64 v101, v137, v71, s[10:11]
	v_cndmask_b32_e64 v100, v137, v70, s[8:9]
	v_cndmask_b32_e64 v103, v137, v69, s[6:7]
	v_cndmask_b32_e64 v102, v137, v68, s[4:5]
	...
	ds_bpermute_b32 v101, v133, v100
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v101, v101, v101
	v_max_f32_e32 v101, v100, v101
	;;#ASMSTART
	v_add_f32 v100, v84, v135
	;;#ASMEND
	s_nop 0
...
.LBB0_35:
	...
	s_setprio 1
	s_waitcnt vmcnt(0)
	ds_read_b128 v[198:201], v118 offset:8192
	ds_read_b128 v[194:197], v126
	v_mfma_f32_32x32x8_bf16 v[2:17], v[206:207], v[66:67], v[2:17]
	v_mfma_f32_32x32x8_bf16 v[18:33], v[218:219], v[66:67], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[210:211], v[66:67], v[34:49]
	ds_read_b128 v[190:193], v127
	ds_read_b128 v[182:185], v128
	v_mfma_f32_32x32x8_bf16 v[50:65], v[222:223], v[66:67], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[208:209], v[68:69], v[2:17]
	v_mfma_f32_32x32x8_bf16 v[18:33], v[220:221], v[68:69], v[18:33]
	ds_read_b128 v[186:189], v129
	ds_read_b128 v[106:109], v130
	v_mfma_f32_32x32x8_bf16 v[34:49], v[212:213], v[68:69], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[224:225], v[68:69], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[214:215], v[70:71], v[2:17]
	ds_read_b128 v[110:113], v131
	ds_read_b128 v[102:105], v132
	v_mfma_f32_32x32x8_bf16 v[18:33], v[226:227], v[70:71], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[230:231], v[70:71], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[202:203], v[70:71], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[216:217], v[72:73], v[2:17]
	...
	v_max_f32_e32 v140, v80, v81
	;;#ASMSTART
	v_add_f32 v80, v84, v135
	;;#ASMEND
	v_mov_b32_e32 v81, v84
	v_cmp_gt_f32_e32 vcc, v140, v80
	...
	;;#ASMSTART
	v_add_f32 v80, v140, v136
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v81, v84, v80
	v_exp_f32_e32 v139, v81
...
.LBB0_40:
	...
	s_branch .LBB0_30
.LBB0_41:
	ds_bpermute_b32 v66, v133, v138
	s_waitcnt lgkmcnt(0)
	;;#ASMSTART
	v_add_f32 v66, v138, v66
	;;#ASMEND
	s_nop 0
	...
	;;#ASMSTART
	v_perm_b32 v28, v3, v2, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v29, v5, v4, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v32, v7, v6, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v33, v9, v8, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v30, v11, v10, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v31, v13, v12, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v26, v15, v14, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v27, v17, v16, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v24, v19, v18, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v25, v21, v20, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v22, v23, v22, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v23, v74, v75, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v20, v72, v73, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v21, v70, v71, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v18, v68, v69, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v19, v66, v67, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v16, v35, v34, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v17, v37, v36, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v14, v39, v38, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v15, v41, v40, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v12, v43, v42, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v13, v45, v44, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v10, v47, v46, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v11, v49, v48, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v8, v51, v50, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v9, v53, v52, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v6, v55, v54, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v7, v57, v56, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v4, v59, v58, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v5, v61, v60, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v2, v63, v62, s86
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v3, v65, v64, s86
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v34, v0
	;;#ASMEND
...
.LBB0_59:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v134, v3, s[94:95] sc0
.LBB0_62:
	...
	global_store_dword v134, v2, s[6:7]
	s_waitcnt vmcnt(0)
.LBB0_63:
	s_or_b64 exec, exec, s[4:5]
	s_lshl_b64 s[0:1], s[0:1], 2
	...
	s_barrier
	global_load_dword v2, v134, s[0:1]
	s_waitcnt vmcnt(0)
	s_barrier
	v_readfirstlane_b32 s4, v2
	s_add_i32 s0, s4, s33
...
.LBB0_66:
	...
	global_load_dwordx2 v[2:3], v134, s[6:7] offset:4
	s_waitcnt vmcnt(0)
