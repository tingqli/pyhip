...
.LBB0_13:
	...
	v_mad_u32_u24 v6, v7, s76, v6
	v_add_lshl_u32 v6, v6, v8, 1
	buffer_load_dwordx4 v[172:175], v6, s[40:43], 0 offen
	buffer_load_dwordx4 v[176:179], v6, s[40:43], 0 offen offset:32
	buffer_load_dwordx4 v[180:183], v6, s[40:43], 0 offen offset:64
	buffer_load_dwordx4 v[184:187], v6, s[40:43], 0 offen offset:96
	buffer_load_dwordx4 v[188:191], v6, s[40:43], 0 offen offset:128
	buffer_load_dwordx4 v[192:195], v6, s[40:43], 0 offen offset:160
	buffer_load_dwordx4 v[196:199], v6, s[40:43], 0 offen offset:192
	buffer_load_dwordx4 v[200:203], v6, s[40:43], 0 offen offset:224
	buffer_load_dwordx4 v[204:207], v6, s[40:43], 0 offen offset:256
	buffer_load_dwordx4 v[208:211], v6, s[40:43], 0 offen offset:288
	buffer_load_dwordx4 v[212:215], v6, s[40:43], 0 offen offset:320
	buffer_load_dwordx4 v[216:219], v6, s[40:43], 0 offen offset:352
	s_waitcnt vmcnt(14)
...
.LBB0_15:
	...
	s_add_u32 s66, s50, s4
	s_addc_u32 s67, s51, s5
	s_ashr_i32 s1, s0, 31
	...
	v_lshl_add_u64 v[4:5], v[4:5], 2, s[66:67]
...
.LBB0_19:
	...
	ds_write_b128 v117, v[156:159]
	ds_write_b128 v117, v[160:163] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[0:1]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_23:
	...
	v_mov_b32_e32 v30, v153
	v_mov_b32_e32 v31, v153
	v_mov_b32_e32 v32, v153
...
.LBB0_26:
	...
	ds_write_b128 v117, v[164:167] offset:12288
	ds_write_b128 v117, v[168:171] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v98, v0
	...
	v_lshl_add_u64 v[98:99], v[98:99], 2, s[66:67]
	global_load_dwordx4 v[164:167], v[98:99], off
	global_load_dwordx4 v[168:171], v[98:99], off offset:256
.LBB0_30:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v98, v0
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[134:135], v[172:173], 0
...
.LBB0_38:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v133, v133, v133
	v_max_f32_e32 v155, v116, v133
	;;#ASMSTART
	v_add_f32 v116, v132, v150
	;;#ASMEND
	v_mov_b32_e32 v133, v132
	v_cmp_gt_f32_e32 vcc, v155, v116
	...
	;;#ASMSTART
	v_add_f32 v116, v155, v151
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v132, v132, v116
	v_exp_f32_e32 v154, v132
	v_mov_b32_e32 v132, v116
...
.LBB0_40:
	...
	;;#ASMSTART
	v_fma_f32 v153, v153, v154, v132
	;;#ASMEND
	s_and_saveexec_b64 s[4:5], vcc
	s_cbranch_execz .LBB0_25
	;;#ASMSTART
	v_mul_f32 v2, v2, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v3, v3, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v4, v4, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v5, v5, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v6, v6, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v7, v7, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v8, v8, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v9, v9, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v10, v10, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v11, v11, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v12, v12, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v13, v13, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v14, v14, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v15, v15, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v16, v16, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v17, v17, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v18, v18, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v19, v19, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v20, v20, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v21, v21, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v22, v22, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v23, v23, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v24, v24, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v25, v25, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v26, v26, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v27, v27, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v28, v28, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v29, v29, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v30, v30, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v31, v31, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v32, v32, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v33, v33, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v34, v34, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v35, v35, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v36, v36, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v37, v37, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v38, v38, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v39, v39, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v40, v40, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v41, v41, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v42, v42, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v43, v43, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v44, v44, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v45, v45, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v46, v46, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v47, v47, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v48, v48, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v49, v49, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v50, v50, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v51, v51, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v52, v52, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v53, v53, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v54, v54, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v55, v55, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v56, v56, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v57, v57, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v58, v58, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v59, v59, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v60, v60, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v61, v61, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v62, v62, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v63, v63, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v64, v64, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v65, v65, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v66, v66, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v67, v67, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v68, v68, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v69, v69, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v70, v70, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v71, v71, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v72, v72, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v73, v73, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v74, v74, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v75, v75, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v76, v76, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v77, v77, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v78, v78, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v79, v79, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v80, v80, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v81, v81, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v82, v82, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v83, v83, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v84, v84, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v85, v85, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v86, v86, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v87, v87, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v88, v88, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v89, v89, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v90, v90, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v91, v91, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v92, v92, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v93, v93, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v94, v94, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v95, v95, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v96, v96, v154
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v97, v97, v154
	;;#ASMEND
	s_branch .LBB0_25
.LBB0_42:
	s_mov_b32 s86, s10
	s_mov_b32 s70, s9
	s_cmp_ge_i32 s68, s40
...
.LBB0_45:
	...
	v_mfma_f32_32x32x8_bf16 v[82:97], v[102:103], v[98:99], v[82:97]
.LBB0_46:
	s_and_b64 s[0:1], s[70:71], exec
	s_cselect_b32 s70, s85, s86
	s_cselect_b32 s86, s87, s85
	s_cselect_b32 s85, s92, s87
	s_add_u32 s68, s68, 2
	s_addc_u32 s69, s69, 0
	v_mov_b64_e32 v[98:99], s[40:41]
	v_cmp_lt_i64_e32 vcc, s[68:69], v[98:99]
...
.LBB0_51:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[132:133], v[216:217], v[98:113]
	...
	v_add_u32_e32 v132, s89, v132
	v_subrev_u32_e32 v133, 55, v132
	v_cmp_gt_i32_e32 vcc, s88, v133
	v_subrev_u32_e32 v133, 54, v132
	v_cmp_gt_i32_e64 s[0:1], s88, v133
	v_subrev_u32_e32 v133, 53, v132
	v_cmp_gt_i32_e64 s[4:5], s88, v133
	v_subrev_u32_e32 v133, 52, v132
	v_cmp_gt_i32_e64 s[6:7], s88, v133
	v_subrev_u32_e32 v133, 51, v132
	v_cmp_gt_i32_e64 s[8:9], s88, v133
	v_subrev_u32_e32 v133, 50, v132
	v_cmp_gt_i32_e64 s[10:11], s88, v133
	v_subrev_u32_e32 v133, 49, v132
	v_cmp_gt_i32_e64 s[12:13], s88, v133
	v_subrev_u32_e32 v133, 48, v132
	v_cmp_gt_i32_e64 s[14:15], s88, v133
	v_subrev_u32_e32 v133, 39, v132
	v_cmp_gt_i32_e64 s[16:17], s88, v133
	v_subrev_u32_e32 v133, 38, v132
	v_cmp_gt_i32_e64 s[18:19], s88, v133
	v_subrev_u32_e32 v133, 37, v132
	v_cmp_gt_i32_e64 s[20:21], s88, v133
	v_subrev_u32_e32 v133, 36, v132
	v_cmp_gt_i32_e64 s[22:23], s88, v133
	v_subrev_u32_e32 v133, 35, v132
	v_cmp_gt_i32_e64 s[24:25], s88, v133
	v_subrev_u32_e32 v133, 34, v132
	v_cmp_gt_i32_e64 s[26:27], s88, v133
	v_subrev_u32_e32 v133, 33, v132
	v_subrev_u32_e32 v132, 32, v132
	v_cmp_gt_i32_e64 s[28:29], s88, v133
	v_cmp_gt_i32_e64 s[30:31], s88, v132
...
.LBB0_55:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[108:109], v[98:99], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[82:97], v[102:103], v[98:99], v[82:97]
	s_cmp_gt_i32 s40, s90
	s_cselect_b64 s[70:71], -1, 0
	s_cmp_le_i32 s40, s90
	s_cbranch_scc1 .LBB0_64
	v_mov_b32_e32 v98, s91
	buffer_load_dword v98, v98, s[36:39], 0 offen
	;;#ASMSTART
	v_mov_b32 v99, v0
	;;#ASMEND
...
.LBB0_60:
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v133, v133, v133
	v_max_f32_e32 v155, v132, v133
	;;#ASMSTART
	v_add_f32 v132, v116, v150
	;;#ASMEND
	v_mov_b32_e32 v133, v116
	v_cmp_gt_f32_e32 vcc, v155, v132
	v_mov_b32_e32 v132, v116
	v_mov_b32_e32 v138, v116
	v_mov_b32_e32 v139, v116
	v_mov_b32_e32 v140, v116
	...
	;;#ASMSTART
	v_add_f32 v132, v155, v151
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v116, v116, v132
	v_exp_f32_e32 v154, v116
	v_mov_b32_e32 v116, v132
	v_mov_b32_e32 v133, v132
	v_mov_b32_e32 v134, v132
	v_mov_b32_e32 v135, v132
...
.LBB0_64:
	...
	s_branch .LBB0_46
.LBB0_65:
	ds_bpermute_b32 v98, v148, v153
	s_waitcnt lgkmcnt(0)
	;;#ASMSTART
	v_add_f32 v98, v153, v98
	;;#ASMEND
	s_nop 0
	v_div_scale_f32 v99, s[0:1], v98, v98, s74
	v_rcp_f32_e32 v100, v99
	v_div_scale_f32 v101, vcc, s74, v98, s74
	...
	v_div_fixup_f32 v98, v99, v98, s74
...
.LBB0_98:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v149, v3, s[62:63] sc0
.LBB0_102:
