...
.LBB0_42:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[160:161], v[208:209], v[98:113]
	v_mfma_f32_32x32x8_bf16 v[98:113], v[162:163], v[210:211], v[98:113]
	s_waitcnt vmcnt(2) lgkmcnt(0)
	s_barrier
	s_setprio 0
	s_nop 7
...
.LBB0_84:
	...
	v_and_or_b32 v132, v132, s50, v159
...
.LBB0_96:
	...
	v_and_or_b32 v161, v161, s50, v159
	v_add_u32_e32 v162, s60, v162
	v_add_u32_e32 v161, s11, v161
...
.LBB0_109:
	...
	v_add_u32_e32 v162, s60, v162
	v_add_u32_e32 v161, s11, v161
	v_add_u32_e32 v163, 0xffffff89, v162
	v_cmp_lt_i32_e32 vcc, v163, v161
	s_nop 1
	v_cndmask_b32_e32 v99, v158, v99, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff8b, v162
	s_nop 0
	v_cndmask_b32_e32 v98, v158, v98, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff8c, v162
	v_pk_mul_f32 v[98:99], v[114:115], v[98:99]
	v_cndmask_b32_e32 v100, v158, v100, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff8d, v162
	s_nop 0
	v_cndmask_b32_e32 v101, v158, v101, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff8e, v162
	v_pk_mul_f32 v[100:101], v[118:119], v[100:101]
	v_cndmask_b32_e32 v102, v158, v102, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff8f, v162
	s_nop 0
	v_cndmask_b32_e32 v103, v158, v103, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff90, v162
	v_pk_mul_f32 v[102:103], v[120:121], v[102:103]
	v_cndmask_b32_e32 v104, v158, v104, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff99, v162
	s_nop 0
	v_cndmask_b32_e32 v105, v158, v105, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff9a, v162
	v_pk_mul_f32 v[104:105], v[122:123], v[104:105]
	v_cndmask_b32_e32 v106, v158, v106, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff9b, v162
	s_nop 0
	v_cndmask_b32_e32 v107, v158, v107, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff9c, v162
	v_pk_mul_f32 v[106:107], v[124:125], v[106:107]
	v_cndmask_b32_e32 v108, v158, v108, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff9d, v162
	s_nop 0
	v_cndmask_b32_e32 v109, v158, v109, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff9e, v162
	v_pk_mul_f32 v[108:109], v[126:127], v[108:109]
	v_cndmask_b32_e32 v110, v158, v110, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffff9f, v162
	v_add_u32_e32 v162, 0xffffffa0, v162
	v_cndmask_b32_e32 v111, v158, v111, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_pk_mul_f32 v[110:111], v[128:129], v[110:111]
	s_nop 0
...
.LBB0_115:
	...
	v_add_u32_e32 v162, s60, v162
	v_add_u32_e32 v161, s11, v161
	v_add_u32_e32 v163, 0xffffffa9, v162
	v_cmp_lt_i32_e32 vcc, v163, v161
	s_nop 1
	v_cndmask_b32_e32 v99, v158, v99, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffab, v162
	s_nop 0
	v_cndmask_b32_e32 v98, v158, v98, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffac, v162
	v_pk_mul_f32 v[98:99], v[114:115], v[98:99]
	v_cndmask_b32_e32 v100, v158, v100, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffad, v162
	s_nop 0
	v_cndmask_b32_e32 v101, v158, v101, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffae, v162
	v_pk_mul_f32 v[100:101], v[118:119], v[100:101]
	v_cndmask_b32_e32 v102, v158, v102, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffaf, v162
	s_nop 0
	v_cndmask_b32_e32 v103, v158, v103, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffb0, v162
	v_pk_mul_f32 v[102:103], v[120:121], v[102:103]
	v_cndmask_b32_e32 v104, v158, v104, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffb9, v162
	s_nop 0
	v_cndmask_b32_e32 v105, v158, v105, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffba, v162
	v_pk_mul_f32 v[104:105], v[122:123], v[104:105]
	v_cndmask_b32_e32 v106, v158, v106, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffbb, v162
	s_nop 0
	v_cndmask_b32_e32 v107, v158, v107, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffbc, v162
	v_pk_mul_f32 v[106:107], v[124:125], v[106:107]
	v_cndmask_b32_e32 v108, v158, v108, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffbd, v162
	s_nop 0
	v_cndmask_b32_e32 v109, v158, v109, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffbe, v162
	v_pk_mul_f32 v[108:109], v[126:127], v[108:109]
	v_cndmask_b32_e32 v110, v158, v110, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, 0xffffffbf, v162
	v_subrev_u32_e32 v162, 64, v162
	v_cndmask_b32_e32 v111, v158, v111, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_pk_mul_f32 v[110:111], v[128:129], v[110:111]
	s_nop 0
...
.LBB0_127:
	...
	v_add_u32_e32 v162, s60, v162
	v_add_u32_e32 v161, s11, v161
	v_subrev_u32_e32 v163, 23, v162
	v_cmp_lt_i32_e32 vcc, v163, v161
	s_nop 1
	v_cndmask_b32_e32 v99, v158, v99, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_subrev_u32_e32 v163, 21, v162
	s_nop 0
	v_cndmask_b32_e32 v98, v158, v98, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_subrev_u32_e32 v163, 20, v162
	v_pk_mul_f32 v[98:99], v[114:115], v[98:99]
	v_cndmask_b32_e32 v100, v158, v100, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_subrev_u32_e32 v163, 19, v162
	s_nop 0
	v_cndmask_b32_e32 v101, v158, v101, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_subrev_u32_e32 v163, 18, v162
	v_pk_mul_f32 v[100:101], v[118:119], v[100:101]
	v_cndmask_b32_e32 v102, v158, v102, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_subrev_u32_e32 v163, 17, v162
	s_nop 0
	v_cndmask_b32_e32 v103, v158, v103, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, -16, v162
	v_pk_mul_f32 v[102:103], v[120:121], v[102:103]
	v_cndmask_b32_e32 v104, v158, v104, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, -7, v162
	s_nop 0
	v_cndmask_b32_e32 v105, v158, v105, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, -6, v162
	v_pk_mul_f32 v[104:105], v[122:123], v[104:105]
	v_cndmask_b32_e32 v106, v158, v106, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, -5, v162
	s_nop 0
	v_cndmask_b32_e32 v107, v158, v107, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, -4, v162
	v_pk_mul_f32 v[106:107], v[124:125], v[106:107]
	v_cndmask_b32_e32 v108, v158, v108, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, -3, v162
	s_nop 0
	v_cndmask_b32_e32 v109, v158, v109, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, -2, v162
	v_pk_mul_f32 v[108:109], v[126:127], v[108:109]
	v_cndmask_b32_e32 v110, v158, v110, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_add_u32_e32 v163, -1, v162
	s_nop 0
	v_cndmask_b32_e32 v111, v158, v111, vcc
	v_cmp_le_i32_e32 vcc, v163, v161
	v_pk_mul_f32 v[110:111], v[128:129], v[110:111]
...
.LBB0_163:
	...
	v_mov_b32_e32 v3, s6
	global_atomic_add v3, v155, v3, s[34:35] sc0
.LBB0_167:
	s_or_b64 exec, exec, s[8:9]
