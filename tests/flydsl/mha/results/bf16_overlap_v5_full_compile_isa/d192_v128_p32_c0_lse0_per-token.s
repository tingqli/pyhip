...
.LBB0_9:
	...
	s_load_dwordx2 s[86:87], s[0:1], 0x70
...
.LBB0_13:
	...
	s_mov_b32 s7, s71
	s_mul_i32 s12, s72, 0xc0
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s78, v2
	s_add_i32 s78, s78, s6
	v_readfirstlane_b32 s5, v3
	s_add_i32 s6, s78, 0x100
	s_min_i32 s5, s6, s5
	s_sub_i32 s75, s5, s78
	s_waitcnt lgkmcnt(0)
	s_add_u32 s8, s52, s0
	...
	s_add_u32 s4, s86, s0
	v_and_or_b32 v2, v6, s56, v2
	s_addc_u32 s0, s87, s1
	s_lshl_b32 s1, s72, 2
	s_lshl_b32 s6, s75, 6
	...
	buffer_load_dwordx4 v[140:143], v6, s[68:71], 0 offen
	buffer_load_dwordx4 v[144:147], v6, s[68:71], 0 offen offset:32
	buffer_load_dwordx4 v[148:151], v6, s[68:71], 0 offen offset:64
	buffer_load_dwordx4 v[152:155], v6, s[68:71], 0 offen offset:96
	buffer_load_dwordx4 v[156:159], v6, s[68:71], 0 offen offset:128
	buffer_load_dwordx4 v[160:163], v6, s[68:71], 0 offen offset:160
	buffer_load_dwordx4 v[164:167], v6, s[68:71], 0 offen offset:192
	buffer_load_dwordx4 v[168:171], v6, s[68:71], 0 offen offset:224
	buffer_load_dwordx4 v[172:175], v6, s[68:71], 0 offen offset:256
	buffer_load_dwordx4 v[176:179], v6, s[68:71], 0 offen offset:288
	buffer_load_dwordx4 v[180:183], v6, s[68:71], 0 offen offset:320
	buffer_load_dwordx4 v[184:187], v6, s[68:71], 0 offen offset:352
	s_waitcnt vmcnt(14)
...
.LBB0_15:
	...
	s_subb_u32 s79, s7, 0
	s_mul_i32 s4, s79, 0x1800
	s_ashr_i32 s5, s4, 31
	s_lshl_b64 s[4:5], s[4:5], 1
	s_add_u32 s94, s50, s4
	s_addc_u32 s95, s51, s5
	s_ashr_i32 s1, s0, 31
	...
	global_load_dwordx4 v[128:131], v[4:5], off offset:256
.LBB0_17:
	...
	s_mul_i32 s4, s84, 0xc00
	v_add_u32_sdwa v4, s4, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_ashrrev_i32_e32 v5, 31, v4
	v_lshl_add_u64 v[4:5], v[4:5], 2, s[94:95]
	global_load_dwordx4 v[132:135], v[4:5], off
	global_load_dwordx4 v[136:139], v[4:5], off offset:256
.LBB0_19:
	s_or_b64 exec, exec, s[0:1]
	s_waitcnt vmcnt(2) lgkmcnt(0)
	s_barrier
	...
	ds_write_b128 v85, v[124:127]
	ds_write_b128 v85, v[128:131] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[0:1]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_25:
	...
	;;#ASMSTART
	v_perm_b32 v70, v67, v66, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v71, v69, v68, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v72, v72, v101, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v73, v73, v100, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v68, v75, v74, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v69, v77, v76, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v66, v79, v78, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v67, v81, v80, s77
	;;#ASMEND
	s_barrier
	s_setprio 1
	s_waitcnt vmcnt(0)
	...
	v_mfma_f32_32x32x8_bf16 v[18:33], v[202:203], v[70:71], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[194:195], v[70:71], v[34:49]
	...
	v_mfma_f32_32x32x8_bf16 v[50:65], v[198:199], v[70:71], v[50:65]
	...
	v_mfma_f32_32x32x8_bf16 v[18:33], v[204:205], v[72:73], v[18:33]
	ds_read_b128 v[188:191], v70
	...
	v_lshrrev_b32_e32 v71, 3, v70
	v_mfma_f32_32x32x8_bf16 v[34:49], v[196:197], v[72:73], v[34:49]
	v_and_b32_e32 v71, 56, v71
	v_xor_b32_e32 v70, v71, v70
	v_lshlrev_b32_e32 v70, 1, v70
	v_mfma_f32_32x32x8_bf16 v[50:65], v[200:201], v[72:73], v[50:65]
	v_mfma_f32_32x32x8_bf16 v[2:17], v[214:215], v[68:69], v[2:17]
	ds_read_b128 v[196:199], v70
	v_add_u32_e32 v70, 0x70, v74
	v_lshrrev_b32_e32 v71, 3, v70
	v_and_b32_e32 v71, 56, v71
	v_xor_b32_e32 v70, v71, v70
	v_lshlrev_b32_e32 v70, 1, v70
	ds_read_b128 v[200:203], v70
	v_mfma_f32_32x32x8_bf16 v[18:33], v[228:229], v[68:69], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[210:211], v[68:69], v[34:49]
	v_mfma_f32_32x32x8_bf16 v[50:65], v[224:225], v[68:69], v[50:65]
	...
	v_xor_b32_e32 v68, v69, v68
	v_lshlrev_b32_e32 v68, 1, v68
	v_mfma_f32_32x32x8_bf16 v[2:17], v[216:217], v[66:67], v[2:17]
...
.LBB0_26:
	...
	ds_write_b128 v85, v[132:135] offset:12288
	ds_write_b128 v85, v[136:139] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v66, v0
	...
	s_mul_i32 s12, s10, 0xc00
	v_add_u32_sdwa v66, s12, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_ashrrev_i32_e32 v67, 31, v66
	v_lshl_add_u64 v[66:67], v[66:67], 2, s[94:95]
	global_load_dwordx4 v[132:135], v[66:67], off
	global_load_dwordx4 v[136:139], v[66:67], off offset:256
.LBB0_30:
	s_or_b64 exec, exec, s[4:5]
	s_waitcnt lgkmcnt(11)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[220:221], v[140:141], 0
	;;#ASMSTART
	v_mov_b32 v84, v0
	;;#ASMEND
	s_add_i32 s4, s11, s79
	v_lshlrev_b32_e32 v101, 3, v84
	v_lshlrev_b32_e32 v84, 5, v84
	s_lshl_b32 s4, s4, 12
	v_and_b32_e32 v101, 0xf8, v101
	v_and_b32_e32 v84, 0x400, v84
	v_mfma_f32_32x32x8_bf16 v[66:81], v[222:223], v[142:143], v[66:81]
	v_or3_b32 v114, v101, v84, s4
	v_ashrrev_i32_e32 v115, 31, v114
	v_lshl_add_u64 v[114:115], v[114:115], 1, s[80:81]
	global_load_dwordx4 v[228:231], v[114:115], off
	s_waitcnt lgkmcnt(10)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[102:103], v[144:145], v[66:81]
	v_add_co_u32_e32 v102, vcc, s76, v114
	s_nop 1
	v_addc_co_u32_e32 v103, vcc, 0, v115, vcc
	v_mfma_f32_32x32x8_bf16 v[66:81], v[104:105], v[146:147], v[66:81]
	s_waitcnt lgkmcnt(9)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[106:107], v[148:149], v[66:81]
	global_load_dwordx4 v[232:235], v[114:115], off offset:512
	global_load_dwordx4 v[220:223], v[114:115], off offset:1024
	v_mfma_f32_32x32x8_bf16 v[66:81], v[108:109], v[150:151], v[66:81]
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[110:111], v[152:153], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[112:113], v[154:155], v[66:81]
	global_load_dwordx4 v[224:227], v[114:115], off offset:1536
	...
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[216:217], v[180:181], v[66:81]
...
.LBB0_34:
	...
	v_xor_b32_e32 v66, v67, v66
	v_lshlrev_b32_e32 v66, 1, v66
	v_mfma_f32_32x32x8_bf16 v[34:49], v[222:223], v[68:69], v[34:49]
...
.LBB0_36:
	...
	global_load_dwordx4 v[128:131], v[66:67], off offset:256
.LBB0_38:
	s_or_b64 exec, exec, s[4:5]
	s_waitcnt lgkmcnt(11)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[200:201], v[140:141], 0
	;;#ASMSTART
	v_mov_b32 v84, v0
	;;#ASMEND
	s_add_i32 s4, s84, s79
	v_lshlrev_b32_e32 v101, 3, v84
	v_lshlrev_b32_e32 v84, 5, v84
	s_lshl_b32 s4, s4, 12
	v_and_b32_e32 v101, 0xf8, v101
	...
	v_or3_b32 v102, v101, v84, s4
	v_ashrrev_i32_e32 v103, 31, v102
	v_lshl_add_u64 v[102:103], v[102:103], 1, s[80:81]
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[224:225], v[166:167], v[66:81]
	global_load_dwordx4 v[224:227], v[102:103], off offset:1536
	s_waitcnt lgkmcnt(4)
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[112:113], v[182:183], v[66:81]
	s_waitcnt lgkmcnt(0)
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v101, v101, v101
	v_max_f32_e32 v123, v84, v101
	;;#ASMSTART
	v_add_f32 v84, v100, v118
	;;#ASMEND
	v_mov_b32_e32 v101, v100
	v_cmp_gt_f32_e32 vcc, v123, v84
	...
	;;#ASMSTART
	v_add_f32 v84, v123, v119
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v100, v100, v84
	v_exp_f32_e32 v122, v100
	v_mov_b32_e32 v100, v84
...
.LBB0_45:
	...
	v_xor_b32_e32 v70, v71, v70
	v_lshlrev_b32_e32 v70, 1, v70
	v_mfma_f32_32x32x8_bf16 v[2:17], v[250:251], v[72:73], v[2:17]
	v_mfma_f32_32x32x8_bf16 v[18:33], v[254:255], v[72:73], v[18:33]
	ds_read_b128 v[188:191], v70
	v_add_u32_e32 v70, 0x50, v74
	v_lshrrev_b32_e32 v71, 3, v70
	v_and_b32_e32 v71, 56, v71
	...
	v_add_u32_e32 v70, 0x60, v74
	v_lshrrev_b32_e32 v71, 3, v70
	v_mfma_f32_32x32x8_bf16 v[34:49], v[242:243], v[72:73], v[34:49]
	v_and_b32_e32 v71, 56, v71
	v_xor_b32_e32 v70, v71, v70
	v_lshlrev_b32_e32 v70, 1, v70
	v_mfma_f32_32x32x8_bf16 v[50:65], v[246:247], v[72:73], v[50:65]
...
.LBB0_46:
	...
	s_cselect_b32 s11, s82, s84
	s_cselect_b32 s84, s83, s82
	s_cselect_b32 s82, s43, s83
	s_add_u32 s96, s96, 2
...
.LBB0_51:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[222:223], v[142:143], v[66:81]
	v_or3_b32 v100, v101, v100, s0
	v_ashrrev_i32_e32 v101, 31, v100
	v_lshl_add_u64 v[100:101], v[100:101], 1, s[80:81]
	global_load_dwordx4 v[248:251], v[100:101], off
	s_waitcnt lgkmcnt(10)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[102:103], v[144:145], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[104:105], v[146:147], v[66:81]
	s_waitcnt lgkmcnt(9)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[106:107], v[148:149], v[66:81]
	global_load_dwordx4 v[252:255], v[100:101], off offset:512
	global_load_dwordx4 v[240:243], v[100:101], off offset:1024
	v_mfma_f32_32x32x8_bf16 v[66:81], v[108:109], v[150:151], v[66:81]
	s_waitcnt lgkmcnt(8)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[110:111], v[152:153], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[112:113], v[154:155], v[66:81]
	global_load_dwordx4 v[244:247], v[100:101], off offset:1536
	v_add_co_u32_e32 v100, vcc, s76, v100
	s_nop 1
	v_addc_co_u32_e32 v101, vcc, 0, v101, vcc
	global_load_dwordx4 v[232:235], v[100:101], off
	s_waitcnt lgkmcnt(7)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[188:189], v[156:157], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[190:191], v[158:159], v[66:81]
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[192:193], v[160:161], v[66:81]
	global_load_dwordx4 v[236:239], v[100:101], off offset:512
	global_load_dwordx4 v[228:231], v[100:101], off offset:1024
	v_mfma_f32_32x32x8_bf16 v[66:81], v[194:195], v[162:163], v[66:81]
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_32x32x8_bf16 v[66:81], v[196:197], v[164:165], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[66:81], v[198:199], v[166:167], v[66:81]
...
.LBB0_55:
	...
	;;#ASMSTART
	v_perm_b32 v72, v67, v66, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v73, v69, v68, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v70, v71, v70, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v71, v100, v101, s77
	;;#ASMEND
	;;#ASMSTART
	v_perm_b32 v68, v75, v74, s77
	;;#ASMEND
	...
	v_xor_b32_e32 v75, v75, v74
	v_lshlrev_b32_e32 v75, 1, v75
	ds_read_b128 v[220:223], v75 offset:12288
	v_add_u32_e32 v75, 0x1810, v74
	v_lshrrev_b32_e32 v76, 3, v75
	v_and_b32_e32 v76, 56, v76
	v_xor_b32_e32 v75, v76, v75
	...
	v_mfma_f32_32x32x8_bf16 v[18:33], v[252:253], v[72:73], v[18:33]
	v_mfma_f32_32x32x8_bf16 v[34:49], v[240:241], v[72:73], v[34:49]
	...
	v_lshlrev_b32_e32 v75, 1, v75
	ds_read_b128 v[110:113], v75
	v_mfma_f32_32x32x8_bf16 v[50:65], v[244:245], v[72:73], v[50:65]
	...
	v_mfma_f32_32x32x8_bf16 v[18:33], v[254:255], v[70:71], v[18:33]
	ds_read_b128 v[188:191], v72
	v_add_u32_e32 v72, 0x1850, v74
	v_lshrrev_b32_e32 v73, 3, v72
	v_and_b32_e32 v73, 56, v73
	v_xor_b32_e32 v72, v73, v72
	v_lshlrev_b32_e32 v72, 1, v72
	ds_read_b128 v[192:195], v72
...
.LBB0_60:
	...
	v_max_f32_e32 v123, v80, v81
	;;#ASMSTART
	v_add_f32 v80, v84, v118
	;;#ASMEND
	v_mov_b32_e32 v81, v84
	v_cmp_gt_f32_e32 vcc, v123, v80
...
.LBB0_64:
	...
	s_branch .LBB0_46
.LBB0_65:
	ds_bpermute_b32 v66, v116, v121
	s_waitcnt lgkmcnt(0)
	;;#ASMSTART
	v_add_f32 v66, v121, v66
	;;#ASMEND
	s_nop 0
...
.LBB0_83:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v117, v3, s[90:91] sc0
.LBB0_86:
