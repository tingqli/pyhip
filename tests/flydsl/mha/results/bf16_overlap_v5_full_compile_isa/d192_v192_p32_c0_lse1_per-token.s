...
.LBB0_13:
	...
	global_load_dwordx2 v[2:3], v149, s[4:5]
	...
	global_load_dwordx2 v[4:5], v149, s[6:7]
	global_load_dword v3, v149, s[0:1]
	...
	v_and_or_b32 v6, v6, 8, s47
	v_mul_u32_u24_e32 v8, 0x18000, v8
	v_mad_u32_u24 v6, v7, s81, v6
	v_add_lshl_u32 v6, v6, v8, 1
	buffer_load_dwordx4 v[174:177], v6, s[40:43], 0 offen
	buffer_load_dwordx4 v[178:181], v6, s[40:43], 0 offen offset:32
	buffer_load_dwordx4 v[182:185], v6, s[40:43], 0 offen offset:64
	buffer_load_dwordx4 v[186:189], v6, s[40:43], 0 offen offset:96
	buffer_load_dwordx4 v[190:193], v6, s[40:43], 0 offen offset:128
	buffer_load_dwordx4 v[194:197], v6, s[40:43], 0 offen offset:160
	buffer_load_dwordx4 v[198:201], v6, s[40:43], 0 offen offset:192
	buffer_load_dwordx4 v[202:205], v6, s[40:43], 0 offen offset:224
	buffer_load_dwordx4 v[206:209], v6, s[40:43], 0 offen offset:256
	buffer_load_dwordx4 v[210:213], v6, s[40:43], 0 offen offset:288
	buffer_load_dwordx4 v[214:217], v6, s[40:43], 0 offen offset:320
	buffer_load_dwordx4 v[218:221], v6, s[40:43], 0 offen offset:352
	s_waitcnt vmcnt(14)
...
.LBB0_15:
	...
	s_subb_u32 s43, s7, 0
	s_mul_i32 s4, s43, 0x1800
	s_ashr_i32 s5, s4, 31
	s_lshl_b64 s[4:5], s[4:5], 1
	s_add_u32 s72, s50, s4
	s_addc_u32 s73, s51, s5
	s_ashr_i32 s1, s0, 31
	...
	global_load_dwordx4 v[162:165], v[4:5], off offset:256
.LBB0_17:
...
.LBB0_19:
	...
	ds_write_b128 v117, v[158:161]
	ds_write_b128 v117, v[162:165] offset:6144
.LBB0_21:
	s_or_b64 exec, exec, s[0:1]
	;;#ASMSTART
	v_mov_b32 v3, v0
...
.LBB0_25:
	...
	s_waitcnt vmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[82:97], v[222:223], v[100:101], v[82:97]
	...
	v_mfma_f32_32x32x8_bf16 v[82:97], v[224:225], v[102:103], v[82:97]
	s_waitcnt vmcnt(3)
...
.LBB0_26:
	...
	ds_write_b128 v117, v[166:169] offset:12288
	ds_write_b128 v117, v[170:173] offset:18432
.LBB0_28:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v98, v0
	...
	global_load_dwordx4 v[166:169], v[98:99], off
	global_load_dwordx4 v[170:173], v[98:99], off offset:256
.LBB0_30:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v98, v0
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[134:135], v[174:175], 0
...
.LBB0_36:
	...
	global_load_dwordx4 v[162:165], v[98:99], off offset:256
.LBB0_38:
	s_or_b64 exec, exec, s[4:5]
	;;#ASMSTART
	v_mov_b32 v98, v0
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v133, v133, v133
	v_max_f32_e32 v156, v116, v133
	;;#ASMSTART
	v_add_f32 v116, v132, v150
	;;#ASMEND
	v_mov_b32_e32 v133, v132
	v_cmp_gt_f32_e32 vcc, v156, v116
	...
	;;#ASMSTART
	v_add_f32 v116, v156, v151
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v132, v132, v116
	v_exp_f32_e32 v155, v132
	v_mov_b32_e32 v132, v116
...
.LBB0_40:
	...
	;;#ASMSTART
	v_fma_f32 v154, v154, v155, v132
	;;#ASMEND
	s_and_saveexec_b64 s[4:5], vcc
	s_cbranch_execz .LBB0_25
	;;#ASMSTART
	v_mul_f32 v2, v2, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v3, v3, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v4, v4, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v5, v5, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v6, v6, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v7, v7, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v8, v8, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v9, v9, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v10, v10, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v11, v11, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v12, v12, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v13, v13, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v14, v14, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v15, v15, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v16, v16, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v17, v17, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v18, v18, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v19, v19, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v20, v20, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v21, v21, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v22, v22, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v23, v23, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v24, v24, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v25, v25, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v26, v26, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v27, v27, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v28, v28, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v29, v29, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v30, v30, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v31, v31, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v32, v32, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v33, v33, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v34, v34, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v35, v35, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v36, v36, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v37, v37, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v38, v38, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v39, v39, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v40, v40, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v41, v41, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v42, v42, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v43, v43, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v44, v44, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v45, v45, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v46, v46, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v47, v47, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v48, v48, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v49, v49, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v50, v50, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v51, v51, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v52, v52, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v53, v53, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v54, v54, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v55, v55, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v56, v56, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v57, v57, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v58, v58, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v59, v59, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v60, v60, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v61, v61, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v62, v62, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v63, v63, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v64, v64, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v65, v65, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v66, v66, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v67, v67, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v68, v68, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v69, v69, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v70, v70, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v71, v71, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v72, v72, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v73, v73, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v74, v74, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v75, v75, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v76, v76, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v77, v77, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v78, v78, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v79, v79, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v80, v80, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v81, v81, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v82, v82, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v83, v83, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v84, v84, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v85, v85, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v86, v86, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v87, v87, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v88, v88, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v89, v89, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v90, v90, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v91, v91, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v92, v92, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v93, v93, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v94, v94, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v95, v95, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v96, v96, v155
	;;#ASMEND
	;;#ASMSTART
	v_mul_f32 v97, v97, v155
	;;#ASMEND
	s_branch .LBB0_25
.LBB0_42:
	s_mov_b32 s92, s10
	s_mov_b32 s76, s9
	s_cmp_ge_i32 s74, s40
...
.LBB0_51:
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_bf16 v[98:113], v[132:133], v[218:219], v[98:113]
	...
	v_add_u32_e32 v132, s95, v132
	v_subrev_u32_e32 v133, 55, v132
	v_cmp_gt_i32_e32 vcc, s94, v133
	v_subrev_u32_e32 v133, 54, v132
	v_cmp_gt_i32_e64 s[0:1], s94, v133
	v_subrev_u32_e32 v133, 53, v132
	v_cmp_gt_i32_e64 s[4:5], s94, v133
	v_subrev_u32_e32 v133, 52, v132
	v_cmp_gt_i32_e64 s[6:7], s94, v133
	v_subrev_u32_e32 v133, 51, v132
	v_cmp_gt_i32_e64 s[8:9], s94, v133
	v_subrev_u32_e32 v133, 50, v132
	v_cmp_gt_i32_e64 s[10:11], s94, v133
	v_subrev_u32_e32 v133, 49, v132
	v_cmp_gt_i32_e64 s[12:13], s94, v133
	v_subrev_u32_e32 v133, 48, v132
	v_cmp_gt_i32_e64 s[14:15], s94, v133
	v_subrev_u32_e32 v133, 39, v132
	v_cmp_gt_i32_e64 s[16:17], s94, v133
	v_subrev_u32_e32 v133, 38, v132
	v_cmp_gt_i32_e64 s[18:19], s94, v133
	v_subrev_u32_e32 v133, 37, v132
	v_cmp_gt_i32_e64 s[20:21], s94, v133
	v_subrev_u32_e32 v133, 36, v132
	v_cmp_gt_i32_e64 s[22:23], s94, v133
	v_subrev_u32_e32 v133, 35, v132
	v_cmp_gt_i32_e64 s[24:25], s94, v133
	v_subrev_u32_e32 v133, 34, v132
	v_cmp_gt_i32_e64 s[26:27], s94, v133
	v_subrev_u32_e32 v133, 33, v132
	v_subrev_u32_e32 v132, 32, v132
	v_cmp_gt_i32_e64 s[28:29], s94, v133
	v_cmp_gt_i32_e64 s[30:31], s94, v132
	...
	v_cndmask_b32_e64 v113, v152, v113, s[30:31]
	v_cndmask_b32_e64 v112, v152, v112, s[28:29]
	v_cndmask_b32_e64 v139, v152, v99, s[0:1]
	v_cndmask_b32_e32 v138, v152, v98, vcc
	v_cndmask_b32_e64 v111, v152, v111, s[26:27]
	v_cndmask_b32_e64 v110, v152, v110, s[24:25]
	v_cndmask_b32_e64 v107, v152, v107, s[18:19]
	v_cndmask_b32_e64 v106, v152, v106, s[16:17]
	v_cndmask_b32_e64 v133, v152, v105, s[14:15]
	v_cndmask_b32_e64 v132, v152, v104, s[12:13]
	v_cndmask_b32_e64 v137, v152, v101, s[6:7]
	v_cndmask_b32_e64 v136, v152, v100, s[4:5]
	v_pk_mul_f32 v[98:99], v[130:131], v[112:113]
	v_pk_mul_f32 v[112:113], v[114:115], v[138:139]
	v_cndmask_b32_e64 v109, v152, v109, s[22:23]
	v_cndmask_b32_e64 v108, v152, v108, s[20:21]
	v_cndmask_b32_e64 v135, v152, v103, s[10:11]
	v_cndmask_b32_e64 v134, v152, v102, s[8:9]
	...
	ds_bpermute_b32 v133, v148, v132
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v133, v133, v133
	v_max_f32_e32 v133, v132, v133
	;;#ASMSTART
	v_add_f32 v132, v116, v150
	;;#ASMEND
	s_nop 0
...
.LBB0_55:
	...
	v_mfma_f32_32x32x8_bf16 v[66:81], v[108:109], v[98:99], v[66:81]
	v_mfma_f32_32x32x8_bf16 v[82:97], v[102:103], v[98:99], v[82:97]
	s_cmp_gt_i32 s40, s96
	s_cselect_b64 s[76:77], -1, 0
	s_cmp_le_i32 s40, s96
...
.LBB0_60:
	...
	v_and_b32_e32 v132, 8, v132
	v_add_u32_e32 v132, s95, v132
	v_subrev_u32_e32 v133, 23, v132
	v_cmp_gt_i32_e32 vcc, s94, v133
	v_subrev_u32_e32 v133, 22, v132
	v_cmp_gt_i32_e64 s[0:1], s94, v133
	v_subrev_u32_e32 v133, 21, v132
	v_cmp_gt_i32_e64 s[4:5], s94, v133
	v_subrev_u32_e32 v133, 20, v132
	v_cmp_gt_i32_e64 s[6:7], s94, v133
	v_subrev_u32_e32 v133, 19, v132
	v_cmp_gt_i32_e64 s[8:9], s94, v133
	v_subrev_u32_e32 v133, 18, v132
	v_cmp_gt_i32_e64 s[10:11], s94, v133
	v_subrev_u32_e32 v133, 17, v132
	v_cmp_gt_i32_e64 s[12:13], s94, v133
	v_add_u32_e32 v133, -16, v132
	v_cmp_gt_i32_e64 s[14:15], s94, v133
	v_add_u32_e32 v133, -7, v132
	v_cmp_gt_i32_e64 s[16:17], s94, v133
	v_add_u32_e32 v133, -6, v132
	v_cmp_gt_i32_e64 s[18:19], s94, v133
	v_add_u32_e32 v133, -5, v132
	v_cmp_gt_i32_e64 s[20:21], s94, v133
	v_add_u32_e32 v133, -4, v132
	v_cmp_gt_i32_e64 s[22:23], s94, v133
	v_add_u32_e32 v133, -3, v132
	v_cmp_gt_i32_e64 s[24:25], s94, v133
	v_add_u32_e32 v133, -2, v132
	v_cmp_gt_i32_e64 s[26:27], s94, v133
	v_add_u32_e32 v133, -1, v132
	v_cmp_gt_i32_e64 s[28:29], s94, v133
	v_cmp_gt_i32_e64 s[30:31], s94, v132
	s_or_b64 s[28:29], s[30:31], s[28:29]
	s_or_b64 s[26:27], s[28:29], s[26:27]
	...
	s_or_b64 s[0:1], s[4:5], s[0:1]
	s_or_b64 vcc, s[0:1], vcc
	v_cndmask_b32_e64 v99, v152, v99, s[0:1]
	v_cndmask_b32_e32 v98, v152, v98, vcc
	v_cndmask_b32_e64 v101, v152, v101, s[6:7]
	v_cndmask_b32_e64 v100, v152, v100, s[4:5]
	v_pk_mul_f32 v[98:99], v[114:115], v[98:99]
	v_cndmask_b32_e64 v103, v152, v103, s[10:11]
	v_cndmask_b32_e64 v102, v152, v102, s[8:9]
	v_pk_mul_f32 v[100:101], v[118:119], v[100:101]
	v_max_f32_e32 v132, v98, v99
	v_cndmask_b32_e64 v105, v152, v105, s[14:15]
	v_cndmask_b32_e64 v104, v152, v104, s[12:13]
	v_pk_mul_f32 v[102:103], v[120:121], v[102:103]
	v_max3_f32 v132, v132, v100, v101
	v_cndmask_b32_e64 v107, v152, v107, s[18:19]
	v_cndmask_b32_e64 v106, v152, v106, s[16:17]
	...
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v133, v133, v133
	v_max_f32_e32 v156, v132, v133
	;;#ASMSTART
	v_add_f32 v132, v116, v150
	;;#ASMEND
	v_mov_b32_e32 v133, v116
	v_cmp_gt_f32_e32 vcc, v156, v132
	v_mov_b32_e32 v132, v116
	v_mov_b32_e32 v138, v116
	v_mov_b32_e32 v139, v116
	v_mov_b32_e32 v140, v116
	...
	;;#ASMSTART
	v_add_f32 v132, v156, v151
	;;#ASMEND
	s_nop 0
	v_sub_f32_e32 v116, v116, v132
	v_exp_f32_e32 v155, v116
	v_mov_b32_e32 v116, v132
	v_mov_b32_e32 v133, v132
	v_mov_b32_e32 v134, v132
	v_mov_b32_e32 v135, v132
...
.LBB0_65:
	...
	v_mov_b32 v100, v0
	;;#ASMEND
	ds_bpermute_b32 v98, v148, v154
	v_lshrrev_b32_e32 v99, 1, v100
	v_and_b32_e32 v101, 31, v100
	v_and_or_b32 v99, v99, s82, v101
	...
	v_cndmask_b32_e32 v100, 0, v153, vcc
	s_add_u32 s6, s64, s4
	...
	s_add_u32 s4, s6, s4
	s_addc_u32 s5, s7, s5
	v_cndmask_b32_e32 v100, v152, v100, vcc
...
.LBB0_100:
	...
	v_mov_b32_e32 v3, s8
	global_atomic_add v3, v149, v3, s[66:67] sc0
.LBB0_104:
	...
	global_store_dword v149, v2, s[6:7]
	s_waitcnt vmcnt(0)
.LBB0_105:
	s_or_b64 exec, exec, s[4:5]
	s_lshl_b64 s[0:1], s[0:1], 2
	...
	s_barrier
	global_load_dword v2, v149, s[0:1]
	s_waitcnt vmcnt(0)
	s_barrier
	v_readfirstlane_b32 s4, v2
	s_add_i32 s0, s4, s33
...
.LBB0_108:
	...
	global_load_dwordx2 v[2:3], v149, s[6:7] offset:4
	s_waitcnt vmcnt(0)
	v_readfirstlane_b32 s6, v3
