...
.LBB0_23:
	...
	s_add_i32 s44, s44, s11
	s_sub_i32 s11, s44, 64
...
.LBB0_68:
	...
	v_and_or_b32 v132, v132, s55, v158
...
.LBB0_70:
	s_or_b64 exec, exec, s[48:49]
	v_pk_add_f32 v[134:135], v[98:99], v[114:115] op_sel_hi:[1,0] neg_lo:[0,1] neg_hi:[0,1]
	v_pk_add_f32 v[98:99], v[112:113], v[114:115] op_sel_hi:[1,0] neg_lo:[0,1] neg_hi:[0,1]
	v_pk_add_f32 v[136:137], v[100:101], v[114:115] op_sel_hi:[1,0] neg_lo:[0,1] neg_hi:[0,1]
	;;#ASMSTART
	v_exp_f32 v98, v98
	;;#ASMEND
	v_pk_add_f32 v[100:101], v[110:111], v[114:115] op_sel_hi:[1,0] neg_lo:[0,1] neg_hi:[0,1]
	v_add_f32_e32 v133, 0, v98
	;;#ASMSTART
	v_exp_f32 v99, v99
	;;#ASMEND
	...
	v_exp_f32 v100, v100
	;;#ASMEND
	v_pk_add_f32 v[138:139], v[102:103], v[114:115] op_sel_hi:[1,0] neg_lo:[0,1] neg_hi:[0,1]
	v_add_f32_e32 v133, v133, v99
	v_add_f32_e32 v133, v133, v100
	v_pk_add_f32 v[102:103], v[108:109], v[114:115] op_sel_hi:[1,0] neg_lo:[0,1] neg_hi:[0,1]
	;;#ASMSTART
	v_exp_f32 v101, v101
	;;#ASMEND
	v_pk_add_f32 v[140:141], v[104:105], v[114:115] op_sel_hi:[1,0] neg_lo:[0,1] neg_hi:[0,1]
	v_add_f32_e32 v133, v133, v101
	;;#ASMSTART
	v_exp_f32 v102, v102
	;;#ASMEND
	v_pk_add_f32 v[104:105], v[106:107], v[114:115] op_sel_hi:[1,0] neg_lo:[0,1] neg_hi:[0,1]
	v_add_f32_e32 v133, v133, v102
	;;#ASMSTART
	v_exp_f32 v103, v103
	;;#ASMEND
...
.LBB0_85:
	...
	v_and_or_b32 v160, v160, s55, v158
	v_add_u32_e32 v161, s66, v161
	v_add_u32_e32 v160, s11, v160
	v_subrev_u32_e32 v226, 55, v161
	v_cmp_lt_i32_e32 vcc, v226, v160
	s_nop 1
	v_cndmask_b32_e32 v99, v156, v99, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 53, v161
	s_nop 0
	v_cndmask_b32_e32 v98, v156, v98, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 52, v161
	v_pk_mul_f32 v[98:99], v[116:117], v[98:99]
	v_cndmask_b32_e32 v100, v156, v100, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 51, v161
	s_nop 0
	v_cndmask_b32_e32 v101, v156, v101, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 50, v161
	v_pk_mul_f32 v[100:101], v[118:119], v[100:101]
	v_cndmask_b32_e32 v102, v156, v102, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 49, v161
	s_nop 0
	v_cndmask_b32_e32 v103, v156, v103, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 48, v161
	v_pk_mul_f32 v[102:103], v[120:121], v[102:103]
	v_cndmask_b32_e32 v104, v156, v104, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 39, v161
	s_nop 0
	v_cndmask_b32_e32 v105, v156, v105, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 38, v161
	v_pk_mul_f32 v[104:105], v[122:123], v[104:105]
	v_cndmask_b32_e32 v106, v156, v106, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 37, v161
	s_nop 0
	v_cndmask_b32_e32 v107, v156, v107, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 36, v161
	v_pk_mul_f32 v[106:107], v[124:125], v[106:107]
	v_cndmask_b32_e32 v108, v156, v108, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 35, v161
	s_nop 0
	v_cndmask_b32_e32 v109, v156, v109, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 34, v161
	v_pk_mul_f32 v[108:109], v[126:127], v[108:109]
	v_cndmask_b32_e32 v110, v156, v110, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 33, v161
...
.LBB0_93:
	...
	v_add_u32_e32 v161, s66, v161
	v_add_u32_e32 v160, s11, v160
	v_subrev_u32_e32 v226, 23, v161
	v_cmp_lt_i32_e32 vcc, v226, v160
	s_nop 1
	v_cndmask_b32_e32 v99, v156, v99, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 21, v161
	s_nop 0
	v_cndmask_b32_e32 v98, v156, v98, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 20, v161
	v_pk_mul_f32 v[98:99], v[116:117], v[98:99]
	v_cndmask_b32_e32 v100, v156, v100, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 19, v161
	s_nop 0
	v_cndmask_b32_e32 v101, v156, v101, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 18, v161
	v_pk_mul_f32 v[100:101], v[118:119], v[100:101]
	v_cndmask_b32_e32 v102, v156, v102, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_subrev_u32_e32 v226, 17, v161
	s_nop 0
	v_cndmask_b32_e32 v103, v156, v103, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_add_u32_e32 v226, -16, v161
	v_pk_mul_f32 v[102:103], v[120:121], v[102:103]
	v_cndmask_b32_e32 v104, v156, v104, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_add_u32_e32 v226, -7, v161
	s_nop 0
	v_cndmask_b32_e32 v105, v156, v105, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_add_u32_e32 v226, -6, v161
	v_pk_mul_f32 v[104:105], v[122:123], v[104:105]
	v_cndmask_b32_e32 v106, v156, v106, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_add_u32_e32 v226, -5, v161
	s_nop 0
	v_cndmask_b32_e32 v107, v156, v107, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_add_u32_e32 v226, -4, v161
	v_pk_mul_f32 v[106:107], v[124:125], v[106:107]
	v_cndmask_b32_e32 v108, v156, v108, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_add_u32_e32 v226, -3, v161
	s_nop 0
	v_cndmask_b32_e32 v109, v156, v109, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_add_u32_e32 v226, -2, v161
	v_pk_mul_f32 v[108:109], v[126:127], v[108:109]
	v_cndmask_b32_e32 v110, v156, v110, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_add_u32_e32 v226, -1, v161
	s_nop 0
	v_cndmask_b32_e32 v111, v156, v111, vcc
	v_cmp_le_i32_e32 vcc, v226, v160
	v_pk_mul_f32 v[110:111], v[128:129], v[110:111]
...
.LBB0_133:
	...
	v_mov_b32_e32 v3, s6
	global_atomic_add v3, v153, v3, s[38:39] sc0
.LBB0_137:
