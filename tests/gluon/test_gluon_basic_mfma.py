...
def get_mem_ab_layout(tilemn:gl.constexpr, tilek:gl.constexpr):
...
@gluon.constexpr_function
def load_layout(k_lanes:gl.constexpr):
...
@gluon.constexpr_function
def get_lds_layout_read(mn:gl.constexpr, k:gl.constexp):
    reg_bases = [[0, 1], [0, 2], [0, 4]]
...
def gemm_test_kernel_lds(
    ...
    mem_b_layout: gl.constexpr = load_layout(k_lanes=8)
