...
def run_benchmark(args: argparse.Namespace) -> int:
    import torch
    if __package__:
        from . import test_gemm as flydsl_gemm
    else:
        import test_gemm as flydsl_gemm
...
def run_validation_matrix(rows, *, m, n, k, waves, tile_m, tile_n, dtype, launches) -> None:
    ...
    import torch
    if __package__:
        from .test_gemm import _make_gemm_950_problem, compile_gemm_950
    else:
        from test_gemm import _make_gemm_950_problem, compile_gemm_950
    ...
    if not args.skip_pytest:
        subprocess.run(
            [
                ...
                "-m",
                "pytest",
                "experiments/gemm/flydsl/test_gemm.py",
                "-k",
                "gemm_950",
                "-q",
            ],
