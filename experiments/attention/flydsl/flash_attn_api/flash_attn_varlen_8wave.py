...
def flash_attn_varlen_func(
    ...
    if num_waves == 4:
        ...
        MHA = importlib.import_module(
            "..pa_4wave.pa_prefill_4wave" if __package__ else "pa_prefill_4wave",
            package=__package__,
        ).MHA
        ...
        module = importlib.import_module(
            "..pa_8wave.pa_prefill_8w32x32" if __package__ else "pa_prefill_8w32x32",
            package=__package__,
        )
