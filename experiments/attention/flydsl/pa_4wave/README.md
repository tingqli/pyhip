...
PA_CASE=tails PA_NUM_ITERS=1 python3 -B experiments/attention/flydsl/pa_4wave/test_pa_prefill.py
PA_CASE=batch PA_NUM_ITERS=1 python3 -B experiments/attention/flydsl/pa_4wave/test_pa_prefill.py
PA_CASE=noncausal PA_NUM_ITERS=1 PA_FORMAL_BENCH=1 PA_SKIP_REFERENCE=1 \
  python3 -B experiments/attention/flydsl/pa_4wave/test_pa_prefill.py
