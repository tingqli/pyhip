...
**历史保留，未在本轮运行。** 以下为`4adaf81`轮次2026-09-08 03:49:34–04:07:11 UTC的CLI数值，来源保存在 [历史原始报告](../../../../tests/flydsl/mha/results/mi325_bf16_e7b4be8_20260908T081608Z/history/all.json)。
...
129.662秒包含新specialization首调/编译，不能称为纯热缓存耗时。完整逐case阶段、原始样本与JUnit见 [本轮BF16结果](../../../../tests/flydsl/mha/results/mi325_bf16_4f3820e_20260908T234624Z/bf16-audit.json) 和 [pytest日志](../../../../tests/flydsl/mha/results/mi325_bf16_4f3820e_20260908T234624Z/pytest.log)。
...
MHA=/host_lc/pyhip/experiments/attention/flydsl/mha/test_mha_pa.py
...
本轮证据见 [BF16结果目录](../../../../tests/flydsl/mha/results/mi325_bf16_4f3820e_20260908T234624Z)、[JUnit](../../../../tests/flydsl/mha/results/mi325_bf16_4f3820e_20260908T234624Z/tests.xml)、[离线审计](../../../../tests/flydsl/mha/results/mi325_bf16_4f3820e_20260908T234624Z/bf16-audit.json)。
快进更新前，原暂存的选卡修复和未暂存变更记录已完整归档并保存到stash **`884b96fbcee56cb5e3394f7625351ee44de27505`**；[更新基线](../../../../tests/flydsl/mha/results/mi325_bf16_4f3820e_20260908T234624Z/baseline.txt)记录归档路径和SHA256，没有盲目重放旧stash。
更新后的原MI325正文另备份为 [更新前报告](../../../../tests/flydsl/mha/results/mi325_bf16_4f3820e_20260908T234624Z/README.325.before.md)。上一轮`e7b4be8`报告与历史FP8/SWA来源仍保留在原结果目录，数值未改写。
