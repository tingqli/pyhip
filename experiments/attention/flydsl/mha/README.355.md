...
来源：[本轮CLI原始JSON](../../../../tests/flydsl/mha/results/gfx950-lowload2-20260908.yFE1Zz/all.json#L1)，保留全部样本及实际dispatch。
...
无需恢复已删除的旧helper，也不需要改用例架构、重装依赖或设置硬件策略；剩余改动只是平台文档和[changes.md](../../../../tests/flydsl/mha/changes.md)同步。

原始JSON、JUnit、选卡日志与[完整验证记录](../../../../tests/flydsl/mha/results/gfx950-lowload2-20260908.yFE1Zz/validation.json#L1)保留，
[进程耗时](../../../../tests/flydsl/mha/results/gfx950-lowload2-20260908.yFE1Zz/run-status.json#L1)不含之前已中断的严格等待。
