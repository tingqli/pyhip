...
PYTHONPATH=src:. python3 \
  experiments/attention/flydsl/attn_4wave/tools/probe-batched-gemm-core-ceiling.py self-test
```
...
PYHIP_JIT_LOG=0 python3 \
  experiments/attention/flydsl/attn_4wave/tools/probe-batched-gemm-core-ceiling.py bench \
  --physical-device 4 --device 0 \
...
[MAIN_MERGE_PERFORMANCE_REPORT.md](../../../../../tests/contrib/moe/MAIN_MERGE_PERFORMANCE_REPORT.md)。
