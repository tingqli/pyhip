...
```bash
HIP_VISIBLE_DEVICES=4 python3 -B experiments/attention/flydsl/attn_4wave/tools/probe-gpu-frequency.py \
...
```bash
python3 -B experiments/attention/flydsl/attn_4wave/tools/probe-gpu-frequency.py \
