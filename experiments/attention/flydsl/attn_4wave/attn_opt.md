...
python3 -B experiments/attention/flydsl/test_attn_gemm.py
```
...
python3 -B experiments/attention/flydsl/attn_4wave/test_attn_gemm_jit.py
...
python3 -B experiments/attention/flydsl/attn_4wave/tools/test-coissue.py \
