...
''' + decl_lds + git_commit + r'''
    ...
    def get_mfma_loader(self, use_pre_shuffle, num_warps, M, K, vm_stride, warp_row0):
        if use_pre_shuffle:
            return self.get_loader_preshuffled(num_warps, M, K, vm_stride, warp_row0)
        else:
            return self.get_loader_row_major(num_warps, M, K, vm_stride, warp_row0)

    def get_loader_preshuffled(self, num_warps, M, K, vm_stride, warp_row0):
    ...
    def get_loader_row_major(self, num_warps, M, K, vm_stride, warp_row0):
        J = self
        if 0:
